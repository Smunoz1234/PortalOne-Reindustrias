...
<title>
	<?php echo $Title; ?> | <?php echo NOMBRE_PORTAL; ?>
</title>
<!-- InstanceEndEditable -->
				...
				<div class="ibox-content">
					<?php include "includes/spinner.php";?>
						<div class="form-group">
							...
							<div class="col-lg-3">
								<input name="NombrePerfil" type="text" required="required" class="form-control"
									id="NombrePerfil" maxlength="100"
									value="<?php if ($edit == 1) {
										echo $row['PerfilUsuario'];
									} ?>">
							</div>
						</div>
						<div class="form-group">
							<div class="col-lg-9">
								<?php if ($edit == 1) { ?>
									<button class="btn btn-warning" type="submit" id="Actualizar">
										<i class="fa fa-refresh"></i> Actualizar perfil
									</button>
								<?php } else { ?>
									<button class="btn btn-primary" type="submit" id="Crear">
										<i class="fa fa-check"></i> Crear perfil
									</button>
								<?php } ?>
								
								<a href="gestionar_perfiles.php" class="btn btn-outline btn-default">
									<i class="fa fa-arrow-circle-o-left"></i> Regresar
								</a>

								<input type="hidden" name="ID_PerfilUsuario" id="ID_PerfilUsuario"
									value="<?php if ($edit == 1) {
										echo $row['ID_PerfilUsuario'];
									} ?>">
			 ...
			 <br>
					...
					<div class="ibox-content">
						...
						<div class="tabs-container">
							<ul class="nav nav-tabs">
								<li class="active">
									<a data-toggle="tab" href="#tab-1"><i class="fa fa-desktop"></i> PortalOne</a>
								</li>
                								...
                								<?php while ($row_Hijo = sqlsrv_fetch_array($SQL_Hijo)) {?>
															...
															<?php } else {?>
																<tr>
																	...
																	<td>
																		<?php echo $row_Padre['NombreFuncion']; ?>
																	</td>
																	
																	<td>
																		<?php echo $row_Padre['Descripcion']; ?>
																	</td>
																</tr>
																<?php }?>
															<?php }?>
															...
															<?php } else {?>
																<tr>
																	<td>
																		<div class="switch">
																			<div class="onoffswitch">
																				<input name="PermisoPortalOne[]"
																					type="checkbox"
																					class="onoffswitch-checkbox"
																					id="PermisoPortalOne<?php echo $row_Padre['ID_Permiso']; ?>"
																					value="<?php echo $row_Padre['ID_Permiso']; ?>"
																					<?php if ($edit == 1) {
																						if (in_array($row_Padre['ID_Permiso'], $PermisosPerfil)) {
																							echo "checked";
																						}
																					} ?>>
																				
																				<label class="onoffswitch-label" 
																					for="PermisoPortalOne<?php echo $row_Padre['ID_Permiso']; ?>">
																					<span class="onoffswitch-inner"></span>
																					<span class="onoffswitch-switch"></span>
																				</label>
																			</div>
									...
									<div class="form-group">
										...
										<div class="table-responsive">
											...
											<?php while ($row_PermisosServiceOne = sqlsrv_fetch_array($SQL_PermisosServiceOne)) { ?>
    											<?php if ($row_PermisosServiceOne['ID_Padre'] == 0) {?>
													<tr class="warning">
														<td colspan="3">
															<strong>
																<?php echo $row_PermisosServiceOne['NombreFuncion']; ?>
															</strong>
														</td>
													</tr>
												<?php $SQL_PadreServiceOne = Seleccionar('uvw_tbl_NombresPermisosPerfiles_ServiceOne', '*', "ID_Padre='" . $row_PermisosServiceOne['ID_Permiso'] . "'"); ?>
													<?php while ($row_PadreServiceOne = sqlsrv_fetch_array($SQL_PadreServiceOne)) { ?>
            											<?php if (strlen($row_PadreServiceOne['ID_Permiso']) == 2) {?>
															<tr class="info">
																<td colspan="3">
																	<strong>
																		<?php echo $row_PadreServiceOne['NombreFuncion']; ?>
																	</strong>
																</td>
															</tr>
														<?php $SQL_HijoServiceOne = Seleccionar('uvw_tbl_NombresPermisosPerfiles_ServiceOne', '*', "ID_Padre='" . $row_PadreServiceOne['ID_Permiso'] . "'"); ?>
                											<?php while ($row_HijoServiceOne = sqlsrv_fetch_array($SQL_HijoServiceOne)) { ?>
																<tr>
																	<td>
																		<div class="switch">
																			<div class="onoffswitch">
																				<input name="PermisoServiceOne[]"
																					type="checkbox"
																					class="onoffswitch-checkbox"
																					id="PermisoServiceOne<?php echo $row_HijoServiceOne['ID_Permiso']; ?>"
																					value="<?php echo $row_HijoServiceOne['ID_Permiso']; ?>"
																					<?php if ($edit == 1) {
																						if (in_array($row_HijoServiceOne['ID_Permiso'], $PermisosPerfilServiceOne)) {
																							echo "checked";
																						}
																					} ?>>

																				<label class="onoffswitch-label" 
																					for="PermisoServiceOne<?php echo $row_HijoServiceOne['ID_Permiso']; ?>">
																					<span class="onoffswitch-inner"></span>
																					<span class="onoffswitch-switch"></span>
																				</label>
																			</div>
																	...
																	<td>
																		<?php echo $row_HijoServiceOne['NombreFuncion']; ?>
																	</td>
																	
																	<td>
																		<?php echo $row_HijoServiceOne['Descripcion']; ?>
																	</td>
																</tr>
																<?php } ?>
															<?php } else { ?>
																<tr>
																		...
																		<div class="switch">
																			<div class="onoffswitch">
																				<input name="PermisoServiceOne[]"
																					type="checkbox"
																					class="onoffswitch-checkbox"
																					id="PermisoServiceOne<?php echo $row_PadreServiceOne['ID_Permiso']; ?>"
																					value="<?php echo $row_PadreServiceOne['ID_Permiso']; ?>"
																					<?php if ($edit == 1) {
																						if (in_array($row_PadreServiceOne['ID_Permiso'], $PermisosPerfilServiceOne)) {
																							echo "checked";
																						}
																					} ?>>

																				<label class="onoffswitch-label" 
																					for="PermisoServiceOne<?php echo $row_PadreServiceOne['ID_Permiso']; ?>">
																					<span class="onoffswitch-inner"></span>
																					<span class="onoffswitch-switch"></span>
																				</label>
																			</div>
																	...
																	<td>
																		<?php echo $row_PadreServiceOne['Descripcion']; ?>
																	</td>
																</tr>
																<?php } ?>
															<?php } ?>
									...
									<div class="form-group">
										...
										<div class="table-responsive">
											...
											<?php while ($row_PermisosSalesOne = sqlsrv_fetch_array($SQL_PermisosSalesOne)) { ?>
    											<?php if ($row_PermisosSalesOne['ID_Padre'] == 0) {?>
													<tr class="warning">
														<td colspan="3">
															<strong>
																<?php echo $row_PermisosSalesOne['NombreFuncion']; ?>
															</strong>
														</td>
													</tr>
											<?php $SQL_PadreSalesOne = Seleccionar('uvw_tbl_NombresPermisosPerfiles_SalesOne', '*', "ID_Padre='" . $row_PermisosSalesOne['ID_Permiso'] . "'"); ?>
        										<?php while ($row_PadreSalesOne = sqlsrv_fetch_array($SQL_PadreSalesOne)) { ?>
            										<?php if (strlen($row_PadreSalesOne['ID_Permiso']) == 2) { ?>
															<tr class="info">
																<td colspan="3">
																	<strong>
																		<?php echo $row_PadreSalesOne['NombreFuncion']; ?>
																	</strong>
																</td>
															</tr>
														<?php $SQL_HijoSalesOne = Seleccionar('uvw_tbl_NombresPermisosPerfiles_SalesOne', '*', "ID_Padre='" . $row_PadreSalesOne['ID_Permiso'] . "'"); ?>
            												<?php while ($row_HijoSalesOne = sqlsrv_fetch_array($SQL_HijoSalesOne)) {?>
																<tr>
																	<td>
																		<div class="switch">
																			<div class="onoffswitch">
																				<input name="PermisoSalesOne[]"
																					type="checkbox"
																					class="onoffswitch-checkbox"
																					id="PermisoSalesOne<?php echo $row_HijoSalesOne['ID_Permiso']; ?>"
																					value="<?php echo $row_HijoSalesOne['ID_Permiso']; ?>"
																					<?php if ($edit == 1) {
																						if (in_array($row_HijoSalesOne['ID_Permiso'], $PermisosPerfilSalesOne)) {
																							echo "checked";
																						}
																					} ?>>

																				<label class="onoffswitch-label"
																					for="PermisoSalesOne<?php echo $row_HijoSalesOne['ID_Permiso']; ?>">
																					<span class="onoffswitch-inner"></span>
																					<span class="onoffswitch-switch"></span>
																				</label>
																			</div>
																	...
																	<td>
																		<?php echo $row_HijoSalesOne['NombreFuncion']; ?>
																	</td>
																	
																	<td>
																		<?php echo $row_HijoSalesOne['Descripcion']; ?>
																	</td>
																</tr>
																<?php
}
                ...
                ?>
																<tr>
																		...
																		<div class="switch">
																			<div class="onoffswitch">
																				<input name="PermisoSalesOne[]"
																					type="checkbox"
																					class="onoffswitch-checkbox"
																					id="PermisoSalesOne<?php echo $row_PadreSalesOne['ID_Permiso']; ?>"
																					value="<?php echo $row_PadreSalesOne['ID_Permiso']; ?>"
																					<?php if ($edit == 1) {
																						if (in_array($row_PadreSalesOne['ID_Permiso'], $PermisosPerfilSalesOne)) {
																							echo "checked";
																						}
																					} ?>>
																					
																				<label class="onoffswitch-label" 
																					for="PermisoSalesOne<?php echo $row_PadreSalesOne['ID_Permiso']; ?>">
																					<span class="onoffswitch-inner"></span>
																					<span class="onoffswitch-switch"></span>
																				</label>
																			</div>
																	...
																	<td>
																		<?php echo $row_PadreSalesOne['Descripcion']; ?>
																	</td>
																</tr>
																<?php } ?>
        													<?php } ?>
