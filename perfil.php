								...
								<div class="col-lg-9">
									<?php if ($edit == 1) { ?>
										<button class="btn btn-warning" type="submit" id="Actualizar"><i
												class="fa fa-refresh"></i> Actualizar perfil</button>
									<?php } else { ?>
										<button class="btn btn-primary" type="submit" id="Crear"><i class="fa fa-check"></i>
											Crear perfil</button>
									<?php } ?>
									<a href="gestionar_perfiles.php" class="btn btn-outline btn-default"><i
							...
							<div class="tabs-container">
								<ul class="nav nav-tabs">
									<li class="active"><a data-toggle="tab" href="#tab-1"><i class="fa fa-desktop"></i>
											PortalOne</a></li>
									<li><a data-toggle="tab" href="#tab-2"><i class="fa fa-mobile"></i> ServiceOne</a>
									</li>
														...
														<tbody>
															<?php while ($row_Permisos = sqlsrv_fetch_array($SQL_Permisos)) {
																if ($row_Permisos['ID_Padre'] == 0) { ?>
																	<tr class="warning">
																		<td colspan="3"><strong>
																				<?php echo $row_Permisos['NombreFuncion']; ?>
																			</strong></td>
																	</tr>
																	<?php
																		...
																		if (strlen($row_Padre['ID_Permiso']) == 2) { ?>
																			...
																			while ($row_Hijo = sqlsrv_fetch_array($SQL_Hijo)) { ?>
																				<tr>
																						...
																						<div class="switch">
																							<div class="onoffswitch">
																								<input name="PermisoPortalOne[]"
																									...
																									id="PermisoPortalOne<?php echo $row_Hijo['ID_Permiso']; ?>"
																									value="<?php echo $row_Hijo['ID_Permiso']; ?>"
																									<?php if ($edit == 1) {
																										if (in_array($row_Hijo['ID_Permiso'], $PermisosPerfil)) {
																											echo "checked";
																										}
																									} ?>>
																								<label class="onoffswitch-label"
																									for="PermisoPortalOne<?php echo $row_Hijo['ID_Permiso']; ?>">
																					...
																					<td>
																						<?php echo $row_Hijo['NombreFuncion']; ?>
																					</td>
																					<td>
																						<?php echo $row_Hijo['Descripcion']; ?>
																					</td>
																				</tr>
																				<?php
																			}
