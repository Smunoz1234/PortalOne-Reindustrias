...
<div class="ibox">
  ...
  <div class="ibox-content">
    <div id="divCliente_<?php echo $Cont; ?>" class="form-group">
      ...
      <div class="col-lg-4">
        <select name="Cliente[]" class="form-control" id="Cliente<?php echo $Cont; ?>"
          onChange="BuscarSucursal('<?php echo $Cont; ?>');">
          <option value="">Seleccione...</option>
          <?php while ($row_Cliente = sqlsrv_fetch_array($SQL_Cliente)) { ?>
            <option value="<?php echo $row_Cliente['CodigoCliente']; ?>">
              <?php echo $row_Cliente['NombreCliente']; ?>
            </option>
          <?php } ?>
        </select>
      </div>
    ...
    while ($row_ClienteUsuario = sqlsrv_fetch_array($SQL_ClienteUsuario)) {
      ...
      <div class="form-group">
        <div class="col-xs-12 font-bold">
          <div class="p-xs border-bottom bg-muted">
            <?php echo $row_ClienteUsuario['NombreCliente']; ?>
          </div>
        </div>
      </div>
      <div class="form-group">
      ...
      do {
        ...
        <div id="div_<?php echo $Cont; ?>" class="form-group">
          <input type="hidden" name="Cliente[]" id="Cliente<?php echo $Cont; ?>"
