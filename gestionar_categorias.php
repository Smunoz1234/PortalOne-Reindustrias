...
<head>
	...
	<title>Gestionar categorías | <?php echo NOMBRE_PORTAL; ?></title>
	<!-- InstanceEndEditable -->
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<a href="categorias.php" class="alkin btn btn-primary"><i class="fa fa-plus-circle"></i>
								Agregar categoría</a>
							<a style="visibility: hidden;" id="a_Edit" href="#" class="alkin btn btn-success"><i
