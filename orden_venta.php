		   ...
		   <div class="col-lg-12">
			  <form action="orden_venta.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="CrearOrdenVenta">
				...
				<div class="col-lg-8">
					<div class="form-group">
						...
						<div class="col-lg-9">
							...
							<input name="CardName" type="text" required="required" class="form-control" id="CardName" placeholder="Digite para buscar..." value="<?php if (($edit == 1) || ($sw_error == 1)) {
				...
				<div class="form-group">
					...
					<div class="col-lg-3">
						<select name="CondicionPago" class="form-control" id="CondicionPago" required="required" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
							echo "disabled='disabled'";
						} ?>>
							<option value="">Seleccione...</option>
				...
				<div class="form-group">
					...
					<div class="col-lg-3">
						<select id="PrjCode" name="PrjCode" class="form-control" required="required" form="CrearOrdenVenta" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
							echo "disabled='disabled'";
						} ?>>
				...
				<div class="form-group">
					<!-- SMM, 30/05/2023 -->
					<div class="col-lg-4">
						<button <?php if ((($edit == 1) && ($row['Cod_Estado'] == 'C')) || (!PermitirFuncion(402))) { echo "disabled"; } ?> class="btn btn-success" type="button" onclick="AgregarArticulos();"><i class="fa fa-plus"></i> Agregar artículo</button>
					</div>
			   ...
			   <form id="frm" action="" class="form-horizontal">
				...
				<div class="col-lg-8">
					<div class="form-group">
						...
						<div class="col-lg-5">
							<select name="EmpleadoVentas" class="form-control" id="EmpleadoVentas" form="CrearOrdenVenta" required="required" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
								echo "disabled='disabled'";
							} ?>>
				...
				<div class="col-lg-4">
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="SubTotal" form="CrearOrdenVenta" id="SubTotal" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="Descuentos" form="CrearOrdenVenta" id="Descuentos" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="Impuestos" form="CrearOrdenVenta" id="Impuestos" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="TotalOrden" form="CrearOrdenVenta" id="TotalOrden" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
