...
if (!isset($_GET['dato']) || ($_GET['dato'] == "")) {
	...
	<body style="overflow-x: auto;">
		<div class="p-sm col-lg-4">
			<label class="checkbox-inline i-checks"><input name="chkStock" type="checkbox" id="chkStock" value="1" <?php if ($SoloStock == 1) { ?>checked="checked" <?php } ?>> Mostrar solo los articulos con stock</label>
		</div>
