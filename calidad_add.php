...
/*if(PermitirFuncion(205)){
	...
	$Where="WHERE ID_Usuario = ".$_SESSION['CodUser'];
...
if($Step==3){
	//Sucursales
	if(PermitirFuncion(205)){
		$Where="WHERE CodigoCliente=''".$_POST['CodigoCliente']."''";
		$SQL_Sucursal=Seleccionar("uvw_Sap_tbl_Clientes_Sucursales","NombreSucursal",$Where);
	}else{
		$Where="WHERE CodigoCliente=''".$_POST['CodigoCliente']."'' and ID_Usuario = ".$_SESSION['CodUser'];
...
<title><?php echo NOMBRE_PORTAL;?> | Cargar archivos</title>
<!-- InstanceEndEditable -->
             ...
             <div class="ibox-content">
              ...
              <?php }else*/if($Step==2){
			   ...
			   <form action="registro.php" method="post" class="form-horizontal" id="AgregarDatos">
              	 <h2>Ingresar información de archivos</h2>
              	<br>
