			...
			<div class="wrapper wrapper-content">
				...
				<div class="ibox-content">
								...
								<div class="form-group">
									...
									<div class="col-lg-4">
										<input name="BuscarItem" id="BuscarItem" type="text" class="form-control"
											...
											onBlur="javascript:BuscarArticulo(this.value);" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
												echo "readonly";
											} ?>>
									</div>
					...
					<form id="frm" action="" class="form-horizontal">
						...
						<input type="hidden" form="CrearOfertaVenta" id="PrjCode" name="PrjCode"
							value="<?php if ($edit == 1) {
								echo $row['PrjCode'];
							} ?>" />
					</form>
