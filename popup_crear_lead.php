				...
				<form action="popup_crear_lead.php" method="post" class="form-horizontal" id="FrmCrear">
					<div class="tabs-container">
						<ul class="nav nav-tabs">
							<li class="active"><a data-toggle="tab" href="#tabcl-1"><i class="fa fa-info-circle"></i>
						...
						<div class="tab-content">
							<div id="tabcl-1" class="tab-pane active">
									...
									<div class="col-lg-3">
										<select name="TipoEntidad" class="form-control" id="TipoEntidad" required>
											...
											<?php while ($row_TipoEntidad = sqlsrv_fetch_array($SQL_TipoEntidad)) { ?>
												<option value="<?php echo $row_TipoEntidad['ID_TipoEntidad']; ?>" <?php if (($sw_error == 1) && (strcmp($row_TipoEntidad['ID_TipoEntidad'], $_POST['TipoEntidad']) == 0)) {
													   echo "selected";
									...
									<div class="col-lg-3">
										<select name="TipoDocumento" class="form-control" id="TipoDocumento" required>
											...
											<?php while ($row_TipoDoc = sqlsrv_fetch_array($SQL_TipoDoc)) { ?>
												<option value="<?php echo $row_TipoDoc['ID_TipoDocumento']; ?>" <?php if (($sw_error == 1) && (strcmp($row_TipoDoc['ID_TipoDocumento'], $_POST['TipoDocumento']) == 0)) {
													   echo "selected";
									...
									<div class="col-lg-3">
										<select name="GroupCode" class="form-control select2" id="GroupCode" required>
											...
											while ($row_GruposClientes = sqlsrv_fetch_array($SQL_GruposClientes)) { ?>
												<option value="<?php echo $row_GruposClientes['GroupCode']; ?>" <?php if (($sw_error == 1) && (strcmp($row_GruposClientes['GroupCode'], $_POST['GroupCode']) == 0)) {
													   echo "selected";
								...
								<div class="form-group">
									<label class="col-lg-1 control-label">Departamento <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
										<select name="County" id="County" class="form-control" required
											...
											<?php while ($row_Dptos = sqlsrv_fetch_array($SQL_Dptos)) { ?>
												<option value="<?php echo $row_Dptos['DeDepartamento']; ?>" <?php if (($sw_error == 1) && (strcmp($row_Dptos['DeDepartamento'], $_POST['County']) == 0)) {
													   echo "selected";
									...
									<label class="col-lg-1 control-label">Ciudad <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
										<select name="City" id="City" onChange="BuscarBarrio();" class="form-control"
											required>
											<option value="">Seleccione...</option>
											<?php if ($sw_error == 1) { ?>
									...
									<label class="col-lg-1 control-label">Barrio <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
								...
								<div class="form-group" style="visibility: hidden;">
									...
									<div class="col-lg-3">
										<label class="checkbox-inline i-checks"><input name="CrearProyecto"
												id="CrearProyecto" type="checkbox" value="Y"> Crear el proyecto para
											este cliente</label>
									</div>
									<div id="dvPrj" style="display: none;">
										<label class="col-lg-1 control-label">Código proyecto <span
												class="text-danger">*</span></label>
										<div class="col-lg-3">
								...
								<div class="form-group">
									<label class="col-xs-12">
										<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-briefcase"></i> Información
											comercial</h3>
									</label>
								</div>
								<div class="form-group">
									...
									<div class="col-lg-3">
										<select name="Industria" class="form-control" id="Industria" required>
											<?php while ($row_Industria = sqlsrv_fetch_array($SQL_Industria)) { ?>
												<option value="<?php echo $row_Industria['IdIndustria']; ?>" <?php if (($sw_error == 1) && (strcmp($row_Industria['IdIndustria'], $_POST['Industria']) == 0)) {
													   echo "selected";
									...
									<div class="col-lg-3">
										<select name="GroupNum" class="form-control" id="GroupNum" required>
											...
											<?php while ($row_CondicionPago = sqlsrv_fetch_array($SQL_CondicionPago)) { ?>
												<option value="<?php echo $row_CondicionPago['IdCondicionPago']; ?>" <?php if (($sw_error == 1) && (strcmp($row_CondicionPago['IdCondicionPago'], $_POST['GroupNum']) == 0)) {
													   echo "selected";
									...
									<div class="col-lg-3">
										<select name="MedioPago" class="form-control select2" id="MedioPago" required>
											<?php while ($row_MedioPago = sqlsrv_fetch_array($SQL_MedioPago)) { ?>
												<option value="<?php echo $row_MedioPago['IdMedioPago']; ?>" <?php if (($sw_error == 1) && (strcmp($row_MedioPago['IdMedioPago'], $_POST['MedioPago']) == 0)) {
													   echo "selected";
									...
									<div class="col-lg-3">
										<select name="IdListaPrecio" class="form-control" id="IdListaPrecio" <?php if (!PermitirFuncion(511)) {
											...
											<?php while ($row_ListaPrecio = sqlsrv_fetch_array($SQL_ListaPrecios)) { ?>
												<option value="<?php echo $row_ListaPrecio['IdListaPrecio']; ?>" <?php if ((ObtenerValorDefecto(2, 'IdListaPrecio') !== null) && (strcmp($row_ListaPrecio['IdListaPrecio'], ObtenerValorDefecto(2, 'IdListaPrecio')) == 0)) {
													   echo "selected";
												   } ?>>
								...
								<div class="form-group">
									<div class="col-lg-9">
										<button class="btn btn-primary" type="submit" id="Crear"><i
												class="fa fa-check"></i> Crear Prospecto</button>
							...
							<div id="tabcl-2" class="tab-pane">
								<div class="form-group">
									<label class="col-xs-12">
										<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-list"></i> Propiedades del
											cliente</h3>
									</label>
								</div>
								<div class="form-group">
														...
														<tr>
															...
															<td>
																<div class="checkbox checkbox-success">
																	<input type="checkbox" class="chkProp"
																		id="Prop<?php echo $row['CodigoGrupo']; ?>"
																		name="Prop<?php echo $row['CodigoGrupo']; ?>"
																		value="Y"
