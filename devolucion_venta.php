				...
				<div class="col-lg-8">
					<div class="form-group">
						...
						<div class="col-lg-9">
							...
							<?php if (!PermitirFuncion(419) && ((($edit == 1) && ($row['Cod_Estado'] == 'C')) || ($dt_LS == 1 || $dt_ET == 1) || ($edit == 1))) {echo "readonly";}?>>
						</div>
					</div>
					<div class="form-group">
			   ...
			   <form id="frm" action="" class="form-horizontal">
				...
				<div class="col-lg-8">
					<div class="form-group">
						...
						<div class="col-lg-4">
							<select id="PrjCode" name="PrjCode" class="form-control select2" form="CrearDevolucionVenta" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {echo "disabled='disabled'";}?>>
