...
<head>
	...
	<title>
		Entrega de venta borrador | <?php echo NOMBRE_PORTAL; ?>
	</title>
	<?php
...
<body>
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content">
								...
								<div class="modal-body">
									<div class="ibox-content">
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<textarea form="CrearEntregaVenta" class="form-control required"
				...
				<div class="ibox-content">
					...
					<div class="row">
						<div class="col-lg-12">
							<form action="entrega_venta_borrador.php" method="post" class="form-horizontal"
								...
								<div class="form-group">
									...
									<label class="col-md-4 col-xs-12">
										<h3 class="bg-success p-xs b-r-sm">
											<i class="fa fa-calendar"></i> Fechas de documento
										</h3>
									</label>
								</div>
								<div class="col-lg-8">
								...
								<div class="col-lg-4">
									...
									<div class="form-group">
										...
										<div class="col-lg-7 input-group date">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
												name="DocDate" type="text" required class="form-control"
									...
									<div class="form-group">
										<label class="col-lg-5">
											Fecha del documento <span class="text-danger">*</span>
										</label>
										<div class="col-lg-7 input-group date">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
												name="TaxDate" type="text" required class="form-control"
								...
								<div class="form-group">
									<label class="col-xs-12">
										<h3 class="bg-success p-xs b-r-sm">
											<i class="fa fa-info-circle"></i> Datos de la Entrega
										</h3>
									</label>
								</div>
								...
								<div class="form-group">
									<label class="col-lg-1 control-label">Serie <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
										<select name="Serie" class="form-control" required id="Serie" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
											echo "disabled";
										} ?>>
											<!-- SMM, 01/05/2022 -->
								...
								<div class="form-group">
									<label class="col-xs-12">
										<h3 class="bg-success p-xs b-r-sm">
											<i class="fa fa-list"></i> Contenido de la Entrega
										</h3>
									</label>
								</div>
										...
										<div id="tab-1" class="tab-pane active">
											<iframe id="DataGrid" name="DataGrid" style="border: 0;" width="100%"
												height="300" src="<?php if ($edit == 0 && $sw_error == 0) {
													echo "detalle_entrega_venta_borrador.php";
												} elseif ($edit == 0 && $sw_error == 1) {
													echo "detalle_entrega_venta_borrador.php?id=0&type=1&usr=" . $_SESSION['CodUser'] . "&cardcode=" . $row['CardCode'];
												} else {
													echo "detalle_entrega_venta_borrador.php?autoriza=1&id=" . base64_encode($row['ID_EntregaVenta']) . "&evento=" . base64_encode($row['IdEvento']) . "&docentry=" . base64_encode($row['DocEntry']) . "&type=2&status=" . base64_encode($row['Cod_Estado']);
												} ?>"></iframe>
										</div>
										<?php if ($edit == 1) { ?>
					...
					<form id="frm" action="" class="form-horizontal">
						...
						<div class="form-group">
							<div class="col-lg-9">
								...
								<a href="<?php echo $return; ?>" class="btn btn-outline btn-default">
	...
	<script>
		$(document).ready(function () {
			...
			// $('.chosen-select').chosen({width: "100%"});// $(".select2").select2();
