				...
				<div id="CamposAutorizacionSAP" <?php if (($edit == 1) && ($row['AutorizacionSAP'] == "N")) {?> style="display: none;" <?php }?>>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<a href="#" id="aVerPass" onClick="javascript:MostrarPassword();" title="Mostrar contraseña" class="btn btn-default btn-xs"><span id="VerPass" class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
						</div>
					</div>
