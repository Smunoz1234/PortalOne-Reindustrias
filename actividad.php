...
<head>
	...
	<script>
		...
		// SMM, 18/01/2024
		function MostrarParadas(id_actividad) {
			$('.ibox-content').toggleClass('sk-loading', true);
			$.ajax({
				type: "POST",
				async: false,
				url: "md_paradas_actividades.php",
				data: {
				...
				success: function (response) {
					...
					$('#TituloModal').html("Historial de Paradas de Actividad");
					$('#myModal').modal("show");
				}
			});
		}
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content">
					...
					<div class="row">
						...
						<div class="col-lg-2">
							<div class="ibox ">
								...
								<div class="ibox-content">
									<h3 class="no-margins">
										<?php if ($sw_error == 0 && $row['UsuarioCreacion'] != "") {
						...
						<div class="col-lg-2">
							<div class="ibox ">
								...
								<div class="ibox-content">
									<h3 class="no-margins">
										<?php if ($sw_error == 0 && $row['FechaCreacion'] != "") {
						...
						<div class="col-lg-2">
							<div class="ibox ">
								...
								<div class="ibox-content">
									<h3 class="no-margins">
										<?php if ($sw_error == 0 && $row['UsuarioActualizacion'] != "") {
						...
						<div class="col-lg-3">
							<div class="ibox ">
								...
								<div class="ibox-content">
									<h3 class="no-margins">
										<?php if ($sw_error == 0 && $row['FechaActualizacion'] != "") {
										...
										<div class="form-group">
											...
											<div class="col-lg-6">
												<div class="btn-group pull-right">
													<?php if ($type_act == 1) { ?>
														<button onclick="MostrarParadas('<?php echo $IdActividad; ?>');" class="btn btn-outline btn-success">
															<i class="fa fa-history"></i> Ver Historial de Paradas
														</button>					
													<?php } ?>
												</div>
											</div>
				...
				<div class="ibox-content">
					...
					<div class="row">
						<div class="col-lg-12">
							<form action="actividad.php" method="post" class="form-horizontal"
								enctype="multipart/form-data" id="CrearActividad">
								<div class="ibox">
									<div class="ibox-title bg-success">
										<h5 class="collapse-link"><i class="fa fa-info-circle"></i> Información de tarea
										</h5>
										<a class="collapse-link pull-right">
											<i class="fa fa-chevron-up"></i>
										</a>
									...
									<div class="ibox-content">
										<div class="form-group">
											<label class="col-lg-1 control-label">Titulo actividad <span
													class="text-danger">*</span></label>
											<div class="col-lg-7">
												<input autocomplete="off" name="TituloActividad" type="text"
													required="required" class="form-control" id="TituloActividad"
													maxlength="150"
													value="<?php if ($type_act == 1 || $sw_error == 1) {
														echo $row['TituloActividad'];
													} else {
														echo $TituloAct;
													} ?>"
													<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1))) {
														echo "readonly='readonly'";
													} ?>>
											</div>
											<label class="col-lg-1 control-label">Tipo tarea</label>
											<div class="col-lg-3">
												<select name="TipoTarea" class="form-control" id="TipoTarea" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
													...
													if ($dt_LS == 1) {
														...
														<option value="Externa" <?php if (($type_act == 1 || $sw_error == 1) && (isset($row['TipoTarea'])) && ($row['TipoTarea'] == 'Externa')) {
															echo "selected=\"selected\"";
														} ?>>Externa</option>
														<option value="Interna" <?php if (($type_act == 1 || $sw_error == 1) && (isset($row['TipoTarea'])) && ($row['TipoTarea'] == 'Interna')) {
															echo "selected=\"selected\"";
														} ?>>Interna</option>
													<?php } ?>
												</select>
										...
										<div id="DatosActividad" class="form-group">
											<label class="col-lg-1 control-label">Tipo asunto <span
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<select name="TipoActividad" class="form-control" id="TipoActividad"
													...
													<?php while ($row_TipoActividad = sqlsrv_fetch_array($SQL_TipoActividad)) { ?>
														<option
															value="<?php echo $row_TipoActividad['ID_TipoActividad']; ?>"
															<?php if ((isset($row['ID_TipoActividad'])) && (strcmp($row_TipoActividad['ID_TipoActividad'], $row['ID_TipoActividad']) == 0)) {
																echo "selected=\"selected\"";
															} ?>>
															<?php echo $row_TipoActividad['DE_TipoActividad']; ?></option>
													<?php } ?>
												</select>
											</div>
											<label class="col-lg-1 control-label">Asunto <span
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<select name="AsuntoActividad" class="form-control" id="AsuntoActividad"
													<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?>
													required="required">
													<?php if (($type_act == 0) || ($sw_error == 1)) { ?>
														<option value="">Seleccione...</option><?php } ?>
													<?php if (($type_act == 1) || ($sw_error == 1)) {
														while ($row_AsuntoActividad = sqlsrv_fetch_array($SQL_AsuntoActividad)) { ?>
															<option
																value="<?php echo $row_AsuntoActividad['ID_AsuntoActividad']; ?>"
																<?php if ((isset($row['ID_AsuntoActividad'])) && (strcmp($row_AsuntoActividad['ID_AsuntoActividad'], $row['ID_AsuntoActividad']) == 0)) {
																	echo "selected=\"selected\"";
																} ?>>
																<?php echo $row_AsuntoActividad['DE_AsuntoActividad']; ?>
															</option>
														<?php }
													} ?>
												</select>
											</div>
											<label class="col-lg-1 control-label">En ruta <span
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<select name="EnRuta" class="form-control" id="EnRuta" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
													echo "disabled='disabled'";
												} ?>
													required>
													<option value="NO" <?php if ((isset($row['EnRuta'])) && ($row['EnRuta'] == 'NO')) {
														echo "selected=\"selected\"";
													} ?>>NO
													</option>
													<option value="SI" <?php if ((isset($row['EnRuta'])) && ($row['EnRuta'] == 'SI')) {
														echo "selected=\"selected\"";
													} ?>>SI
													</option>
												</select>
										...
										<div class="form-group">
											<label class="col-lg-1 control-label">Tipo asignado <span
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<select name="TipoAsignado" class="form-control" required
													id="TipoAsignado" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?>>
													<option value="2" <?php if ((isset($row['IdTipoAsignado'])) && ($row['IdTipoAsignado'] == '2')) {
														echo "selected=\"selected\"";
													} ?>>Empleado</option>
													<option value="1" <?php if ((isset($row['IdTipoAsignado'])) && ($row['IdTipoAsignado'] == '1')) {
														echo "selected=\"selected\"";
													} ?>>Usuario SAP</option>
													<option value="3" <?php if ((isset($row['IdTipoAsignado'])) && ($row['IdTipoAsignado'] == '3')) {
														echo "selected=\"selected\"";
													} ?>>Lista destinatarios</option>
												</select>
											</div>
											<label class="col-lg-1 control-label">Asignado a <span
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<select name="EmpleadoActividad" class="form-control select2" required
													id="EmpleadoActividad" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?>>
													<?php if (($type_act == 0) || (($type_act == 1) && ($row['IdTipoAsignado'] == 2))) { ?>
														...
														<?php while ($row_EmpleadoActividad = sqlsrv_fetch_array($SQL_EmpleadoActividad)) { ?>
															<option value="<?php echo $row_EmpleadoActividad['ID_Empleado']; ?>"
																<?php if ((isset($row['ID_EmpleadoActividad'])) && (strcmp($row_EmpleadoActividad['ID_Empleado'], $row['ID_EmpleadoActividad']) == 0)) {
																	echo "selected=\"selected\"";
																} ?>>
																<?php echo $row_EmpleadoActividad['NombreEmpleado']; ?></option>
														<?php }
													} elseif (($type_act == 1) && ($row['IdTipoAsignado'] == 3)) { ?>
														<option value="">(Sin asignar)</option>
														<?php while ($row_ListaDest = sqlsrv_fetch_array($SQL_ListaDest)) { ?>
															<option value="<?php echo $row_ListaDest['IdListaAsignado']; ?>"
																<?php if ((isset($row['IdListaAsignado'])) && (strcmp($row_ListaDest['IdListaAsignado'], $row['IdListaAsignado']) == 0)) {
																	echo "selected=\"selected\"";
																} ?>>
																<?php echo $row_ListaDest['DeListaAsignado']; ?></option>
														<?php }
														...
														<?php while ($row_UsuariosSAP = sqlsrv_fetch_array($SQL_UsuariosSAP)) { ?>
															<option value="<?php echo $row_UsuariosSAP['IdUsuarioSAP']; ?>"
																<?php if ((isset($row['ID_EmpleadoActividad'])) && (strcmp($row_UsuariosSAP['IdUsuarioSAP'], $row['ID_EmpleadoActividad']) == 0)) {
																	echo "selected=\"selected\"";
																} ?>>
																<?php echo $row_UsuariosSAP['NombreEmpleado']; ?></option>
														<?php }
													} ?>
												</select>
											</div>
											...
											<div class="col-lg-3">
												<select name="CDU_TurnoTecnico" class="form-control"
													id="CDU_TurnoTecnico" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?>>
													<option value="">Seleccione...</option>
													<?php while ($row_TurnoTecnicos = sqlsrv_fetch_array($SQL_TurnoTecnicos)) { ?>
														<option value="<?php echo $row_TurnoTecnicos['CodigoTurno']; ?>"
															<?php if ((isset($row['CDU_IdTurnoTecnico'])) && (strcmp($row_TurnoTecnicos['CodigoTurno'], $row['CDU_IdTurnoTecnico']) == 0)) {
																echo "selected=\"selected\"";
															} ?>>
															<?php echo $row_TurnoTecnicos['NombreTurno']; ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-lg-3">
												<select name="MotivoCierre" class="form-control select2"
													id="MotivoCierre" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?>>
													<?php while ($row_MotivoCierre = sqlsrv_fetch_array($SQL_MotivoCierre)) { ?>
														<option value="<?php echo $row_MotivoCierre['IdMotivoCierre']; ?>"
															<?php if ((isset($row['IdMotivoCierre'])) && (strcmp($row_MotivoCierre['IdMotivoCierre'], $row['IdMotivoCierre']) == 0)) {
																echo "selected=\"selected\"";
															} ?>>
															<?php echo $row_MotivoCierre['DeMotivoCierre']; ?></option>
													<?php } ?>
												</select>
											</div>
											...
											<div class="col-lg-3">
												<select name="EstadoActividad" class="form-control" id="EstadoActividad"
													...
													<?php while ($row_EstadoActividad = sqlsrv_fetch_array($SQL_EstadoActividad)) { ?>
														<option value="<?php echo $row_EstadoActividad['Cod_Estado']; ?>"
															<?php if ((isset($row['IdEstadoActividad'])) && (strcmp($row_EstadoActividad['Cod_Estado'], $row['IdEstadoActividad']) == 0)) {
																echo "selected=\"selected\"";
															} ?>>
															<?php echo $row_EstadoActividad['NombreEstado']; ?></option>
													<?php } ?>
												</select>
											</div>
											<label class="col-lg-1 control-label">Tipo estado actividad <span
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<select name="TipoEstadoActividad" class="form-control"
													id="TipoEstadoActividad" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?> required="required">
													<option value="">Seleccione...</option>
													<?php while ($row_TiposEstadoActividad = sqlsrv_fetch_array($SQL_TiposEstadoActividad)) { ?>
														<option
															value="<?php echo $row_TiposEstadoActividad['ID_TipoEstadoActividad']; ?>"
															<?php if ((isset($row['IdTipoEstadoActividad'])) && (strcmp($row_TiposEstadoActividad['ID_TipoEstadoActividad'], $row['IdTipoEstadoActividad']) == 0)) {
																echo "selected=\"selected\"";
															} ?>>
															<?php echo $row_TiposEstadoActividad['DE_TipoEstadoActividad']; ?>
														</option>
													<?php } ?>
												</select>
											</div>
								...
								<div class="ibox">
									<div class="ibox-title bg-success">
										<h5 class="collapse-link"><i class="fa fa-group"></i> Información de cliente
										</h5>
										<a class="collapse-link pull-right">
											<i class="fa fa-chevron-up"></i>
										</a>
									...
									<div class="ibox-content">
										<div class="form-group">
											<label class="col-lg-1 control-label"><i onClick="ConsultarDatosCliente();"
													...
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<input name="ClienteActividad" type="hidden" id="ClienteActividad"
													value="<?php if (($type_act == 1) || ($sw_error == 1)) {
														echo $row['ID_CodigoCliente'];
													} elseif ($dt_LS == 1 || $dt_DM == 1) {
														echo $row_Cliente['CodigoCliente'];
													} ?>">
												<input name="NombreClienteActividad" type="text" required="required"
													class="form-control" id="NombreClienteActividad"
													...
													<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1) || ($row['TipoTarea'] == 'Interna')) || (($sw_error == 1) && ($row['TipoTarea'] == 'Interna')) || ($dt_LS == 1) || ($dt_DM == 1)) {
														echo "readonly='readonly'";
													} ?>>
											</div>
											...
											<div class="col-lg-3">
												<select name="ContactoCliente" class="form-control" id="ContactoCliente"
													...
													required>
													<?php if ((($type_act == 0) || ($sw_error == 1)) && ($dt_LS != 1) && ($dt_DM != 1)) { ?>
														<option value="">Seleccione...</option><?php } ?>
													<?php if (($type_act == 1) || ($sw_error == 1) || ($dt_LS == 1) || ($dt_DM == 1)) {
														while ($row_ContactoCliente = sqlsrv_fetch_array($SQL_ContactoCliente)) { ?>
															<option
																value="<?php echo $row_ContactoCliente['CodigoContacto']; ?>"
																<?php if ((isset($row['ID_ContactoCliente'])) && (strcmp($row_ContactoCliente['CodigoContacto'], $row['ID_ContactoCliente']) == 0)) {
																	echo "selected=\"selected\"";
																} elseif (isset($_GET['Contacto']) && (strcmp($row_ContactoCliente['CodigoContacto'], base64_decode($_GET['Contacto'])) == 0)) {
																	echo "selected=\"selected\"";
																} ?>>
											...
											<label class="col-lg-1 control-label">Sucursal <span
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<select name="SucursalCliente" class="form-control select2"
													id="SucursalCliente" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?> required>
													<?php if (($type_act == 0) || ($sw_error == 1)) { ?>
														<option value="">Seleccione...</option><?php } ?>
														...
														while ($row_SucursalCliente = sqlsrv_fetch_array($SQL_SucursalCliente)) { ?>
															<option
																...
																<?php if ((isset($row['NombreSucursal'])) && (strcmp($row_SucursalCliente['NombreSucursal'], $row['NombreSucursal']) == 0)) {
																	echo "selected=\"selected\"";
																} elseif (isset($_GET['Sucursal']) && (strcmp($row_SucursalCliente['NombreSucursal'], base64_decode($_GET['Sucursal'])) == 0)) {
																	echo "selected=\"selected\"";
																} ?>>
										...
										<div class="form-group">
											<label class="col-lg-1 control-label">Dirección <span
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<input name="DireccionActividad" type="text" required="required"
													class="form-control" id="DireccionActividad" maxlength="100"
													value="<?php if (($type_act == 1) || ($sw_error == 1)) {
														echo $row['DireccionActividad'];
													} elseif ($dt_LS == 1 || $dt_DM == 1) {
											...
											<div class="col-lg-3">
												<input name="BarrioDireccionActividad" type="text" class="form-control"
													id="BarrioDireccionActividad" maxlength="50"
													value="<?php if (($type_act == 1) || ($sw_error == 1)) {
														echo $row['BarrioDireccionActividad'];
													} elseif ($dt_LS == 1) {
														echo base64_decode($_GET['Barrio']);
													} ?>"
													<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1))) {
														echo "readonly='readonly'";
													} ?>>
											</div>
											<label class="col-lg-1 control-label">Teléfono <span
													class="text-danger">*</span></label>
											<div class="col-lg-3">
												<input name="TelefonoActividad" autocomplete="off" type="text"
													class="form-control" required="required" id="TelefonoActividad"
													maxlength="50"
													value="<?php if (($type_act == 1) || ($sw_error == 1)) {
														echo $row['TelefonoContacto'];
													} elseif ($dt_LS == 1) {
														echo base64_decode($_GET['Telefono']);
													} ?>"
													<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1))) {
														echo "readonly='readonly'";
													} ?>>
										...
										<div class="form-group">
											...
											<div class="col-lg-3">
												<input name="CorreoActividad" autocomplete="off" type="text"
													class="form-control" id="CorreoActividad" maxlength="100"
													value="<?php if (($type_act == 1) || ($sw_error == 1)) {
														echo $row['CorreoContacto'];
													} elseif ($dt_LS == 1) {
														echo base64_decode($_GET['Correo']);
													} ?>"
													<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1))) {
														echo "readonly='readonly'";
													} ?>>
								...
								<div class="ibox">
									...
									<div class="ibox-content">
										<div class="form-group">
											...
											<div class="col-lg-6">
												<textarea name="Comentarios" rows="7" maxlength="3000"
													class="form-control" id="Comentarios" type="text" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1))) {
														echo "readonly='readonly'";
													} ?>><?php if (($type_act == 1) || ($sw_error == 1)) {
														echo $row['ComentariosActividad'];
													} ?></textarea>
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-1 control-label">Fecha inicio <span
													class="text-danger">*</span></label>
											<div class="col-lg-2 input-group date">
												<span class="input-group-addon"><i
														class="fa fa-calendar"></i></span><input name="FechaInicio"
													type="text" autocomplete="off" required="required"
													class="form-control" id="FechaInicio"
													value="<?php if ((($type_act == 1) || ($sw_error == 1)) && ($row['FechaInicioActividad']) != "1900-01-01") {
														echo $row['FechaInicioActividad'];
													} else {
														echo date('Y-m-d');
													} ?>"
													<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1))) {
											...
											<div id="dv_HoraInicio" class="col-lg-2 input-group clockpicker"
												data-autoclose="true" <?php if (($type_act == 1) && ($row['TodoDia'] == 1)) { ?>style="display: none;" <?php } ?>>
												<input name="HoraInicio" id="HoraInicio" type="text"
													class="form-control"
													value="<?php if ((($type_act == 1) || ($sw_error == 1)) && ($row['HoraInicioActividad'] != "00:00")) {
														echo $row['HoraInicioActividad'];
													} else {
														echo date('H:i');
													} ?>"
													required="required" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1))) {
														echo "readonly='readonly'";
													} ?>
											...
											<div class="col-lg-2">
												<label class="checkbox-inline i-checks"><input name="chkTodoDia"
														type="checkbox" id="chkTodoDia"
														value="<?php if (($type_act == 1) || ($sw_error == 1)) {
															echo $row['TodoDia'];
														} ?>"
														<?php if ((($type_act == 1) || ($sw_error == 1)) && ($row['TodoDia'] == 1)) {
										...
										<div class="form-group">
											<label class="col-lg-1 control-label">Fecha fin <span
													class="text-danger">*</span></label>
											<div class="col-lg-2 input-group date">
												<span class="input-group-addon"><i
														class="fa fa-calendar"></i></span><input name="FechaFin"
													id="FechaFin" type="text" required="required" autocomplete="off"
													class="form-control"
													value="<?php if ((($type_act == 1) || ($sw_error == 1)) && ($row['FechaFinActividad']) != "1900-01-01") {
														echo $row['FechaFinActividad'];
													} else {
														echo date('Y-m-d');
													} ?>"
													<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1))) {
											...
											<div id="dv_HoraFin" class="col-lg-2 input-group clockpicker"
												data-autoclose="true" <?php if (($type_act == 1) && ($row['TodoDia'] == 1)) { ?>style="display: none;" <?php } ?>>
												<?php
												$nuevahora = strtotime('+' . ObtenerVariable("TimeMinAct") . ' minute', time());
												$nuevahora = date('H:i', $nuevahora);
												?>
												<input name="HoraFin" id="HoraFin" type="text" class="form-control"
													value="<?php if ((($type_act == 1) || ($sw_error == 1)) && ($row['HoraFinActividad'] != "00:00")) {
														echo $row['HoraFinActividad'];
													} else {
														echo $nuevahora;
													} ?>"
													required="required" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y') || ($BloqEdit == 1))) {
								...
								<div class="ibox">
									...
									<div class="ibox-content">
										<div class="form-group">
											<label
												class="col-lg-1 control-label"><?php if (($type_act == 1) && ($row['DocMarkDocType'] != "-1")) { ?><a
														href="<?php echo $row['DocMarkPage']; ?>.php?id=<?php echo base64_encode($row['DocMarkDocEntry']); ?>&id_portal=<?php echo base64_encode($row['DocMarkIdPortal']); ?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('actividad.php'); ?>"
														target="_blank" title="Consultar documento"
														class="btn-xs btn-success fa fa-search"></a> <?php } ?>Documento
												asociado</label>
											<div class="col-lg-2">
												<select name="TipoDocMarketing" class="form-control"
													id="TipoDocMarketing" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?>>
													<?php if ($dt_DM != 1) { ?>
														<option value="">(Ninguno)</option><?php } ?>
													<?php while ($row_TipoDocMark = sqlsrv_fetch_array($SQL_TipoDocMark)) { ?>
														<option value="<?php echo $row_TipoDocMark['ID_Objeto']; ?>" <?php if ((isset($row['DocMarkDocType'])) && (strcmp($row_TipoDocMark['ID_Objeto'], $row['DocMarkDocType']) == 0)) {
															   echo "selected=\"selected\"";
														   } elseif (isset($_GET['DM_type']) && (strcmp($row_TipoDocMark['ID_Objeto'], base64_decode($_GET['DM_type'])) == 0)) {
															   echo "selected=\"selected\"";
														   } ?>>
															<?php echo $row_TipoDocMark['DE_Objeto']; ?></option>
													<?php } ?>
												</select>
											</div>
											<label class="col-lg-1 control-label">Número de documento</label>
											<div class="col-lg-2">
												<select name="DocMarketing" class="form-control select2"
													id="DocMarketing" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?>>
													<?php if ($dt_DM != 1) { ?>
														<option value="">(Ninguna)</option><?php } ?>
													<?php if (($type_act == 1) || ($sw_error == 1) || ($dt_DM == 1)) {
														while ($row_DocMarketing = sqlsrv_fetch_array($SQL_DocMarketing)) { ?>
															<option
																value="<?php echo $row_DocMarketing['DocEntry'] . "__" . $row_DocMarketing['DocNum']; ?>"
																<?php if ((isset($row['DocMarkDocEntry'])) && (strcmp($row_DocMarketing['DocEntry'], $row['DocMarkDocEntry']) == 0)) {
																	echo "selected=\"selected\"";
																} elseif (isset($_GET['DM']) && (strcmp($row_DocMarketing['DocEntry'], base64_decode($_GET['DM'])) == 0)) {
																	echo "selected=\"selected\"";
																} ?>>
																<?php echo $row_DocMarketing['DocNum']; ?></option>
														<?php }
													} ?>
												</select>
											</div>
										...
										<div class="form-group">
											<label
												class="col-lg-1 control-label"><?php if (($type_act == 1) && ($row['ID_LlamadaServicio'] != 0)) { ?><a
												...
												servicio</label>
											<div class="col-lg-8">
												<select name="OrdenServicioActividad" class="form-control select2"
													id="OrdenServicioActividad" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
														echo "disabled='disabled'";
													} ?>>
													<?php if ($dt_LS != 1) { ?>
														<option value="">(Ninguna)</option><?php } ?>
								...
								<?php if ($type_act == 1) { ?>
									<div class="ibox">
										...
										<div class="ibox-content">
											<div class="form-group">
												<div class="col-lg-11">
													<textarea name="NotasActividad" rows="10" class="form-control"
														id="NotasActividad" maxlength="3000"
														placeholder="Escriba los comentarios de los trabajos realizados..."
														type="text" <?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
															echo "readonly='readonly'";
														} ?>><?php if (($type_act == 1) || ($sw_error == 1)) {
															echo $row['NotasActividad'];
														} ?></textarea>
												</div>
											</div>
											<div class="form-group">
												<div class="col-lg-9">
													<?php if (($type_act == 1) && (PermitirFuncion(304) && ($row['IdEstadoActividad'] != 'Y'))) { ?>
														<button class="btn btn-success" type="submit" id="Insertar"><i
																class="fa fa-check-square-o"></i>&nbsp;Insertar notas</button>
													<?php } ?>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-2 input-group date">
													<span class="input-group-addon"><i
														...
														name="FechaInicioEjecucion" type="text" class="form-control"
														autocomplete="off" id="FechaInicioEjecucion"
														value="<?php if ((($type_act == 1) || ($sw_error == 1)) && ($row['CDU_FechaInicioEjecucionActividad']) != "") {
															echo $row['CDU_FechaInicioEjecucionActividad'];
														} ?>"
														<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
															echo "readonly='readonly'";
														} ?>>
												...
												<div class="col-lg-2 input-group clockpicker" data-autoclose="true">
													<input name="HoraInicioEjecucion" id="HoraInicioEjecucion" type="text"
														class="form-control"
														value="<?php if ((($type_act == 1) || ($sw_error == 1)) && ($row['CDU_HoraInicioEjecucionActividad'] != "")) {
															echo $row['CDU_HoraInicioEjecucionActividad'];
														} ?>"
														<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
															echo "readonly='readonly'";
														} ?>
														onChange="ValidarHorasEjec();">
													<span class="input-group-addon">
														<span class="fa fa-clock-o"></span>
													</span>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-2 input-group date">
													<span class="input-group-addon"><i
															class="fa fa-calendar"></i></span><input
														name="FechaFinEjecucion" id="FechaFinEjecucion" type="text"
														autocomplete="off" class="form-control"
														value="<?php if ((($type_act == 1) || ($sw_error == 1)) && ($row['CDU_FechaFinEjecucionActividad']) != "") {
												...
												<div class="col-lg-2 input-group clockpicker" data-autoclose="true">
													...
													//$nuevahora = date ('H:i' , $nuevahora);
													?>
													<input name="HoraFinEjecucion" id="HoraFinEjecucion" type="text"
														class="form-control"
														value="<?php if ((($type_act == 1) || ($sw_error == 1)) && ($row['CDU_HoraFinEjecucionActividad'] != "")) {
															echo $row['CDU_HoraFinEjecucionActividad'];
														} ?>"
														<?php if (($type_act == 1) && (!PermitirFuncion(304) || ($row['IdEstadoActividad'] == 'Y'))) {
															echo "readonly='readonly'";
														} ?>
								...
								<div class="ibox">
									...
									<div class="ibox-content">
												...
												<div class="form-group">
													<div class="col-xs-12">
														<?php while ($row_AnexoActividad = sqlsrv_fetch_array($SQL_AnexoActividad)) {
															...
															<div class="file-box">
																<div class="file">
																	<a href="attachdownload.php?file=<?php echo base64_encode($row_AnexoActividad['AbsEntry']); ?>&line=<?php echo base64_encode($row_AnexoActividad['Line']); ?>"
																		target="_blank">
																		<div class="icon">
																		...
																		<div class="file-name">
																			...
																			<?php if (isset($row_AnexoActividad['DeTipoEvidencia']) && $row_AnexoActividad['DeTipoEvidencia'] != "") { ?>
																				<br>
																				<small>Tipo evidencia:
																					<?php echo $row_AnexoActividad['DeTipoEvidencia']; ?></small>
																			<?php } ?>
																		</div>
																	</a>
																</div>
										...
										<input type="hidden" id="pag_param" name="pag_param"
											value="<?php if (isset($_GET['pag'])) {
												echo $_GET['pag'];
											} ?>" />
										<input type="hidden" id="return_param" name="return_param"
											value="<?php if (isset($_GET['return'])) {
												echo base64_encode($_GET['return']);
											} ?>" />
										<input type="hidden" id="return" name="return"
											value="<?php echo base64_encode($return); ?>" />
										<input type="hidden" id="ID" name="ID"
											value="<?php if ($type_act == 1) {
												echo base64_encode($row['ID_Actividad']);
											} ?>" />
										<input type="hidden" id="IdAnexos" name="IdAnexos"
											value="<?php if ($type_act == 1) {
												echo $row['IdAnexoActividad'];
											} ?>" />
										<input type="hidden" id="IdActividadPortal" name="IdActividadPortal"
											value="<?php if (($type_act == 1) && ($sw_error == 0)) {
												echo base64_encode($row['IdActividadPortal']);
											} elseif ($sw_error == 1) {
												echo base64_encode($row['ID_Actividad']);
											} ?>" />
							</form>
					...
					<div class="form-group">
						<div class="col-lg-9">
							<?php if (($type_act == 1) && (PermitirFuncion(304) && ($row['IdEstadoActividad'] != 'Y') && ($BloqEdit == 0))) { ?>
								<button class="btn btn-warning" form="CrearActividad" type="submit" id="Actualizar"><i
										class="fa fa-refresh"></i> Actualizar actividad</button>
							<?php } ?>
							<?php if (($type_act == 1) && (PermitirFuncion(304) && ($row['IdEstadoActividad'] == 'Y') && ($BloqEdit == 0))) { ?>
								<button class="btn btn-success" form="CrearActividad" type="submit"
									onClick="EnviarFrm('42');" id="Reabrir"><i class="fa fa-reply"></i> Reabrir</button>
							<?php } ?>
							<?php if (($type_act == 1) && (PermitirFuncion(313) && ($BloqEdit == 0))) { ?>
								<button class="btn btn-danger" form="CrearActividad" type="submit"
									onClick="EnviarFrm('41');" id="Eliminar"><i class="fa fa-trash"></i> Eliminar</button>
							<?php } ?>
							<?php if ($type_act == 0) { ?>
								<button class="btn btn-primary" form="CrearActividad" type="submit" id="Crear"><i
										class="fa fa-check"></i> Crear actividad</button>
							<?php } ?>
