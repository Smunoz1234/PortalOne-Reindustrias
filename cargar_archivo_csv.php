           ...
           <div class="col-lg-12">
             ...
             <form action="registro.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="AgregarArchivos" onSubmit="return ComprobarExt();">
			   ...
			   <div class="row">
				   <div class="col-lg-12">
						<div class="col-sm-9">
							<button class="btn btn-primary" type="submit">Continuar <i class="fa fa-arrow-circle-right"></i></button> <a href="cargue_masivo_archivos.php" class="btn btn-outline btn-default"><i class="fa fa-arrow-circle-o-left"></i> Cancelar</a>
						</div>
						<input type="hidden" id="P" name="P" value="22" />
				   </div>
			   </div>
			   </form>
			   </div>
