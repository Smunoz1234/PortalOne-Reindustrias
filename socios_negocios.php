	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content">
				...
				<!-- Fin, myModal -->
				<form action="socios_negocios.php" method="post" class="form-horizontal" enctype="multipart/form-data"
					id="EditarSN" name="EditarSN">
					<div class="row">
						<div class="col-lg-12">
							<div class="ibox-content">
									...
									<div class="col-lg-6">
										...
										if ($edit == 1) {
											if (PermitirFuncion(503) || ($Metod == 4 && PermitirFuncion(505)) || (PermitirFuncion(504) && ($row['CardType'] == "L"))) { ?>
												<button class="btn btn-warning" type="submit" id="Crear"><i
														class="fa fa-refresh"></i> Actualizar Socio de negocio</button>
											<?php }
										} else {
											if (PermitirFuncion(501)) { ?>
												<button class="btn btn-primary" type="submit" id="Crear"><i
														class="fa fa-check"></i> Crear Socio de negocio</button>
											<?php }
										} ?>
										<?php
										...
										<?php if ($edit == 1 && isset($row["TipoSN"]) && ($row["TipoSN"] == "CLIENTE")) { ?>
											<div class="btn-group">
												<button data-toggle="dropdown" class="btn btn-success dropdown-toggle"><i
														class="fa fa-plus-circle"></i> Agregar documento <i
														class="fa fa-caret-down"></i></button>
												<ul class="dropdown-menu">
													<li>
														<a class="dropdown-item"
															href="llamada_servicio.php?dt_LS=1&Cardcode=<?php echo base64_encode($row['CodigoCliente']); ?>"
															target="_blank">Crear llamada de servicio</a>
													</li>
													<li>
														<a class="dropdown-item"
															href="tarjeta_equipo.php?dt_TE=1&Cardcode=<?php echo base64_encode($row['CodigoCliente']); ?>"
															target="_blank">Crear tarjeta de equipo</a>
													</li>
												</ul>
											</div>
										<?php } else {
								...
								<div class="form-group">
									<div class="col-lg-12">
										<p><button type="button" class="btn btn-outline btn-link"
												onClick="CapturarGPS();" title="Obtener coordenadas nuevamente"><i
													class="fa fa-map-marker"></i> Coordenadas GPS: </button><span
												id="CoordGPS"></span></p>
									</div>
								</div>
								...
								<input type="hidden" id="EsProyecto" name="EsProyecto"
									value="<?php echo $EsProyecto; ?>" />
							...
							<div class="ibox-content">
								...
								<div class="tabs-container">
									<ul class="nav nav-tabs">
										...
										<li><a data-toggle="tab" href="#tabSN-2"><i class="fa fa-user-circle"></i>
												Contactos</a></li>
										<li><a data-toggle="tab" href="#tabSN-3"><i class="fa fa-home"></i>
												Direcciones</a></li>
										<?php if ($edit == 1) { ?>
											<li><a data-toggle="tab" href="#tabSN-4"><i class="fa fa-folder-open"></i>
													Documentos relacionados</a></li><?php } ?>
										<?php if ($edit == 1) { ?>
											<li><a data-toggle="tab" href="#tabSN-5" onClick="ConsultarTab('501');"><i
														class="fa fa-handshake-o" aria-hidden="true"></i> Contratos</a></li>
										<?php } ?>
										<li><a data-toggle="tab" href="#tabSN-6"><i class="fa fa-paperclip"></i>
												Anexos</a></li>
									</ul>
									<div class="tab-content">
										<div id="tabSN-1" class="tab-pane active">
											<div class="col-lg-1">
												<div id="spinner1" style="visibility: hidden;"
											...
											<div class="form-group">
												<label class="col-xs-12">
													<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-info-circle"></i>
											...
											<div class="form-group">
												...
												<div class="col-lg-3">
													<input name="CardCode" autofocus="autofocus" type="text" readonly
														class="form-control" id="CardCode" value="<?php if ($edit == 1) {
											...
											<div class="form-group">
												<label class="col-lg-1 control-label">Tipo entidad <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<select name="TipoEntidad" class="form-control" id="TipoEntidad"
														required>
												...
												<label class="col-lg-1 control-label">Tipo documento <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
												...
												<label class="col-lg-1 control-label">Número documento <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<input name="LicTradNum" type="text" required class="form-control"
														id="LicTradNum" value="<?php if ($edit == 1 || $sw_error == 1) {
															echo $row['LicTradNum'];
											...
											<div class="form-group">
												...
												<div class="col-lg-3">
													<input name="PNNombres" type="text" class="form-control"
														id="PNNombres" onkeyup="mayus(this);" readonly="readonly" value="<?php if ($edit == 1 || $sw_error == 1) {
															echo strtoupper($row['U_HBT_Nombres']);
														} ?>" onChange="CrearNombre();">
												</div>
												<label class="col-lg-1 control-label">Primer apellido</label>
												<div class="col-lg-3">
													<input name="PNApellido1" type="text" class="form-control"
														id="PNApellido1" onkeyup="mayus(this);" readonly="readonly"
												...
												<div class="col-lg-3">
													<input name="PNApellido2" type="text" class="form-control"
														id="PNApellido2" onkeyup="mayus(this);" readonly="readonly"
														value="<?php if ($edit == 1 || $sw_error == 1) {
											...
											<div class="form-group">
												<label class="col-lg-1 control-label">Nombre cliente/Razón social <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<input type="text" class="form-control" name="CardName"
														id="CardName" onkeyup="mayus(this);" required value="<?php if ($edit == 1 || $sw_error == 1) {
												...
												<div class="col-lg-3">
													<input type="text" readonly class="form-control"
														name="EstadoServicio" id="EstadoServicio" value="<?php if ($edit == 1) {
												...
												<div class="col-lg-3">
													<input type="email" class="form-control" name="CorreoCliente"
														id="CorreoCliente" required value="<?php if ($edit == 1 || $sw_error == 1) {
															echo ($row['Email']);
											...
											<div class="form-group">
												...
												<div class="col-lg-3">
													<input type="text" class="form-control" name="TelefonoCliente"
														id="TelefonoCliente" onkeyup="mayus(this);" required value="<?php if ($edit == 1 || $sw_error == 1) {
															echo ($row['Telefono']);
														} ?>" <?php if ($edit == 0) { ?>onChange="CopiarNombreCont();" <?php } ?>>
												</div>
												...
												<div class="col-lg-3">
													<input type="text" class="form-control" name="CelularCliente"
														id="CelularCliente" onkeyup="mayus(this);" required value="<?php if ($edit == 1 || $sw_error == 1) {
															echo ($row['Celular']);
														} ?>" <?php if ($edit == 0) { ?>onChange="CopiarNombreCont();" <?php } ?>>
												</div>
												<label class="col-lg-1 control-label">Vendedor <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<select name="EmpleadoVentas" class="form-control"
														id="EmpleadoVentas" required="required">
											...
											<div class="form-group">
												<label class="col-xs-12">
													<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-briefcase"></i>
											...
											<div class="form-group">
												...
												<div class="col-lg-3">
													<input name="AliasName" type="text" required class="form-control"
														id="AliasName" value="<?php if ($edit == 1 || $sw_error == 1) {
												...
												<label class="col-lg-1 control-label">Grupo <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<select name="GroupCode" class="form-control select2" id="GroupCode"
														required>
														<option value="">Seleccione...</option>
											...
											<div class="form-group">
												...
												<label class="col-lg-1 control-label">Medio de pago <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<select name="MedioPago" class="form-control select2" id="MedioPago"
														required>
												...
												<label class="col-lg-1 control-label">Tipo nacionalidad <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<select name="TipoNacionalidad" class="form-control"
														id="TipoNacionalidad" required>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label">Tipo extranjero <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<select name="TipoExtranjero" class="form-control"
														id="TipoExtranjero" required>
												...
												<label class="col-lg-1 control-label">Industria <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
												...
												<label class="col-lg-1 control-label">Territorio <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<select name="Territorio" class="form-control select2"
														id="Territorio" required>
											...
											<div class="form-group">
												<label class="col-xs-12">
													<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-bank"></i>
														Información tributaria</h3>
												</label>
											</div>
											<div class="form-group">
												<label class="col-lg-1 control-label">Régimen tributario <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<select name="RegimenTributario" class="form-control"
														id="RegimenTributario" required>
														<option value="">Seleccione...</option>
												...
												<label class="col-lg-1 control-label">Régimen fiscal <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
												...
												<label class="col-lg-1 control-label">Responsabilidad fiscal <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<select name="ResponsabilidadFiscal" class="form-control select2"
														id="ResponsabilidadFiscal" required>
														<option value="">Seleccione...</option>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label">Municipio MM <span
														class="text-danger">*</span></label>
												<div class="col-lg-3">
													<input name="ID_MunicipioMM" type="hidden" id="ID_MunicipioMM"
														value="<?php if ($edit == 1 || $sw_error == 1) {
															echo $row_MunMM['ID_Municipio'];
														} elseif (isset($row_Municipio['ID_Municipio'])) {
															echo $row_Municipio['ID_Municipio'];
														} ?>">
													<input name="MunicipioMM" type="text" class="form-control"
														id="MunicipioMM" placeholder="Digite para buscar..." value="<?php if ($edit == 1 || $sw_error == 1) {
											...
											<?php if ($edit == 1) { ?>
												<div class="form-group">
													<label class="col-xs-12">
														<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-credit-card"></i>
															Datos de finanzas</h3>
													</label>
												</div>
												<div class="form-group">
													...
													<div class="col-lg-3">
														<input name="Balance" type="text" class="form-control" id="Balance"
															value="<?php echo number_format($row['Balance'] ?? 0, 2); ?>"
															readonly="readonly">
													</div>
													<label class="col-lg-1 control-label">Limite de crédito</label>
													<div class="col-lg-3">
														<input name="LimiteCredito" type="text" class="form-control"
															id="LimiteCredito"
															value="<?php echo number_format($row['CreditLine'] ?? 0, 2); ?>"
															readonly="readonly">
													</div>
													<label class="col-lg-1 control-label">Crédito consumido</label>
													<div class="col-lg-3">
														<input name="CreditoConsumido" type="text" class="form-control"
															id="CreditoConsumido"
															value="<?php echo number_format($row['CreditoConsumido'] ?? 0, 2); ?>"
															readonly="readonly">
													</div>
												</div>
											<?php } ?>
										...
										<div id="tabSN-2" class="tab-pane">
											...
											<div class="panel-body">
												<div class="col-lg-6">
													<iframe id="frameCtc" name="frameCtc" style="border: 0;"
														width="100%" height="500" src="sn_contactos_lista.php?id=<?php if ($edit == 1) {
										...
										<div id="tabSN-3" class="tab-pane">
											...
											<div class="panel-body">
												<div class="col-lg-6">
													<iframe id="frameDir" name="frameDir" style="border: 0;"
														width="100%" height="700" src="sn_direcciones_lista.php?id=<?php if ($edit == 1) {
															echo base64_encode($row['CodigoCliente']);
														} ?>&edit=<?php echo base64_encode($edit); ?>"></iframe>
												</div>
												<div class="col-lg-6">
												...
												<div class="tabs-container">
													<ul class="nav nav-tabs">
														<li class="active"><a data-toggle="tab" href="#tab-1"><i
																	class="fa fa-laptop"></i> Listas de materiales</a></li>
														<li><a data-toggle="tab" href="#tab-7"
																onClick="ConsultarTab('7');"><i class="fa fa-car"></i>
																Tarjetas de equipo</a></li>
														<li><a data-toggle="tab" href="#tab-2"
																onClick="ConsultarTab('2');"><i class="fa fa-phone"></i>
																Llamadas de servicios</a></li>
														<li><a data-toggle="tab" href="#tab-3"
																onClick="ConsultarTab('3');"><i class="fa fa-calendar"></i>
																Actividades</a></li>
														<li><a data-toggle="tab" href="#tab-4"><i
																	class="fa fa-file-text"></i> Facturas pendientes</a>
														</li>
														<li><a data-toggle="tab" href="#tab-5"
																onClick="ConsultarTab('5');"><i class="fa fa-money"></i>
																Pagos realizados</a></li>
														<li><a data-toggle="tab" href="#tab-8"
																onClick="ConsultarTab('8');"><i class="fa fa-money"></i>
																Anticipos realizados</a></li>
														<li><a data-toggle="tab" href="#tab-6"><i
																	class="fa fa-suitcase"></i> Historico de cartera</a>
														</li>
													</ul>
													<div class="tab-content">
																		...
																		<tbody>
																			<?php while ($row_IDServicio = sql_fetch_array($SQL_IDServicio)) {
																				...
																				<tr class="gradeX tooltip-demo">
																					<td><?php echo $row_IDServicio['ItemCode']; ?>
																					</td>
																					<td><?php echo $row_IDServicio['ItemName']; ?>
																					</td>
																					<td><?php echo $row_IDServicio['NombreSucursal']; ?>
																					</td>
																					<td><?php echo $row_IDServicio['Servicios']; ?>
																					</td>
																					<td><?php echo $row_IDServicio['Areas']; ?>
																					</td>
																					<td><span <?php if ($row_IDServicio['Estado'] == 'Y') {
																						echo "class='label label-info'";
																					} else {
																						echo "class='label label-danger'";
																					} ?>><?php echo $row_IDServicio['NombreEstado']; ?></span>
																					</td>
																					<td><a href="articulos.php?id=<?php echo base64_encode($row_IDServicio['ItemCode']); ?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('socios_negocios.php'); ?>"
																			...
																			<table
																				...
																				<tbody>
																					<?php while ($row_FactPend = sqlsrv_fetch_array($SQL_FactPend)) { ?>
																						<tr>
																							<td><?php echo $row_FactPend['NoDocumento']; ?>
																							</td>
																							...
																							<td><?php echo "$" . number_format($row_FactPend['TotalDocumento'], 2); ?>
																							</td>
																							<td><?php echo "$" . number_format($row_FactPend['ValorPagoDocumento'], 2); ?>
																							</td>
																							<td><?php echo number_format($row_FactPend['DiasVencidos'], 0); ?>
																							</td>
																							<td><?php echo "$" . number_format($row_FactPend['SaldoDocumento'], 2); ?>
																							</td>

																							<td> <!-- SMM, 11/03/2022 -->
																								<a
																									onClick="MostrarPlazos('<?php echo $row_FactPend['NoDocumento']; ?>');"><?php echo $row_FactPend['CantidadPlazo']; ?></a>
																							</td>

																							<td>
																								<a href="factura_venta.php?id=<?php echo base64_encode($row_FactPend['NoInterno']); ?>&id_portal=<?php echo base64_encode($row_FactPend['IdDocPortal']); ?>&tl=1"
																									class="btn btn-success btn-xs"
																									target="_blank"><i
																										class="fa fa-folder-open-o"></i>
																									Abrir</a>
																								<a href="sapdownload.php?id=<?php echo base64_encode('15'); ?>&type=<?php echo base64_encode('2'); ?>&DocKey=<?php echo base64_encode($row_FactPend['NoInterno']); ?>&ObType=<?php echo base64_encode('13'); ?>&IdFrm=<?php echo base64_encode($row_FactPend['IdSeries']); ?>"
																									target="_blank"
																									class="btn btn-warning btn-xs"><i
																										class="fa fa-download"></i>
																									Descargar</a>
																								<?php if ($row_FactPend['URLVisorPublico'] != "") { ?><a
																										href="<?php echo $row_FactPend['URLVisorPublico']; ?>"
																										target="_blank"
																										class="btn btn-primary btn-xs"
																										title="Ver factura eléctronica"><i
																							...
																							<td>
																								<div
																									...
																									<input type="checkbox"
																										id="singleCheckbox<?php echo $row_FactPend['NoDocumento']; ?>"
																										value=""
																										onChange="SeleccionarFactura('<?php echo base64_encode($row_FactPend['NoInterno']); ?>','<?php echo base64_encode('13'); ?>','<?php echo base64_encode($row_FactPend['Series']); ?>');"
																					...
																					<tr id="dwnAllFact"
																						...
																						<td colspan="9" class="text-right">
																							<input type="hidden"
																								id="FactSel" name="FactSel"
																								value="" />
																							<input type="hidden"
																								id="FactFrm" name="FactFrm"
																								value="" />
																							<a id="LinkAllFact" href="#"
																								target="_blank"
																			...
																			<table class="table table-bordered">
																				...
																				<tbody>
																					<?php while ($row_HistGestion = sqlsrv_fetch_array($SQL_HistGestion)) { ?>
																						<tr class="gradeX">
																							<td><?php echo $row_HistGestion['TipoGestion']; ?>
																							</td>
																							<td><?php echo $row_HistGestion['Destino']; ?>
																							</td>
																							<td><?php echo $row_HistGestion['NombreEvento']; ?>
																							</td>
																							<td><?php echo $row_HistGestion['ResultadoGestion']; ?>
																							</td>
																							<td><?php echo $row_HistGestion['Comentarios']; ?>
																							</td>
																							<td><?php echo $row_HistGestion['CausaNoPago']; ?>
																							</td>
																							...
																							<td><?php echo $row_HistGestion['Usuario']; ?>
																							</td>
																						</tr>
																					<?php } ?>
																				</tbody>
