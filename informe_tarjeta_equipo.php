...
$FI_FechaFactura = "";
$FF_FechaFactura = "";
if (isset($_GET['FI_FechaFactura']) && $_GET['FI_FechaFactura'] != "") {
	$FI_FechaFactura = $_GET['FI_FechaFactura'];
	$sw = 1;
} else {
	//Restar 7 dias a la fecha actual
	$fecha = date('Y-m-d');
	$nuevafecha = strtotime('-' . ObtenerVariable("DiasRangoFechasGestionar") . ' day');
	$nuevafecha = date('Y-m-d', $nuevafecha);
	// $FI_FechaFactura = $nuevafecha;
}
if (isset($_GET['FF_FechaFactura']) && $_GET['FF_FechaFactura'] != "") {
	$FF_FechaFactura = $_GET['FF_FechaFactura'];
	$sw = 1;
} else {
	// $FF_FechaFactura = date('Y-m-d');
}
...
if ($sw == 1) {
	$Param = array(
		...
		"'" . FormatoFecha($FI_FechaFactura) . "'",
		"'" . FormatoFecha($FF_FechaFactura) . "'",
	);
						...
						<div class="ibox-content">
							...
							<form action="informe_tarjeta_equipo.php" method="get" id="formBuscar"
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<div class="input-daterange input-group">
											<input name="FI_FechaFactura" type="text"
												class="input-sm form-control fecha" id="FI_FechaFactura"
												placeholder="Fecha inicial" value="<?php echo $FI_FechaFactura; ?>"
												autocomplete="off" />
											<span class="input-group-addon">hasta</span>
											<input name="FF_FechaFactura" type="text"
