...
$FI_Fecha_Factura = "";
$FF_Fecha_Factura = "";
if (isset($_GET['FI_Fecha_Factura']) && $_GET['FI_Fecha_Factura'] != "") {
	$FI_Fecha_Factura = $_GET['FI_Fecha_Factura'];
	$sw = 1;
} else {
	//Restar 7 dias a la fecha actual
	$fecha = date('Y-m-d');
	$nuevafecha = strtotime('-' . ObtenerVariable("DiasRangoFechasGestionar") . ' day');
	$nuevafecha = date('Y-m-d', $nuevafecha);
	// $FI_Fecha_Factura = $nuevafecha;
}
if (isset($_GET['FF_Fecha_Factura']) && $_GET['FF_Fecha_Factura'] != "") {
	$FF_Fecha_Factura = $_GET['FF_Fecha_Factura'];
	$sw = 1;
} else {
	// $FF_Fecha_Factura = date('Y-m-d');
}
...
if ($sw == 1) {
	$Param = array(
		...
		"'" . FormatoFecha($FI_Fecha_Factura) . "'",
		"'" . FormatoFecha($FF_Fecha_Factura) . "'",
	);
						...
						<div class="ibox-content">
							...
							<form action="informe_tarjeta_equipo.php" method="get" id="formBuscar"
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<div class="input-daterange input-group">
											<input name="FI_FechaMatricula" type="text"
												class="input-sm form-control fecha" id="FI_FechaMatricula"
												placeholder="Fecha inicial" value="<?php echo $FI_FechaMatricula; ?>"
												autocomplete="off" />
											<span class="input-group-addon">hasta</span>
											<input name="FF_FechaMatricula" type="text"
												class="input-sm form-control fecha" id="FF_FechaMatricula"
												placeholder="Fecha final" value="<?php echo $FF_FechaMatricula; ?>"
												autocomplete="off" />
										</div>
									</div>
									...
									<div class="col-lg-3">
										<div class="input-daterange input-group">
											<input name="FI_Fecha_SOAT" type="text" class="input-sm form-control fecha"
												id="FI_Fecha_SOAT" placeholder="Fecha inicial"
												value="<?php echo $FI_Fecha_SOAT; ?>" autocomplete="off" />
											<span class="input-group-addon">hasta</span>
											<input name="FF_Fecha_SOAT" type="text" class="input-sm form-control fecha"
												id="FF_Fecha_SOAT" placeholder="Fecha final"
												value="<?php echo $FF_Fecha_SOAT; ?>" autocomplete="off" />
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<div class="input-daterange input-group">
											<input name="FI_FechaUlt_Mant" type="text"
												class="input-sm form-control fecha" id="FI_FechaUlt_Mant"
												placeholder="Fecha inicial" value="<?php echo $FI_FechaUlt_Mant; ?>"
												autocomplete="off" />
											<span class="input-group-addon">hasta</span>
											<input name="FF_FechaUlt_Mant" type="text"
												class="input-sm form-control fecha" id="FF_FechaUlt_Mant"
												placeholder="Fecha final" value="<?php echo $FF_FechaUlt_Mant; ?>"
												autocomplete="off" />
										</div>
									</div>
									...
									<div class="col-lg-3">
										<div class="input-daterange input-group">
											<input name="FI_Fecha_Tecno" type="text" class="input-sm form-control fecha"
												id="FI_Fecha_Tecno" placeholder="Fecha inicial"
												value="<?php echo $FI_Fecha_Tecno; ?>" autocomplete="off" />
											<span class="input-group-addon">hasta</span>
											<input name="FF_Fecha_Tecno" type="text" class="input-sm form-control fecha"
												id="FF_Fecha_Tecno" placeholder="Fecha final"
												value="<?php echo $FF_Fecha_Tecno; ?>" autocomplete="off" />
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<div class="input-daterange input-group">
											<input name="FI_FechaProx_CambAceite" type="text"
												class="input-sm form-control fecha" id="FI_FechaProx_CambAceite"
												placeholder="Fecha inicial"
												value="<?php echo $FI_FechaProx_CambAceite; ?>" autocomplete="off" />
											<span class="input-group-addon">hasta</span>
											<input name="FF_FechaProx_CambAceite" type="text"
												class="input-sm form-control fecha" id="FF_FechaProx_CambAceite"
												placeholder="Fecha final"
												value="<?php echo $FF_FechaProx_CambAceite; ?>" autocomplete="off" />
										</div>
									</div>
									...
									<div class="col-lg-3">
										<div class="input-daterange input-group">
											<input name="FI_Fecha_Factura" type="text"
												class="input-sm form-control fecha" id="FI_Fecha_Factura"
												placeholder="Fecha inicial" value="<?php echo $FI_Fecha_Factura; ?>"
												autocomplete="off" />
											<span class="input-group-addon">hasta</span>
											<input name="FF_Fecha_Factura" type="text"
												class="input-sm form-control fecha" id="FF_Fecha_Factura"
												placeholder="Fecha final" value="<?php echo $FF_Fecha_Factura; ?>"
												autocomplete="off" />
										</div>
									</div>
								</div>
