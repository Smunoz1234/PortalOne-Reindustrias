							...
							<div class="ibox-content">
								...
								<div class="form-group">
									<div class="col-lg-6">
										...
										<button class="btn btn-warning" type="button" id="NewParam"
											onClick="CrearParametro();"><i class="fa fa-plus-circle"></i> Crear nuevo
											valor</button>
									</div>
								</div>
								...
								<div class="tabs-container">
									<ul class="nav nav-tabs">
										<li class="active"><a data-toggle="tab" href="#tab-1"><i
													class="fa fa-calendar"></i> Rutero</a></li>
										<li><a data-toggle="tab" href="#tab-2"><i class="fa fa-tasks"></i> Creación de
												OT</a></li>
									</ul>
											...
											<div class="form-group">
												<label class="col-xs-12">
													<h3 class="bg-success p-xs b-r-sm"><i
															class="fa fa-check-square-o"></i> Lista de parámetros de
														rutero</h3>
												</label>
											</div>
											<input name="<?php echo $row_Rutas['ID_Campo']; ?>" type="hidden"
												id="<?php echo $row_Rutas['ID_Campo']; ?>"
												value="<?php echo $row_Rutas['ID_Campo']; ?>">
											<?php
											while ($row_Rutas = sqlsrv_fetch_array($SQL_Rutas)) {
												...
												<div class="form-group">
													<label class="col-lg-2 control-label">
														<?php echo $row_Rutas['LabelCampo']; ?><br><span class="text-muted">
															<?php echo $row_Rutas['NombreCampo']; ?>
														</span>
													</label>
													<div class="col-lg-3">
														<input name="<?php echo $row_Rutas['NombreCampo']; ?>" type="text"
															class="form-control"
															id="<?php echo $row_Rutas['NombreCampo']; ?>" maxlength="100"
															value="<?php echo $row_Data['Valor']; ?>" autocomplete="off">
														<input name="<?php echo $row_Rutas['ID_Campo']; ?>" type="hidden"
															id="<?php echo $row_Rutas['ID_Campo']; ?>"
															value="<?php echo $row_Rutas['ID_Campo']; ?>">
													</div>
													...
													<select name="Series" class="form-control" id="Series">
														...
														<?php while ($row_Series = sqlsrv_fetch_array($SQL_Series)) { ?>
															<option value="<?php echo $row_Series['IdSeries']; ?>" <?php if ((isset($_GET['Series'])) && (strcmp($row_Series['IdSeries'], $_GET['Series']) == 0)) {
																...
																<?php echo $row_Series['DeSeries'] . " ({$row_Series['IdSeries']})"; ?>
															</option>
														<?php } ?>
													</select>
												</div>
