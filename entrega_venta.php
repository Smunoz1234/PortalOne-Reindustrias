			   ...
			   <form id="frm" action="" class="form-horizontal">
				...
				<div class="col-lg-8">
					<div class="form-group">
						...
						<div class="col-lg-5">
							<select name="EmpleadoVentas" class="form-control" id="EmpleadoVentas" form="CrearEntregaVenta" required="required" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
								echo "disabled='disabled'";
							} ?>>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<textarea name="Comentarios" form="CrearEntregaVenta" maxlength="2000" rows="4" class="form-control" id="Comentarios" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
								echo "readonly";
				...
				<div class="col-lg-4">
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="SubTotal" form="CrearEntregaVenta" id="SubTotal" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="Descuentos" form="CrearEntregaVenta" id="Descuentos" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="Impuestos" form="CrearEntregaVenta" id="Impuestos" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="TotalEntrega" form="CrearEntregaVenta" id="TotalEntrega" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
