                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-3">
                                            <select name="Cliente" class="form-control select2" id="Cliente">
                                                <?php if ($sw_todos == 1) { ?>
                                                    <option value="" selected="selected">(Todos)</option><?php } ?>
                                        ...
                                        <div class="col-lg-1">
                                            <button type="submit" name="submit" class="btn btn-outline btn-primary"><i
                                            ...
                                            <?php while ($row = sqlsrv_fetch_array($SQL)) { ?>
                                                <tr class="gradeX">
                                                    ...
                                                    <td><?php if ($row['Archivo'] != "") { ?><a
                                                                href="filedownload.php?file=<?php echo base64_encode($row['ID_Archivo']); ?>&dtype=<?php echo base64_encode("2"); ?>"
                                                                target="_blank" class="btn btn-success btn-xs"><i
                                                                    class="fa fa-download"></i> Descargar</a><?php } else { ?>
                                                            <p class="text-muted">Ninguno</p><?php } ?>
                                                    </td>
                                                    <td align="center">
                                                        <?php if (ConsultarDescargaArchivo($row['ID_Archivo']) == 0) {
                                                            echo "<i title='No se ha descargado' class='fa fa-eye-slash'></i>";
                                                        } else {
                                                            echo "<i title='Ult. Fecha descarga: " . ConsultarFechaDescarga($row['ID_Archivo']) . "' class='fa fa-eye'></i>";
                                                        } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
