								...
								<div class="form-group">
									<div class="col-lg-6">
										<button class="btn btn-primary" type="button" id="NewParam"
											onClick="CrearCampo();"><i class="fa fa-plus-circle"></i> Crear nuevo
											registro</button>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-xs-12">
										<h3 class="bg-success p-xs b-r-sm">
											<i class="fa fa-check-square-o"></i> Lista de formatos
										</h3>
									</label>
								</div>
										...
										<tbody>
											<?php while ($row = sqlsrv_fetch_array($SQL)) { ?>
												<tr class="gradeX">
													...
													<td><?php echo $row['IdBodegaDefecto'] . " - " . $row['DeBodegaDefecto']; ?>
													</td>

													<td>
														<button type="button" id="btnEdit<?php echo $row['ID']; ?>"
															class="btn btn-success btn-xs"
															onclick="EditarCampo('<?php echo $row['ID']; ?>');"><i
																class="fa fa-pencil"></i> Editar</button>
														<button type="button" id="btnDel<?php echo $row['ID']; ?>"
															class="btn btn-danger btn-xs"
															onclick="BorrarLinea('<?php echo $row['ID']; ?>');"><i
