...
<head>
	...
	<title>Cambiar contraseña | <?php echo NOMBRE_PORTAL; ?></title>
	<!-- InstanceEndEditable -->
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<form action="cambiar_clave.php" method="post" class="form-horizontal" id="CambiarClave"
								enctype="application/x-www-form-urlencoded">
								<div class="form-group">
									<label class="col-xs-12">
										<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-info-circle"></i> Ingrese la
											información</h3>
									</label>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">Contraseña actual</label>
									<div class="col-sm-3"><input name="PasswordActual" type="password" autofocus
											required="required" class="form-control" id="PasswordActual" maxlength="50">
									</div>
								</div>
								<div class="form-group" id="pwd-container1">
									<label class="col-sm-2 control-label">Nueva contraseña</label>
									<div class="col-sm-3"><input name="PasswordNueva" type="password"
											required="required" class="form-control example1" id="PasswordNueva"
											maxlength="50"></div>
									<div class="col-sm-5">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label">Reescriba la contraseña</label>
									<div class="col-sm-3"><input name="PasswordConfirmacion" type="password"
											required="required" class="form-control" id="PasswordConfirmacion"
											maxlength="50"></div>
								</div>
								<div class="form-group">
									<div class="col-sm-9">
										<button class="btn btn-success" type="submit"><i
												class="fa fa-lock"></i>&nbsp;Cambiar</button> <a href="index1.php"
							...
							<div class="alert alert-info">
								...
								<ul style="font-size: 1.2em;">
									...
									<li>Deben constar únicamente de caracteres del alfabeto latino que se encuentren en
										un teclado en inglés (no deben tener acentos ni otros diacríticos).</li>
									<li>Deben ser una combinación de por lo menos tres de los siguientes tipos de
										carácteres: mayúsculas, minúsculas, números y signos de puntuación.</li>
									...
									<li>No deben contener caracteres repetidos o secuencias de caracteres tales como
										1234, 2222, ABCD o letras adyacentes del teclado</li>
								</ul>
							</div>
						</div>
					</div>
