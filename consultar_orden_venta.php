...
<head>
	...
	<title>
		<?php echo NOMBRE_PORTAL; ?> | Consultar orden de venta
	</title>
	<!-- InstanceEndEditable -->
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<form action="consultar_orden_venta.php" method="get" id="formBuscar"
												...
												<tr class="gradeX">
													...
													<td>
														<?php if ($row['ID_LlamadaServicio'] != 0) { ?><a
																href="llamada_servicio.php?id=<?php echo base64_encode($row['ID_LlamadaServicio']); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('consultar_orden_venta.php'); ?>&tl=1"
																target="_blank">
													...
													<td>
														<a href="orden_venta.php?id=<?php echo base64_encode($row['ID_OrdenVenta']); ?>&id_portal=<?php echo base64_encode($row['IdDocPortal']); ?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('consultar_orden_venta.php'); ?>"
