							...
							<tbody>
								...
								while ($row = sqlsrv_fetch_array($SQL_Items)) {
									...
									<tr style="cursor: pointer;"
										onClick="BuscarSerial('<?php echo $row['ItemCode']; ?>','<?php echo $row['WhsCode']; ?>','<?php echo $row['LineNum']; ?>','<?php echo base64_encode($row['ItemName']); ?>','<?php echo $row['UnitMsr']; ?>','<?php echo number_format($row['Quantity'], 0); ?>');">
										<td>
