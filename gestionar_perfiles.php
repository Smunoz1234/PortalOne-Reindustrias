							...
							<div class="ibox">
								...
								<div class="ibox-content">
									<div class="form-group">
										<div class="col-lg-6">
											<a href="perfil.php" class="btn btn-outline btn-primary"><i
													class="fa fa-plus-circle"></i> Agregar perfil</a>
										</div>
									</div>
								</div>
							</div>
									...
									<tbody>
										<?php while ($row = sqlsrv_fetch_array($SQL)) { ?>
											<tr>
												...
												<td>
													<a href="perfil.php?id=<?php echo base64_encode($row['ID_PerfilUsuario']); ?>&tl=1"
														class="btn btn-info btn-circle" title="Editar"><i
															class="fa fa-edit"></i></a>
													<?php if ($row['CantUsuarios'] == 0) { ?><a href="#"
															onClick="Eliminar(<?php echo $row['ID_PerfilUsuario']; ?>);"
															class="btn btn-danger btn-circle" title="Eliminar"><i
																class="fa fa-eraser"></i></a><?php } ?>
												</td>
											</tr>
										<?php } ?>
									</tbody>
