									...
									<div class="form-group">
										<div class="col-xs-12">
											<?php while ($row_Anexo = sqlsrv_fetch_array($SQL_Anexos)) {$Icon = IconAttach($row_Anexo['FileExt']);?>
												<div class="file-box">
													<div class="file">
														<a href="attachdownload.php?swError=<?php echo $sw_error; ?>&file=<?php echo base64_encode($row_Anexo['AbsEntry']); ?>&line=<?php echo base64_encode($row_Anexo['Line']); ?>" target="_blank">
															<div class="icon">
															...
															<div class="file-name">
																...
																<br/>
																<small><?php echo $row_Anexo['Fecha']->format('Y-m-d'); ?></small>
															</div>
														</a>
													</div>
												</div>
