...
// SMM, 24/01/2024
$Cons = "SELECT * FROM uvw_Sap_tbl_SolicitudesCompras_Borrador WHERE $WhereFecha $Filtro ORDER BY DocNum DESC";
...
if (isset($_GET['IDTicket']) && $_GET['IDTicket'] != "") {
	...
	$Cons = "SELECT * FROM uvw_Sap_tbl_SolicitudesCompras_Borrador WHERE $Where";
}
...
<head>
	...
	<title>Consultar solicitud de compra borrador |
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-8">
					<h2>Consultar solicitud de compra borrador</h2>
					<ol class="breadcrumb">
						<li>
						...
						<li class="active">
							<strong>Consultar solicitud de compra borrador</strong>
						</li>
					</ol>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<form action="consultar_solicitud_compra_borrador.php" method="get" id="formBuscar"
									...
									<tbody>
										<?php if ($sw == 1) { ?>
											<?php while ($row = sqlsrv_fetch_array($SQL)) { ?>
												<tr class="gradeX">
													<td>
														<?php echo $row['ID_SolicitudCompra']; ?>
													</td>
													<td>
														<?php echo $row['DocNum']; ?>
													</td>
													...
													<td>
														<a href="solicitud_compra_borrador.php?id=<?php echo base64_encode($row['ID_SolicitudCompra']); ?>&id_portal=<?php echo base64_encode($row['IdDocPortal']); ?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('consultar_solicitud_compra_borrador.php'); ?>"
															class="alkin btn btn-success btn-xs"><i
																class="fa fa-folder-open-o"></i> Abrir</a>
														<a href="sapdownload.php?id=<?php echo base64_encode('15'); ?>&type=<?php echo base64_encode('2'); ?>&DocKey=<?php echo base64_encode($row['ID_SolicitudCompra']); ?>&ObType=<?php echo base64_encode('1470000113'); ?>&IdFrm=<?php echo base64_encode($row['IdSeries']); ?>"
