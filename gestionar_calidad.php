...
<head>
	...
	<title><?php echo NOMBRE_PORTAL; ?> | Gestionar documentos calidad</title>
	<!-- InstanceEndEditable -->
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				...
				<div class="col-sm-4">
					<div class="title-action">
						<a href="calidad_add.php" class="btn btn-primary"><i class="fa fa-upload"></i> Cargar
							documentos</a>
					</div>
				</div>
				<?php  //echo $Cons; ?>
										...
										<?php while ($row = sqlsrv_fetch_array($SQL)) { ?>
											<tr class="gradeX">
												...
												<td><?php if ($row['Archivo'] != "") { ?><a
															...
															target="_blank" class="btn btn-link btn-xs"><i
																class="fa fa-download"></i>
															Descargar</a><?php if (PermitirFuncion(205) || ConsultarUsuarioCargue($row['ID_Archivo'])) { ?>
															- <a href="#"
																onClick="EliminarRegistro(<?php echo $row['ID_Archivo']; ?>);"
																class="btn btn-link btn-xs"><i class="fa fa-eraser"></i>
																Eliminar</a><?php }
												} else { ?>
