								...
								<div class="col-lg-12">
									...
									<?php if ($edit == 1) { ?>
										<button class="btn btn-warning" type="submit" id="Crear"><i
												class="fa fa-refresh"></i> Actualizar usuario</button>
									<?php } else { ?>
										<button class="btn btn-primary" type="submit" id="Crear"><i class="fa fa-check"></i>
											Crear usuario</button>
									<?php } ?>
									<a href="<?php echo $return; ?>" class="btn btn-default"><i
											class="fa fa-arrow-circle-o-left"></i> Regresar</a>
									<?php if ($edit == 1) { ?>
										<button type="button" class="btn btn-success pull-right" onClick="CopiarParam();"><i
												class="fa fa-copy"></i> Copiar parámetros desde otro usuario</button>
									<?php } ?>
								</div>
							</div>
						</div>
							...
							<div class="tabs-container">
								<ul class="nav nav-tabs">
									<li class="active"><a data-toggle="tab" href="#tab-1"><i
												class="fa fa-user-circle"></i> Información de usuario</a></li>
									<li><a data-toggle="tab" href="#tab-2" onClick="ConsultarTab('2');"><i
												class="fa fa-group"></i> Clientes asociados</a></li>
									<li><a data-toggle="tab" href="#tab-3" onClick="ConsultarTab('3');"><i
												class="fa fa-edit"></i> Valores por defecto</a></li>

									<!-- SMM, 13/10/2022 -->
									<li><a data-toggle="tab" href="#tab-4" onClick="ConsultarTab('4');"><i
												class="fa fa-object-group"></i> Grupos Artículos</a></li>
								</ul>
								<div class="tab-content">
									<div id="tab-1" class="tab-pane active">
										<div class="ibox">
											...
											<div class="ibox-content">
												<div class="form-group">
													...
													<div class="col-lg-3"><input name="Nombre" type="text"
															required="required" class="form-control" id="Nombre"
															value="<?php if ($edit == 1) {
																echo $row['Nombre'];
															} ?>">
													</div>
													<label class="col-lg-1 control-label">Segundo nombre</label>
													<div class="col-lg-3"><input name="SegundoNombre" type="text"
													...
													<div class="col-lg-3"><input name="Apellido" type="text"
												...
												<div class="form-group">
													...
													<div class="col-lg-3"><input name="SegundoApellido" type="text"
													...
													<div class="col-lg-3"><input name="Cedula" type="text"
													...
													<div class="col-lg-3"><input name="Telefono" type="text"
												...
												<div class="form-group">
													...
													<div class="col-lg-2"><input name="Usuario" type="text"
															required="required" class="form-control" id="Usuario"
															onChange="ValidarUsuario(this.value);"
															value="<?php if ($edit == 1) {
																echo $row['Usuario'];
															} ?>"
															<?php if ($edit == 1) {
													...
													<div class="col-lg-3"><input name="Password" type="password"
															class="form-control example1" id="Password" value=""><a
															href="#" id="aVerPass" onClick="javascript:Mostrar();"
															title="Mostrar contraseña"
															class="btn btn-default btn-xs"><span id="VerPass"
																class="glyphicon glyphicon-eye-open"
																aria-hidden="true"></span></a></div>
													<label class="col-lg-1 control-label">&nbsp;</label>
													<div class="col-lg-3">
														<div id="lvlPass" class="pwstrength_viewport_progress"></div>
													</div>
												</div>
												<div class="form-group" id="pwd-container1">
													<label class="col-lg-1 control-label">Email</label>
													<div class="col-lg-3"><input name="Email" type="email"
													...
													<div class="col-lg-1">
														<div class="switch pull-right">
															<div class="onoffswitch">
																<input name="CambioPass" type="checkbox"
																	class="onoffswitch-checkbox" id="CambioPass"
																	value="1">
													...
													<div class="col-lg-3">
														<p class="text-primary">Solicitar cambio de contraseña al primer
															inicio de sesión.</p>
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-1 control-label">Time Out</label>
													<div class="col-lg-3"><input name="TimeOut" type="text"
															required="required" class="form-control" id="TimeOut"
															maxlength="4"
															value="<?php if ($edit == 1) {
																echo $row['TimeOut'] ?? 900;
															} ?>">
													</div>
													<label class="col-lg-1 control-label">Código SAP</label>
													<div class="col-lg-3">
														<select name="CodigoSAP" class="form-control select2"
															id="CodigoSAP">
															<option value="">Seleccione...</option>
															<?php while ($row_Empleados = sqlsrv_fetch_array($SQL_Empleados)) { ?>
																<option value="<?php echo $row_Empleados['ID_Empleado']; ?>"
																	<?php if (isset($row['CodigoSAP']) && (strcmp($row_Empleados['ID_Empleado'], $row['CodigoSAP']) == 0)) {
																		echo "selected";
																	} ?>>
																	<?php echo $row_Empleados['ID_Empleado'] . " - " . $row_Empleados['NombreEmpleado']; ?>
																</option>
															<?php } ?>
														</select>
													</div>
													...
													<div class="col-lg-3">
														<select name="PerfilUsuario" class="form-control"
															...
															<?php while ($row_Perfiles = sqlsrv_fetch_array($SQL_Perfiles)) { ?>
																<option
																	value="<?php echo $row_Perfiles['ID_PerfilUsuario']; ?>"
																	<?php if (($edit == 1) && (strcmp($row_Perfiles['ID_PerfilUsuario'], $row['ID_PerfilUsuario']) == 0)) {
																		echo "selected";
																	} ?>>
																	<?php echo $row_Perfiles['PerfilUsuario']; ?></option>
															<?php } ?>
														</select>
													</div>
													...
													<div class="col-lg-3">
														<select name="Estado" class="form-control" id="Estado">
															<?php while ($row_Estado = sqlsrv_fetch_array($SQL_Estados)) { ?>
																<option value="<?php echo $row_Estado['Cod_Estado']; ?>"
																	<?php if (($edit == 1) && (strcmp($row_Estado['Cod_Estado'], $row['Estado']) == 0)) {
																		echo "selected";
																	} ?>>
													...
													<div class="col-lg-3">
														<select name="Proveedor" class="form-control select2"
															...
															<?php while ($row_Proveedores = sqlsrv_fetch_array($SQL_Proveedores)) { ?>
																<option
																	value="<?php echo $row_Proveedores['CodigoCliente']; ?>"
																	<?php if (($edit == 1) && (strcmp($row_Proveedores['CodigoCliente'], $row['CodigoSAPProv']) == 0)) {
																		echo "selected";
																	} ?>>
																	<?php echo $row_Proveedores['NombreCliente']; ?>
																</option>
															<?php } ?>
														</select>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-3">
														<label class="checkbox-inline i-checks"><input
																name="chkServiceOne" id="chkServiceOne" type="checkbox"
																value="1" <?php if ($edit == 1) {
																	if ($row['UserServiceOne'] == 1) {
													...
													<div class="col-lg-3"><input name="SerialEquipo" type="text"
															class="form-control" id="SerialEquipo"
															value="<?php if ($edit == 1) {
																echo $row['SerialEquipo'];
															} ?>">
													</div>
													...
													<div class="col-lg-3">
														<select name="Dashboard" class="form-control" id="Dashboard">
															<?php while ($row_Dashboard = sqlsrv_fetch_array($SQL_Dashboard)) { ?>
																<option value="<?php echo $row_Dashboard['IdDashboard']; ?>"
																	<?php if (($edit == 1) && (strcmp($row_Dashboard['IdDashboard'], $row['Dashboard']) == 0)) {
																		echo "selected";
																	} ?>>
																	<?php echo $row_Dashboard['NombreDashboard']; ?>
																</option>
															<?php } ?>
														</select>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-3">
														<label class="checkbox-inline i-checks"><input
																name="chkSalesOne" id="chkSalesOne" type="checkbox"
																value="1" <?php if ($edit == 1) {
																	if ($row['UserSalesOne'] == 1) {
																		echo "checked=\"checked\"";
																	}
																} ?>> Este usuario tiene acceso a
															Sales One</label>
												...
												<div class="form-group">
													...
													<div class="col-lg-3">
														...
														if (($edit == 0) || (($edit == 1) && ($row['AnxFirma'] == ""))) { ?>
															<button class="btn btn-primary" type="button" id="FirmaUsuario"
																onClick="AbrirFirma('SigUser');"><i
																	class="fa fa-pencil-square-o"></i> Realizar
																firma</button>
														<?php } else { ?>
															<button class="btn btn-warning" type="button" id="FirmaUsuario"
																onClick="AbrirFirma('SigUser');"><i
																	class="fa fa-pencil-square-o"></i> Actualizar
																firma</button>
														<?php } ?>
														<input type="hidden" id="SigUser" name="SigUser" value="" />
														<span class="text-primary font-bold">O cargue un archivo con la
															imagen de la firma</span>
														<input name="FirmaCargadaUsuario" type="file"
															id="FirmaCargadaUsuario" class="m-t-sm" />
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-lg-3">
														<?php if (($edit == 1) && ($row['AnxFirma'] != "")) { ?>
															<img id="ImgSigUser" style="max-width: 100%; height: auto;"
																src="<?php echo $dir_new . $row['AnxFirma']; ?>" alt="" />
														<?php } else { ?>
															<img id="ImgSigUser"
														...
														<div id="divSerie_<?php echo $Cont; ?>" class="form-group">
															...
															<div class="col-lg-3">
																<select name="TipoDocumento[]" class="form-control"
																	id="TipoDocumento<?php echo $Cont; ?>"
																	onChange="BuscarSerieDoc('<?php echo $Cont; ?>');">
																	<option value="">Seleccione...</option>
																	<?php $CatActual = "";
																	while ($row_TiposDocumentos = sqlsrv_fetch_array($SQL_TiposDocumentos)) {
																		...
																		<option
																			value="<?php echo $row_TiposDocumentos['IdTipoDocumento']; ?>"
																			<?php if ((strcmp($row_TiposDocumentos['IdTipoDocumento'], $row_SeriesUsuario['IdTipoDocumento']) == 0)) {
																				echo "selected";
																			} ?>>
																			<?php echo $row_TiposDocumentos['DeTipoDocumento']; ?>
																		</option>
																	<?php } ?>
																</select>
															</div>
															...
															<div class="col-lg-2">
																<select name="Series[]" class="form-control"
																	id="Series<?php echo $Cont; ?>">
																	<option value="">Seleccione...</option>
																	<?php while ($row_SeriesDocumentos = sqlsrv_fetch_array($SQL_SeriesDocumentos)) { ?>
																		<option
																			value="<?php echo $row_SeriesDocumentos['IdSeries']; ?>"
																			<?php if ((strcmp($row_SeriesDocumentos['IdSeries'], $row_SeriesUsuario['IdSeries']) == 0)) {
																				echo "selected";
																			} ?>>
																			<?php echo $row_SeriesDocumentos['DeSeries']; ?>
																		</option>
																	<?php } ?>
																</select>
															</div>
															...
															<div class="col-lg-2">
																<select name="PermisoSerie[]" class="form-control"
																	id="PermisoSerie<?php echo $Cont; ?>">
																	<option value="1" <?php if ($row_SeriesUsuario['Permiso'] == 1) {
																		echo "selected";
																	} ?>>
																		Solo consulta</option>
																	<option value="2" <?php if ($row_SeriesUsuario['Permiso'] == 2) {
																		echo "selected";
																	} ?>>
																		Solo creación</option>
																	<option value="3" <?php if ($row_SeriesUsuario['Permiso'] == 3) {
																		echo "selected";
																	} ?>>
																		Creación y consulta</option>
																</select>
															</div>
															<div class="col-lg-2">
																<button type="button" id="btnSeries<?php echo $Cont; ?>"
																	class="btn btn-warning btn-xs btn_del"><i
												...
												<div id="divSerie_<?php echo $Cont; ?>" class="form-group">
													...
													<div class="col-lg-2">
														<button type="button" id="btnSeries<?php echo $Cont; ?>"
															...
															onClick="addFieldTDoc(this);"><i class="fa fa-plus"></i>
															Añadir otro</button>
													</div>
												</div>
											</div>
										...
										<div class="ibox">
											...
											<div class="ibox-content">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<select data-placeholder="Digite para buscar..."
															name="Proyecto[]" class="form-control select2" id="Proyecto"
															multiple>
										...
										<div class="ibox">
											...
											<div class="ibox-content">
												<?php while ($row_DimReparto = sqlsrv_fetch_array($SQL_DimReparto)) { ?>
													...
													<div class="form-group">
														<label
															class="col-lg-1 control-label"><?php echo $row_DimReparto['NombreDim']; ?><br><span
																class="text-muted"><?php echo $row_DimReparto['TipoDim']; ?></span></label>
														<div class="col-lg-3">
															<select name="Dimension<?php echo $row_DimReparto['CodDim']; ?>"
																class="form-control select2"
																id="Dimension<?php echo $row_DimReparto['CodDim']; ?>">
																<option value="">(Ninguno)</option>

																<?php while ($row_CentroCostos = sqlsrv_fetch_array($SQL_CentroCostos)) { ?>
																	<option value="<?php echo $row_CentroCostos['PrcCode']; ?>"
																		<?php if (($edit == 1) && (strcmp($row_CentroCostos['PrcCode'], $row['CentroCosto' . $row_DimReparto['CodDim']]) == 0)) {
																			echo "selected";
																		} ?>>
																		<?php echo $row_CentroCostos['PrcName'] . " (" . $row_CentroCostos['PrcCode'] . ")"; ?>
																	</option>
																<?php } ?>
															</select>
														</div>
										...
										<div class="ibox">
											...
											<div class="ibox-content">
												<div class="form-group">
													...
													<div class="col-lg-3">
														<select name="AlmacenOrigen" class="form-control select2"
															id="AlmacenOrigen">
															<option value="">(Ninguno)</option>
															<?php while ($row_AlmacenOrigen = sqlsrv_fetch_array($SQL_AlmacenOrigen)) { ?>
																<option value="<?php echo $row_AlmacenOrigen['WhsCode']; ?>"
																	<?php if (($edit == 1) && (strcmp($row_AlmacenOrigen['WhsCode'], $row['AlmacenOrigen']) == 0)) {
																		echo "selected";
																	} ?>>
																	<?php echo $row_AlmacenOrigen['WhsName']; ?></option>
															<?php } ?>
														</select>
													</div>
													<label class="col-lg-1 control-label">Almacén de destino</label>
													<div class="col-lg-3">
														<select name="AlmacenDestino" class="form-control select2"
															id="AlmacenDestino">
															<option value="">(Ninguno)</option>
															<?php while ($row_AlmacenDestino = sqlsrv_fetch_array($SQL_AlmacenDestino)) { ?>
																<option
																	value="<?php echo $row_AlmacenDestino['WhsCode']; ?>"
																	<?php if (($edit == 1) && (strcmp($row_AlmacenDestino['WhsCode'], $row['AlmacenDestino']) == 0)) {
																		echo "selected";
																	} ?>>
																	<?php echo $row_AlmacenDestino['WhsName']; ?></option>
															<?php } ?>
														</select>
													</div>
												</div>
										...
										<div class="ibox">
											<div class="ibox-title bg-success">
												<h5><i class="fa fa-briefcase"></i> Empleados asignados (para
													programación)</h5>
												<a class="collapse-link pull-right">
													<i class="fa fa-chevron-up"></i>
												</a>
											...
											<div class="ibox-content">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<select data-placeholder="Digite para buscar..." name="Grupo[]"
															class="form-control select2" id="Grupo" multiple>
															<?php while ($row_Grupos = sqlsrv_fetch_array($SQL_Grupos)) { ?>
																<option value="<?php echo $row_Grupos['IdCargo']; ?>" <?php if (in_array($row_Grupos['IdCargo'], $ids_grupos)) {
																	   echo "selected";
																   } ?>>
										...
										<div class="ibox">
											<div class="ibox-title bg-success">
												<h5><i class="fa fa-briefcase"></i> Perfiles de autores para
													autorizaciones de documentos</h5>
												<a class="collapse-link pull-right">
													<i class="fa fa-chevron-up"></i>
												</a>
											</div>
											<div class="ibox-content">
												<div class="form-group">
													...
													<div class="col-lg-4">
														<select data-placeholder="Digite para buscar..."
															name="PerfilAutor[]" class="form-control select2"
															id="PerfilAutor" multiple>
															<?php while ($row_Perfil_Autor = sqlsrv_fetch_array($SQL_Perfiles_Autorizaciones)) { ?>
																<option
																	value="<?php echo $row_Perfil_Autor['ID_PerfilUsuario']; ?>"
																	<?php if (in_array($row_Perfil_Autor['ID_PerfilUsuario'], $ids_perfiles)) {
																		echo "selected";
																	} ?>>
										...
										<div class="ibox">
											...
											<div class="ibox-content">
												<div class="form-group">
													<label class="col-lg-2 control-label">Conceptos de salida
														seleccionados</label>
													<div class="col-lg-10">
														<select data-placeholder="Digite para buscar..."
															name="Concepto[]" class="form-control select2" id="Concepto"
															multiple>
															<?php while ($row_Concepto = sqlsrv_fetch_array($SQL_Conceptos_Salida)) { ?>
																<option
																	value="<?php echo $row_Concepto['id_concepto_salida']; ?>"
																	<?php if (in_array($row_Concepto['id_concepto_salida'], $ids_conceptos)) {
																		echo "selected";
																	} ?>>
		...
		function ConsultarTab(type) {
			if (type == 2) {//Clientes
				if (tab_2 == 0) {
					...
					$.ajax({
						type: "POST",
						url: "us_clientes.php?id=<?php if ($edit == 1) {
							echo base64_encode($row['ID_Usuario']);
						} ?>",
						success: function (response) {
				...
				if (tab_3 == 0) {
					...
					$.ajax({
						type: "POST",
						url: "us_valores_defecto.php?id=<?php if ($edit == 1) {
							echo base64_encode($row['ID_Usuario']);
						} ?>",
						success: function (response) {
			...
			// Grupos Artículos. SMM, 13/10/2022
				...
				if (tab_4 == 0) {
					...
					$.ajax({
						type: "POST",
						url: "us_grupos_articulos.php?id=<?php if ($edit == 1) {
							echo base64_encode($row['ID_Usuario']);
						} ?>",
						success: function (response) {
