...
// Fin, Verificar que viene de una Entrada de Compras
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content">
								...
								<div class="form-group">
									<div class="col-lg-6">
										...
										<a href="#" class="btn btn-outline btn-info"
											onClick="VerMapaRel('<?php echo base64_encode($row['DocEntry']); ?>','<?php echo base64_encode('21'); ?>');"><i
												class="fa fa-sitemap"></i> Mapa de relaciones</a>
									</div>
									<div class="col-lg-6">
										<?php if ($row['DocBaseDocEntry'] != "") { ?>
											<a href="entrada_compra.php?id=<?php echo base64_encode($row['DocBaseDocEntry']); ?>&id_portal=<?php echo base64_encode($row['DocBaseIdPortal']); ?>&tl=1"
										...
										<?php if ($row['Cod_Estado'] == 'O') { ?>
											<button type="button"
												onClick="javascript:location.href='actividad.php?dt_DM=1&Cardcode=<?php echo base64_encode($row['CardCode']); ?>&Contacto=<?php echo base64_encode($row['CodigoContacto']); ?>&Sucursal=<?php echo base64_encode($row['SucursalDestino']); ?>&Direccion=<?php echo base64_encode($row['DireccionDestino']); ?>&DM_type=<?php echo base64_encode('21'); ?>&DM=<?php echo base64_encode($row['DocEntry']); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('entrada_compra.php'); ?>'"
				...
				<div class="ibox-content">
					...
					<div class="row">
						<div class="col-lg-12">
							<form action="devolucion_compra.php" method="post" class="form-horizontal"
								enctype="multipart/form-data" id="CrearDevolucionCompra">
								<?php
								$_GET['obj'] = "21";
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										...
										form="CrearDevolucionCompra" required <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
											echo "disabled";
											} ?>>
										...
										<div id="tab-1" class="tab-pane active">
											<iframe id="DataGrid" name="DataGrid" style="border: 0;" width="100%"
												...
												src="<?php if ($edit == 0 && $sw_error == 0) {
													echo "detalle_devolucion_compra.php";
												} elseif ($edit == 0 && $sw_error == 1) {
													echo "detalle_devolucion_compra.php?id=0&type=1&usr=" . $_SESSION['CodUser'] . "&cardcode=" . $row['CardCode'];
												} else {
													echo "detalle_devolucion_compra.php?id=" . base64_encode($row['ID_DevolucionCompra']) . "&evento=" . base64_encode($row['IdEvento']) . "&docentry=" . base64_encode($row['DocEntry']) . "&type=2&status=" . base64_encode($row['Cod_Estado']);
												} ?>"></iframe>
										</div>
										<?php if ($edit == 1) { ?>
					...
					<form id="frm" action="" class="form-horizontal">
						...
						<div class="col-lg-8">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<textarea name="Comentarios" form="CrearDevolucionCompra" rows="4"
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" name="SubTotal" form="CrearDevolucionCompra" id="SubTotal"
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" name="Descuentos" form="CrearDevolucionCompra" id="Descuentos"
										class="form-control" style="text-align: right; font-weight: bold;"
										value="<?php if ($edit == 1) {
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" name="Impuestos" form="CrearDevolucionCompra" id="Impuestos"
										class="form-control" style="text-align: right; font-weight: bold;"
										value="<?php if ($edit == 1) {
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" name="Redondeo" form="CrearDevolucionCompra" id="Redondeo"
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" name="TotalDevolucion" form="CrearDevolucionCompra"
						...
						<div class="form-group">
							<div class="col-lg-9">
								<?php if ($edit == 0 && PermitirFuncion(714)) { ?>
									<button class="btn btn-primary" type="submit" form="CrearDevolucionCompra" id="Crear"><i
											class="fa fa-check"></i> Crear Devolución de compras</button>
								<?php } elseif ($row['Cod_Estado'] == "O" && PermitirFuncion(714)) { ?>
									<button class="btn btn-warning" type="submit" form="CrearDevolucionCompra"
										id="Actualizar"><i class="fa fa-refresh"></i> Actualizar Devolución de
										compras</button>
								<?php } ?>
								<?php
						...
						<input type="hidden" form="CrearDevolucionCompra" id="IdDevolucionCompra" name="IdDevolucionCompra"
							value="<?php if ($edit == 1) {
								echo base64_encode($row['ID_DevolucionCompra']);
							} ?>" />
						<input type="hidden" form="CrearDevolucionCompra" id="IdEvento" name="IdEvento"
							value="<?php if ($edit == 1) {
								echo base64_encode($IdEvento);
							} ?>" />
						<input type="hidden" form="CrearDevolucionCompra" id="d_LS" name="d_LS"
							value="<?php echo $dt_LS; ?>" />
						<input type="hidden" form="CrearDevolucionCompra" id="tl" name="tl"
							value="<?php echo $edit; ?>" />
						<input type="hidden" form="CrearDevolucionCompra" id="swError" name="swError"
							value="<?php echo $sw_error; ?>" />
						<input type="hidden" form="CrearDevolucionCompra" id="return" name="return"
			...
			if (((cardCode != "") && (serie != "")) || probarModal) {
				$.ajax({
					...
					data: {
						...
						OT: ordenServicio,
						Edit: <?php echo $edit; ?>,
						DocType: "<?php echo ($edit == 0) ? 26 : 27; ?>",
						DocId: "<?php echo $row['ID_DevolucionCompra'] ?? 0; ?>",
