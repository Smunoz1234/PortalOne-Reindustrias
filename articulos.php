													...
													<div class="col-lg-12">
														<div class="table-responsive">
															<table class="table table-striped table-bordered">
																...
																<tbody>
																	<?php while ($row_Alternativo = sqlsrv_fetch_array($SQL_Alternativos)) { ?>
																		<tr style="<?php if ($row_Alternativo["stock"] > 0) {
																				echo "background-color: #1ab394; color:white;";
																			} ?>">
																			
																			<td>
																				<?php echo $row_Alternativo["id_articulo_hijo"] ?? ""; ?>
																			</td>
																			<td>
																				<?php echo $row_Alternativo["articulo_hijo"] ?? ""; ?>
																			</td>
																			<td>
																				<?php echo number_format($row_Alternativo["stock"], 2); ?>
																			</td>
																			<td>
																				<?php echo number_format($row_Alternativo["Coincidencia"], 2) . "%"; ?>
																			</td>
																			<td>
																				<?php echo $row_Alternativo["comentarios"] ?? ""; ?>
																			</td>
