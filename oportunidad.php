	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content">
							...
							<form id="formActividades">
								<div class="modal-body">
									<div class="row">
										...
										<div class="col-lg-10">
											<label class="checkbox-inline i-checks"><input name="chkVisualizar"
													id="chkVisualizar" type="checkbox" value="1"> Visualizar sólo
												actividades pendientes</label>
										</div>
										<div class="col-lg-1"></div>
									</div>
										...
										<div class="ibox-content">
											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="NombreCompetidor"
														id="NombreCompetidor" autocomplete="off" required>
												</div>
												<div class="form-group">
													<label class="control-label">Nivel de amenaza <span
															class="text-danger">*</span></label>
													<select name="AmenazaCompetidor" class="form-control"
														id="AmenazaCompetidor" required>
														<option value="-1">Seleccione...</option>
														<?php while ($row_Etapas = sqlsrv_fetch_array($SQL_Etapas)) { ?>
															<option value="<?php echo $row_Etapas['ID_Etapa']; ?>">
																<?php echo $row_Etapas['DE_Etapa']; ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<select name="GanadaCompetidor" class="form-control"
														id="GanadaCompetidor">
												...
												<div class="form-group">
													...
													<textarea name="ComentariosCompetidor" id="ComentariosCompetidor"
														rows="2" maxlength="3000" class="form-control"
														type="text"></textarea>
												</div>
											</div>
				...
				<form action="oportunidad.php" method="post" class="form-horizontal" enctype="multipart/form-data"
					id="FrmOp">
					<?php
					$_GET['obj'] = "97";
						...
						<div class="col-lg-12">
							<div class="ibox-content">
										...
										if ($edit == 1) {
											if (PermitirFuncion(1102)) { ?>
												<button class="btn btn-warning" type="submit" id="Actualizar"><i
														class="fa fa-refresh"></i> Actualizar oportunidad</button>
											<?php }
										} elseif (PermitirFuncion(1101)) { ?>
											<button class="btn btn-primary" type="submit" id="Crear"><i
													class="fa fa-check"></i> Crear oportunidad</button>
										<?php } ?>

										<!-- SMM, 16/11/2022 -->
										<button class="btn btn-info" onclick="$('#modalActividades').modal('show');"><i
												class="fa fa-tasks"></i> Actividades relacionadas</button>
								...
								<input type="hidden" id="ID" name="ID"
									value="<?php if (isset($row['IdOportunidadPortal'])) {
										echo base64_encode($row['IdOportunidadPortal']);
									} ?>" />
								<input type="hidden" id="tl" name="tl" value="<?php echo $edit; ?>" />
								<input type="hidden" id="IdAnexo" name="IdAnexo"
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="ibox-content">
								...
								<div class="form-group">
									<label class="col-lg-1 control-label"><i onClick="ConsultarCliente('CardCode');"
									...
									<div class="col-lg-3">
										<select name="ContactoCliente" class="form-control" id="ContactoCliente"
											required <?php if (($edit == 1) && ($row['IdEstadoOportunidad'] == 'C')) {
												echo "disabled='disabled'";
											} ?>>
											<option value="">Seleccione...</option>
											<?php if ($edit == 1 || $sw_error == 1) { ?>
												<?php while ($row_ContactoCliente = sqlsrv_fetch_array($SQL_ContactoCliente)) { ?>
													<option value="<?php echo $row_ContactoCliente['CodigoContacto']; ?>" <?php if ((isset($row['IdContactoOportunidad'])) && (strcmp($row_ContactoCliente['CodigoContacto'], $row['IdContactoOportunidad']) == 0)) {
									...
									<div class="col-lg-3">
										<select name="Industria" class="form-control" id="Industria">
											...
											<?php while ($row_Industria = sqlsrv_fetch_array($SQL_Industria)) { ?>
												<option value="<?php echo $row_Industria['IdIndustria']; ?>" <?php if ((isset($row['IdIndustria'])) && (strcmp($row_Industria['IdIndustria'], $row['IdIndustria']) == 0)) {
													   echo "selected=\"selected\"";
												   } ?>>
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<input name="ImporteFact" type="text" class="form-control" id="ImporteFact"
											value="<?php if ($edit == 1 || $sw_error == 1) {
												echo number_format($row['ImporteFacturaTotal'], 2);
											} ?>"
											readonly="readonly">
									</div>

									<label class="col-lg-1 control-label">Propietario <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
										<input name="Propietario" id="Propietario" type="hidden"
											value="<?php if ($edit == 1 || $sw_error == 1) {
												echo $row['IdPropietario'];
											} ?>" />
										<input name="NombrePropietario" type="text" class="form-control"
											id="NombrePropietario"
											value="<?php if ($edit == 1 || $sw_error == 1) {
												echo $row['NombrePropietario'];
											} ?>"
											readonly="readonly">
									</div>
								...
								<div class="form-group">
									<label class="col-xs-12">
										<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-suitcase"></i> Información de
											la oportunidad</h3>
									</label>
								</div>
								<div class="form-group">
									<label class="col-lg-1 control-label">Nombre de la oportunidad <span
											class="text-danger">*</span></label>
									<div class="col-lg-7">
										<input autocomplete="off" name="NombreOportunidad" type="text"
											required="required" class="form-control" id="NombreOportunidad"
											maxlength="150"
											value="<?php if ($edit == 1 || $sw_error == 1) {
												echo $row['NombreOportunidad'];
											} ?>">
									</div>

									<label class="col-lg-1 control-label">Número de oportunidad</label>
									<div class="col-lg-3">
										<input autocomplete="off" name="NumeroOportunidad" type="text"
											class="form-control" id="NumeroOportunidad" maxlength="10"
											value="<?php if ($edit == 1 || $sw_error == 1) {
												echo $row['ID_Oportunidad'];
											} ?>"
											readonly>
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-1 control-label">Tipo de oportunidad <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
										<select name="TipoOpr" class="form-control" id="TipoOpr" <?php if (($edit == 1) && ($row['IdEstadoOportunidad'] == 'C')) {
											echo "disabled='disabled'";
										} ?>>
											<option value="R" <?php if (($edit == 1 || $sw_error == 1) && ($row['IdTipoOportunidad'] == "R")) {
												echo "selected=\"selected\"";
											} ?>>
												Ventas</option>
											<option value="P" <?php if (($edit == 1 || $sw_error == 1) && ($row['IdTipoOportunidad'] == "P")) {
												echo "selected=\"selected\"";
											} ?>>
												Compras</option>
										</select>
									...
									<label class="col-lg-1 control-label">Estado <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
										<input autocomplete="off" name="EstadoOportunidad" type="text"
											class="form-control" id="EstadoOportunidad" maxlength="10"
											value="<?php if ($edit == 1 || $sw_error == 1) {
												echo $row['DeEstadoOportunidad'];
											} ?>"
											readonly>
									</div>

									<label class="col-lg-1 control-label">Empleado de ventas <span
											class="text-danger">*</span></label>
									<div class="col-lg-3">
										<select name="EmpleadoVentas" class="form-control select2" id="EmpleadoVentas"
											required>
											<option value="">Seleccione...</option>
											<?php while ($row_EmpVentas = sqlsrv_fetch_array($SQL_EmpVentas)) { ?>
												<option value="<?php echo $row_EmpVentas['ID_EmpVentas']; ?>" <?php if (($edit == 1) && (isset($row['IdEmpleadoOportunidad'])) && (strcmp($row_EmpVentas['ID_EmpVentas'], $row['IdEmpleadoOportunidad']) == 0)) {
													   echo "selected=\"selected\"";
												   } elseif (($edit == 0) && (isset($_SESSION['CodigoSAP'])) && (strcmp($row_EmpVentas['ID_EmpVentas'], $_SESSION['CodigoSAP']) == 0)) {
													   echo "selected=\"selected\"";
												   } ?>>
													<?php echo $row_EmpVentas['DE_EmpVentas']; ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
								<div class="form-group">
									<label class="col-lg-1 control-label">% de cierre <span
											class="text-danger">*</span></label>
									<div class="col-lg-7">
										<input type="hidden" name="PrctOpor" id="PrctOpor"
											value="<?php if ($edit == 1 || $sw_error == 1) {
												echo $row['PorcentajeOportunidad'];
											} ?>" />
										<div class="progress">
											<div class="progress-bar progress-bar-success" role="progressbar"
												style="width: <?php if (($edit == 1) || ($sw_error == 1)) {
													echo number_format($row['PorcentajeOportunidad'], 0);
												} else {
													echo "0";
												} ?>%;"
												aria-valuenow="<?php if (($edit == 1) || ($sw_error == 1)) {
													echo number_format($row['PorcentajeOportunidad'], 0);
												} else {
													echo "0";
												} ?>"
									...
									<label class="col-lg-1 control-label">Fecha de inicio <span
											class="text-danger">*</span></label>
									<div class="col-lg-3 input-group date">
										<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
											name="FechaInicio" id="FechaInicio" type="text"
											onChange="CalcularDiasCierre();" required="required" class="form-control"
											value="<?php if ($edit == 1 || $sw_error == 1) {
												echo $row['FechaInicio']->format('Y-m-d');
											} ?>"
											<?php if (($edit == 1) && ($row['IdEstadoOportunidad'] == 'C')) {
												echo "readonly";
											} ?>>
								...
								<div class="form-group">
									...
									<div class="col-lg-3 input-group date">
										<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
											name="FechaCierre" id="FechaCierre" type="text" class="form-control"
											value="<?php if ($edit == 1 || $sw_error == 1) {
												echo ($row['FechaCierre'] != "") ? $row['FechaCierre']->format('Y-m-d') : "";
											} ?>"
											<?php if (($edit == 1) && ($row['IdEstadoOportunidad'] == 'C')) {
												echo "readonly";
											} ?>>
								...
								<div class="form-group">
									<label class="col-xs-12">
										<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-list"></i> Detalles de la
											oportunidad</h3>
									</label>
								</div>
								<div class="tabs-container">
									<ul class="nav nav-tabs">
										<li class="active"><a data-toggle="tab" href="#tabOpr-1"><i
													class="fa fa-shopping-cart"></i> Potencial</a></li>
										<li><a data-toggle="tab" href="#tabOpr-2"><i class="fa fa-book"></i> General</a>
										</li>
										<li><a data-toggle="tab" href="#tabOpr-3"><i class="fa fa-flag-checkered"></i>
												Etapas</a></li>
										<li><a data-toggle="tab" href="#tabOpr-4"><i class="fa fa-group"></i> Socios de
												negocios</a></li>
										<li><a data-toggle="tab" href="#tabOpr-5"><i class="fa fa-trophy"></i>
												Competidores</a></li>
										<li><a data-toggle="tab" href="#tabOpr-6"><i class="fa fa-tasks"></i>
												Resumen</a></li>
										<li><a data-toggle="tab" href="#tabOpr-7"><i class="fa fa-paperclip"></i>
												Anexos</a></li>
									</ul>
									<div class="tab-content">
										<div id="tabOpr-1" class="tab-pane active">
											...
											<div class="form-group">
												<div class="col-lg-4">
													<div class="form-group">
														<label class="col-lg-4 control-label">Cierre planificado en
															<span class="text-danger">*</span></label>
														<div class="col-lg-4">
															<input autocomplete="off" name="CierrePlan" type="text"
																required="required" class="form-control" id="CierrePlan"
																maxlength="10"
																value="<?php if ($edit == 1 || $sw_error == 1) {
																	echo $row['CierrePlanificado'];
																} ?>"
																onChange="CalcularCierre();">
														</div>
														<div class="col-lg-4">
															<select name="CierreTipo" class="form-control"
																id="CierreTipo" <?php if (($edit == 1) && ($row['IdEstadoOportunidad'] == 'C')) {
																	echo "disabled='disabled'";
																} ?>>
																<option value="M" <?php if (($edit == 1 || $sw_error == 1) && ($row['DifType'] == "M")) {
																	echo "selected=\"selected\"";
																} ?>>Meses</option>
																<option value="W" <?php if (($edit == 1 || $sw_error == 1) && ($row['DifType'] == "W")) {
																	echo "selected=\"selected\"";
																} ?>>Semanas</option>
																<option value="D" <?php if (($edit == 1 || $sw_error == 1) && ($row['DifType'] == "D")) {
																	echo "selected=\"selected\"";
																} ?>>Días</option>
															</select>
														</div>
													...
													<div class="form-group">
														<label class="col-lg-4 control-label">Fecha de cierre prevista
															<span class="text-danger">*</span></label>
														<div class="col-lg-8 input-group date">
															<span class="input-group-addon"><i
																	class="fa fa-calendar"></i></span><input
																name="FechaCierrePrev" id="FechaCierrePrev" type="text"
																onChange="CalcularDiasCierre();" required="required"
																class="form-control"
																value="<?php if ($edit == 1 || $sw_error == 1) {
																	echo $row['FechaCierrePrevista']->format('Y-m-d');
																} ?>"
																<?php if (($edit == 1) && ($row['IdEstadoOportunidad'] == 'C')) {
																	echo "readonly";
																} ?>>
													...
													<div class="form-group">
														<label class="col-lg-4 control-label">Monto potencial
															($)</label>
														<div class="col-lg-8">
															<input name="MontoPotencial" type="text"
																class="form-control" id="MontoPotencial"
																value="<?php if ($edit == 1 || $sw_error == 1) {
																	echo number_format($row['MontoPotencial'], 2);
																} ?>"
																<?php if (($edit == 1) && ($row['IdEstadoOportunidad'] != 'O')) {
																	echo "readonly";
																} ?>>
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-4 control-label">Monto ponderado
															($)</label>
														<div class="col-lg-8">
															<input name="MontoPonderado" type="text"
																class="form-control" id="MontoPonderado"
																value="<?php if ($edit == 1 || $sw_error == 1) {
																	echo number_format($row['MontoPonderado'], 2);
																} ?>"
																<?php if (($edit == 1) && ($row['IdEstadoOportunidad'] != 'O')) {
																	echo "readonly";
																} ?>>
													...
													<div class="form-group">
														<label class="col-lg-4 control-label">% de ganancia
															bruta</label>
														<div class="col-lg-8">
															<input name="PrcGananciaBruta" type="text"
																class="form-control" id="PrcGananciaBruta"
																value="<?php if ($edit == 1 || $sw_error == 1) {
																	echo number_format($row['PrcnGananciaBruta'], 0);
																} ?>"
																<?php if (($edit == 1) && ($row['IdEstadoOportunidad'] != 'O')) {
																	echo "readonly";
																} ?>>
													...
													<div class="form-group">
														<label class="col-lg-4 control-label">Ganancia bruta total
															($)</label>
														<div class="col-lg-8">
															<input name="GananciaBruta" type="text" class="form-control"
																id="GananciaBruta"
																value="<?php if ($edit == 1 || $sw_error == 1) {
																	echo number_format($row['GananciaBruta'], 2);
																} ?>"
																<?php if (($edit == 1) && ($row['IdEstadoOportunidad'] != 'O')) {
																	echo "readonly";
																} ?>>
													...
													<div class="form-group">
														<label class="col-lg-4 control-label">Nivel de interés <span
																class="text-danger">*</span></label>
														<div class="col-lg-8">
															<select name="NivelInteres" class="form-control"
																id="NivelInteres" <?php if (($edit == 1) && ($row['IdEstadoOportunidad'] != 'O')) {
																	echo "disabled='disabled'";
																} ?> required="required">
																<option value="">Seleccione...</option>
																<?php while ($row_NivelInteres = sqlsrv_fetch_array($SQL_NivelInteres)) { ?>
																	<option
																		value="<?php echo $row_NivelInteres['ID_NivelInteres']; ?>"
																		<?php if (($edit == 1) && (isset($row['IdNivelInteres'])) && (strcmp($row_NivelInteres['ID_NivelInteres'], $row['IdNivelInteres']) == 0)) {
																			echo "selected=\"selected\"";
																		} ?>>
																		<?php echo $row_NivelInteres['DE_NivelInteres']; ?>
																	</option>
																<?php } ?>
															</select>
														</div>
										...
										<div id="tabOpr-2" class="tab-pane">
											...
											<div class="form-group">
												<label class="col-lg-2 control-label"><i
														onClick="ConsultarCliente('CanalSN');" title="Consultar cliente"
														style="cursor: pointer"
														class="btn-xs btn-success fa fa-search"></i> Canal SN</label>
												<div class="col-lg-3">
													<input name="CanalSN" type="hidden" id="CanalSN"
														value="<?php if (($edit == 1) || ($sw_error == 1)) {
															echo $row['CodigoCanalSN'];
														} ?>">
													<input name="NombreCanalSN" type="text" class="form-control"
														id="NombreCanalSN" placeholder="Digite para buscar..."
														value="<?php if (($edit == 1) || ($sw_error == 1)) {
															echo $row['NombreCanalSN'];
														} ?>"
														<?php if (($edit == 1) && ($row['IdEstadoOportunidad'] != 'O')) {
															echo "readonly";
														} ?>>
											...
											<div class="form-group">
												...
												<div class="col-lg-3">
													<select name="ContactoCanalSN" class="form-control"
														id="ContactoCanalSN" <?php if (($edit == 1) && ($row['IdEstadoOportunidad'] == 'C')) {
															echo "disabled='disabled'";
														} ?>>
														<option value="">Seleccione...</option>
														<?php if (($edit == 1 || $sw_error == 1) && ($row['CodigoCanalSN'] != "")) { ?>
															<?php while ($row_ContactoCanalSN = sqlsrv_fetch_array($SQL_ContactoCanalSN)) { ?>
																<option
																	value="<?php echo $row_ContactoCanalSN['CodigoContacto']; ?>"
																	<?php if ((isset($row['CodigoContactoCanalSN'])) && (strcmp($row_ContactoCanalSN['CodigoContacto'], $row['CodigoContactoCanalSN']) == 0)) {
																		echo "selected=\"selected\"";
																	} ?>>
																	<?php echo $row_ContactoCanalSN['ID_Contacto']; ?></option>
															<?php } ?>
														<?php } ?>
													</select>
												</div>
												...
												<div class="col-lg-3">
													<select name="FuenteInfo" class="form-control select2"
														id="FuenteInfo">
														<option value="">Seleccione...</option>
														<?php while ($row_FuenteInfo = sqlsrv_fetch_array($SQL_FuenteInfo)) { ?>
															<option value="<?php echo $row_FuenteInfo['ID_FuenteInfo']; ?>"
																<?php if ((isset($row['IdFuenteInfo'])) && (strcmp($row_FuenteInfo['ID_FuenteInfo'], $row['IdFuenteInfo']) == 0)) {
																	echo "selected=\"selected\"";
																} ?>>
																<?php echo $row_FuenteInfo['DE_FuenteInfo']; ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
												...
												<div class="col-lg-3">
													<select name="RamoInd" class="form-control select2" id="RamoInd">
														...
														<?php while ($row_RamoInd = sqlsrv_fetch_array($SQL_RamoInd)) { ?>
															<option value="<?php echo $row_RamoInd['ID_RamoIndustria']; ?>"
																<?php if ((isset($row['IdIndustria'])) && (strcmp($row_RamoInd['ID_RamoIndustria'], $row['IdIndustria']) == 0)) {
																	echo "selected=\"selected\"";
																} ?>>
																<?php echo $row_RamoInd['DescripcionRamoIndustria']; ?>
															</option>
														<?php } ?>
													</select>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<textarea name="Comentarios" rows="7" maxlength="1000"
														class="form-control" id="Comentarios"
														type="text"><?php if ($edit == 1 || $sw_error == 1) {
															echo $row['ComentariosOportunidad'];
														} ?></textarea>
												</div>
											</div>
										</div>
										<div id="tabOpr-3" class="tab-pane">
											...
											<div class="row m-b-md">
												<div class="col-lg-12">
													<button class="btn btn-primary" type="button" id="NewParam"
														onClick="CrearEtapa();"><i class="fa fa-plus-circle"></i> Añadir
														etapa</button>
												</div>
											</div>
											<div class="table-responsive">
												...
												<table class="table table-bordered table-hover dataTables-example"
													...
													<tbody id="listaEtapas">
														...
														<?php while (($edit == 1) && ($row_Detalle = sqlsrv_fetch_array($SQL_Detalle))) { ?>
															<tr class="gradeX">
																<td id="idLin<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo $i; ?></td>
																<td id="FIni<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo $row_Detalle['FechaInicio']; ?></td>
																<td id="FCie<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo $row_Detalle['FechaCierre']; ?></td>
																<td id="NomEmp<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo $row_Detalle['DeEmpleado']; ?></td>
																<td id="Eta<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo $row_Detalle['DeEtapa']; ?></td>
																<td id="PrEtap<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo number_format($row_Detalle['PorcentajeEtapa'], 0) . "%"; ?>
																</td>
																<td id="MPot<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo number_format($row_Detalle['MontoPotencial'], 2); ?>
																</td>
																<td id="IPon<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo number_format($row_Detalle['ImportePonderado'], 2); ?>
																</td>
																<td id="Com<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo $row_Detalle['Comentarios']; ?></td>
																<td id="NomObj<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo $row_Detalle['NombreObjeto']; ?></td>
																<td id="DocNum<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo $row_Detalle['DocNumDocumento']; ?></td>
																<td id="NomProp<?php echo $row_Detalle['IdLinea']; ?>">
																	<?php echo $row_Detalle['NombrePropietario']; ?></td>
																<td id="Est<?php echo $row_Detalle['IdLinea']; ?>"><span
																		<?php if ($row_Detalle['IdEstado'] == 'C') {
																			echo "class='label label-info'";
																		} else {
																			echo "class='label label-warning'";
																		} ?>><?php echo $row_Detalle['DeEstado']; ?></span>
																</td>
																<td id="Acc<?php echo $row_Detalle['IdLinea']; ?>">
																	<button type="button"
																		id="btnEdit<?php echo $row_Detalle['IdLinea']; ?>"
																		class="btn btn-success btn-xs"
																		onClick="EditarEtapa('<?php echo $row_Detalle['ID_Oportunidad']; ?>','<?php echo $row_Detalle['IdLinea']; ?>','<?php echo $row_Detalle['IdEstado']; ?>');"><i
																			class="fa fa-pencil"></i> Editar</button>
																	<button type="button"
																		id="btnDel<?php echo $row_Detalle['IdLinea']; ?>"
																		class="btn btn-danger btn-xs"
																		onClick="BorrarLinea('<?php echo $row_Detalle['ID_Oportunidad']; ?>');"><i
										...
										<div id="tabOpr-4" class="tab-pane">
											...
											<div class="row m-b-md">
												<div class="col-lg-12">
													<button class="btn btn-primary" type="button" id="NewParam"
														onClick="CrearSN();"><i class="fa fa-plus-circle"></i> Añadir
														Socio de Negocio</button>
												</div>
											</div>
											<div class="table-responsive">
												<table class="table table-bordered table-hover dataTables-example"
										...
										<div id="tabOpr-5" class="tab-pane">
											...
											<div class="row m-b-md">
												<div class="col-lg-12">
													<button class="btn btn-primary" type="button" id="NewParam"
														onClick="CrearCompetidor();"><i class="fa fa-plus-circle"></i>
														Añadir Competidor</button>
												</div>
											</div>
											<div class="table-responsive">
												<table class="table table-bordered table-hover dataTables-example"
													id="tablaCompetidores">
													<thead>
														<tr>
															<th>#</th>
															<th>Nombre</th>
												...
												<div class="col-lg-3">
													<select name="Estado" class="form-control" id="Estado">
														<?php while ($row_EstadoOpr = sqlsrv_fetch_array($SQL_EstadoOpr)) { ?>
															<option value="<?php echo $row_EstadoOpr['Cod_Estado']; ?>"
																<?php if (($edit == 1) && (isset($row['IdEstadoOportunidad'])) && (strcmp($row_EstadoOpr['Cod_Estado'], $row['IdEstadoOportunidad']) == 0)) {
																	echo "selected=\"selected\"";
																} elseif (($edit == 0) && ($row_EstadoOpr['Cod_Estado'] == 'O')) {
																	echo "selected=\"selected\"";
																} ?>>
																<?php echo $row_EstadoOpr['NombreEstado']; ?></option>
														<?php } ?>
													</select>
												</div>
												<label class="col-lg-1 control-label">Clase de documento</label>
												<div class="col-lg-3">
													<input name="TipoDocResumen" type="hidden" class="form-control"
														id="TipoDocResumen"
														value="<?php if ($edit == 1 || $sw_error == 1) {
															echo $row['IdTipoDocResumen'];
														} ?>">

													<input autocomplete="off" name="NombreDocResumen" type="text"
														class="form-control" id="NombreDocResumen" maxlength="10"
														value="<?php if ($edit == 1 || $sw_error == 1) {
															echo $row['DeTipoDocResumen'];
														} ?>"
														readonly>
												</div>
												<label class="col-lg-1 control-label">Número de documento</label>
												<div class="col-lg-3">
													<input name="DocEntryResumen" type="hidden" class="form-control"
														id="DocEntryResumen"
														value="<?php if ($edit == 1 || $sw_error == 1) {
															echo $row['DocEntryResumen'];
														} ?>">

													<input autocomplete="off" name="DocNumResumen" type="text"
														class="form-control" id="DocNumResumen" maxlength="10"
														value="<?php if ($edit == 1 || $sw_error == 1) {
															echo $row['DocNumResumen'];
														} ?>"
														readonly>
												</div>
											</div>
