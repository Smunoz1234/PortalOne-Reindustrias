...
function BuscarArticulo(dato){
	...
	if(dato!=""){
		if((cardcode!="")&&(almacen!="")&&(idlistaprecio!="")){
			...
			remote=open('buscar_articulo.php?reqdate='+reqdate+'&prjcode='+proyecto+'&empventas='+empleado+'&idlistaprecio='+idlistaprecio+'&dato='+dato+'&cardcode='+cardcode+'&whscode='+almacen+'&doctype=<?php if ($edit == 0) {
				echo "22";
			} else {
				echo "23";
		   ...
		   <div class="col-lg-12">
			  <form action="solicitud_compra.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="CrearSolicitudCompra">
				...
				<div class="form-group">
					...
					<div class="col-lg-3">
						<select id="PrjCode" name="PrjCode" class="form-control select2" required="required" form="CrearSolicitudCompra" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
							echo "disabled='disabled'";
						} ?>>
				...
				<div class="form-group">
					...
					<div class="col-lg-4">
						<input name="BuscarItem" id="BuscarItem" type="text" class="form-control" placeholder="Escriba para buscar..." onBlur="javascript:BuscarArticulo(this.value);" <?php if ((($edit == 1) && ($row['Cod_Estado'] == 'C')) || (!PermitirFuncion(701))) {
							echo "readonly";
						} ?>>
						 </div>
					...
					<div class="tab-content">
						<div id="tab-1" class="tab-pane active">
							<iframe id="DataGrid" name="DataGrid" style="border: 0;" width="100%" height="300" src="<?php if ($edit == 0 && $sw_error == 0) {
								echo "detalle_solicitud_compra.php";
							} elseif ($edit == 0 && $sw_error == 1) {
								echo "detalle_solicitud_compra.php?id=0&type=1&usr=" . $_SESSION['CodUser'] . "&cardcode=" . $row['CardCode'];
							} else {
			   ...
			   <form id="frm" action="" class="form-horizontal">
				...
				<div class="col-lg-8">
					<div class="form-group">
						...
						<div class="col-lg-5">
							<select name="EmpleadoVentas" class="form-control" id="EmpleadoVentas" form="CrearSolicitudCompra" required="required" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
								echo "disabled='disabled'";
							} ?>>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<textarea type="text" maxlength="2000" name="Comentarios" form="CrearSolicitudCompra" rows="4" id="Comentarios" class="form-control" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
								echo "readonly";
							} ?>><?php if ($edit == 1 || $sw_error == 1) {
				...
				<div class="col-lg-4">
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="SubTotal" form="CrearSolicitudCompra" id="SubTotal" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="Descuentos" form="CrearSolicitudCompra" id="Descuentos" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="Impuestos" form="CrearSolicitudCompra" id="Impuestos" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="TotalSolicitud" form="CrearSolicitudCompra" id="TotalSolicitud" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
