		...
		<div class="sidebar-collapse">
			<ul class="nav metismenu" id="side-menu">
				...
				<?php if (PermitirFuncion(207) || PermitirFuncion(208) || PermitirFuncion(209) || PermitirFuncion(210)) { ?>
					<li>
						<a href="#"><i class="fa fa-file-text"></i> <span class="nav-label">Gestión de
				...
				<?php if (PermitirFuncion(301) || PermitirFuncion(303) || PermitirFuncion(305) || PermitirFuncion(306) || PermitirFuncion(307) || PermitirFuncion(308) || PermitirFuncion(310) || PermitirFuncion(311) || PermitirFuncion(312) || PermitirFuncion(316)) {?>
					<li>
						...
						<ul class="nav nav-second-level collapse">
							...
							<?php if (PermitirFuncion([334, 301, 303, 352])) {?>
								<li>
									...
									<ul class='nav nav-third-level'>
										...
										<?php if (PermitirFuncion(303)) {?><li><a class="alnk" href="gestionar_actividades.php">Actividades</a></li><?php }?>
										<?php if (PermitirFuncion(352)) {?><li><a class="alnk" href="parametros_servicios.php">Parámetros de servicios/mantenimiento</a></li><?php }?>
									</ul>
								</li>
							<?php }?>
						...
						<ul class="nav nav-second-level collapse">
							<li>
								...
								<ul class='nav nav-third-level'>
									...
									<li>
										<a class="alnk" href="prov_entradas_compra.php">Entradas de mercancías/servicios</a>
									</li>
							...
							<li>
								...
								<ul class='nav nav-third-level'>
									<li>
										<a class="alnk" href="prov_certificado_retenciones.php">Certificado de retenciones</a>
									</li>
								</ul>
							</li>
				...
				<?php if (PermitirFuncion(801)) { ?>
					<li>
						<a href="#"><i class="fa fa-suitcase"></i> 
							<span class="nav-label">Cartera/CRM</span><span
								class="fa arrow"></span></a>
				...
				<li>
					<a href="#"><i class="fa fa-gears"></i> <span class="nav-label">Administración</span><span
						class="fa arrow"></span></a>
