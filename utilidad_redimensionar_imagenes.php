		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content">
				<div class="ibox-content">
					...
					<div class="row">
						<div class="col-lg-12">
							<form action="utilidad_redimensionar_imagenes.php" method="post" class="form-horizontal"
							...
							<div class="ibox">
								...
								<div class="ibox-content">
									...
									<div class="row">
										<form
											action="upload.php?<?php if ($persistir && false) {
												echo "persistent=redimensionar_imagenes";
											} ?>"
											class="dropzone" id="dropzoneForm" name="dropzoneForm">
