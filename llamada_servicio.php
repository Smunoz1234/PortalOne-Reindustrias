...
if ($type_llmd == 1 && $sw_error == 0) {
    ...
    //Lista de materiales
    $SQL_ListaMateriales = Seleccionar('uvw_Sap_tbl_ListaMateriales', '*', "CDU_IdMarca='" . $row['CDU_IdMarca_TarjetaEquipo'] . "' AND CDU_IdLinea='" . $row['CDU_IdLinea_TarjetaEquipo'] . "'");
											...
											<table class="table table-striped table-bordered table-hover dataTables-example" >
												...
												<?php while ($row_Formularios = sqlsrv_fetch_array($SQL_Formularios)) {?>
													<tr class="gradeX">
														...
														<td><?php echo isset($row_Formularios['fecha_hora']) ? $row_Formularios['fecha_hora']->format('Y-m-d H:i') : ""; ?></td>
