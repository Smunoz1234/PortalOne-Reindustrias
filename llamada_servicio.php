...
$(document).ready(function () {
	...
	<?php if (($edit == 0) && ($sw_error == 0) && ($dt_SLS == 0)) { ?>
			// SMM, 12/07/2023
			  ...
			  <form action="llamada_servicio.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="CrearLlamada">
						...
						<div class="ibox-content">
							<div class="form-group">
								<div class="col-lg-4">
									...
									<input name="ClienteLlamada" type="hidden" id="ClienteLlamada" value="<?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
										echo $row['ID_CodigoCliente'];
									} elseif ($dt_LS == 1) {
										echo $row_Cliente['CodigoCliente'];
									} ?>">
									<input name="NombreClienteLlamada" type="text" required class="form-control" id="NombreClienteLlamada" placeholder="Digite para buscar..." <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1') || ($row['TipoTarea'] == 'Interna')) || ($dt_LS == 1) || ($edit == 1)) {
										echo "readonly";
							...
							<div class="form-group">
								<div class="col-lg-4">
									...
									<input name="DireccionLlamada" type="text" required class="form-control" id="DireccionLlamada" maxlength="100" <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
										echo "readonly";
									} ?> value="<?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
								...
								<div class="col-lg-4">
									...
									<input name="TelefonoLlamada" type="text" class="form-control" required id="TelefonoLlamada" maxlength="50" <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
										echo "readonly";
									} ?> value="<?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
							...
							<div class="form-group">
								...
								<div class="col-lg-3">
									...
									<input name="CDU_TiempoTarea" type="number" class="form-control" id="CDU_TiempoTarea" required <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
										echo "readonly";
									} ?> value="<?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							<div class="col-lg-4">
								...
								<select name="Series" class="form-control" required id="Series" <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
									echo "disabled";
								} ?>>
										<option value="">Seleccione...</option>
							...
							<div class="col-lg-2">
								...
								<input autocomplete="off" name="Ticket" type="text" class="form-control" id="Ticket" maxlength="50" readonly="readonly" value="<?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
									echo $row['DocNum'];
								} ?>">
							</div>
							<div class="col-lg-2">
								<label class="control-label">ID de llamada</label>
								<input autocomplete="off" name="CallID" type="text" class="form-control" id="CallID" maxlength="50" readonly="readonly" value="<?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
							...
							<div class="col-lg-4">
								...
								<div class="input-group date">
									 <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input name="FechaCreacion" type="text" required class="form-control" id="FechaCreacion" value="<?php if (($edit == 1 || ($dt_SLS == 1)) && ($row['FechaCreacionLLamada']) != "") {
						...
						<div class="form-group">
							<div class="col-lg-8">
								...
								<input autocomplete="off" name="AsuntoLlamada" type="text" required class="form-control" id="AsuntoLlamada" maxlength="150" <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
									echo "readonly";
								} ?> value="<?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
							...
							<div class="col-lg-4">
								...
								<div class="input-group clockpicker" data-autoclose="true">
									...
									<input name="HoraCreacion" id="HoraCreacion" type="text" class="form-control" value="<?php if ($edit == 1 || ($dt_SLS == 1)) {
						...
						<div class="form-group">
							<div class="col-lg-4">
								...
								<select name="OrigenLlamada" class="form-control" required id="OrigenLlamada" <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
									echo "disabled";
								} ?>>
									<option value="">Seleccione...</option>
							...
							<div class="col-lg-4">
								...
								<select name="TipoLlamada" class="form-control" required id="TipoLlamada" <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
									echo "disabled";
								} ?>>
									<option value="">Seleccione...</option>
							...
							<div class="col-lg-4">
								...
								<div class="input-group date">
									 ...
									 name="FechaAgenda" type="text" class="form-control" id="FechaAgenda" value="<?php if (($edit == 1 || ($dt_SLS == 1)) && ($row['FechaAgenda'] != "")) {
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								...
								<select name="SubTipoProblema" class="form-control" id="SubTipoProblema" <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
									echo "readonly";
								} ?> required>
									<option value="">Seleccione...</option>
							...
							<div class="col-lg-4">
								...
								<div class="input-group clockpicker" data-autoclose="true">
									...
									name="HoraAgenda" id="HoraAgenda" type="text" class="form-control" value="<?php if (($edit == 1 || ($dt_SLS == 1)) && ($row['HoraAgenda'] != "")) {
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								...
								<select name="EstadoLlamada" class="form-control" id="EstadoLlamada" required <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
									echo "disabled";
								} ?>>
						...
						<div class="form-group">
							<div class="col-lg-8">
								...
								<textarea name="ComentarioLlamada" rows="7" maxlength="3000" required class="form-control" id="ComentarioLlamada" type="text" <?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
									echo "readonly";
								} ?>><?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
					...
					<div class="ibox-content">
						...
						<div class="form-group">
							<div class="col-lg-4">
								...
								<select name="CDU_Marca" class="form-control select2" required id="CDU_Marca"
								<?php if (($edit == 1) && (!PermitirFuncion(302) || ($row['IdEstadoLlamada'] == '-1'))) {
									echo "disabled";
								} ?>>
									<option value="" disabled selected>Seleccione...</option>
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									<div class="col-lg-6">
										...
										<div class="input-group date">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input name="FechaCierre" type="text" required class="form-control" id="FechaCierre" value="<?php if (($edit == 1) && ($row['FechaCierreLLamada']) != "") {
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input <?php if (!$testMode) {
													echo "readonly";
												} ?> autocomplete="off" name="NombreContactoFirma" type="text" class="form-control cierre-input" id="NombreContactoFirma" maxlength="100" value="<?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
											...
											<div class="form-group">
												...
												<input <?php if (!$testMode) {
													echo "readonly";
												} ?> autocomplete="off" name="CedulaContactoFirma" type="number" class="form-control cierre-input" id="CedulaContactoFirma" maxlength="15" value="<?php if (($edit == 1) || ($sw_error == 1 || ($dt_SLS == 1))) {
											...
											<div class="form-group">
												...
												<?php if (($sw_error == 1 || ($dt_SLS == 1)) || (($edit == 1) && ($row['IdEstadoLlamada'] == '-1'))) { ?>
				...
				<div class="ibox">
					...
					<div class="ibox-content">
						...
						} elseif (($edit == 1) && ($sw_error == 1 || ($dt_SLS == 1))) {
							echo base64_encode($row['ID_LlamadaServicio']);
						} elseif (($edit == 0) && ($sw_error == 1 || ($dt_SLS == 1))) {
							echo base64_encode($row['ID_LlamadaServicio']);
						} ?>" />
													...
													<div class="col-lg-9">
														...
														<?php if (PermitirFuncion(302) && ($row['IdEstadoLlamada'] != '-1')) { ?>
															<?php if (PermitirFuncion([401, 402, 404, 409])) { ?>
																<div class="btn-group">
																	<button data-toggle="dropdown" class="btn btn-outline btn-success dropdown-toggle"><i class="fa fa-plus-circle"></i> Agregar documento de ventas <i class="fa fa-caret-down"></i></button>
																	<ul class="dropdown-menu">
																		<?php if (PermitirFuncion(401)) { ?>
																			<li><a class="dropdown-item alkin d-venta" href="oferta_venta.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>">Oferta de venta con LMT</a></li>
																		...
																		<?php if (PermitirFuncion(402)) { ?>
																			<li><a class="dropdown-item alkin d-venta" href="orden_venta.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>">Orden de venta con LMT</a></li>
																		...
																		<?php if (PermitirFuncion(404)) { ?>
																			<li><a class="dropdown-item alkin d-venta" href="entrega_venta.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>">Entrega de venta con LMT</a></li>
																		...
																		<?php if (PermitirFuncion(409)) { ?>
																			<li><a class="dropdown-item alkin d-venta" href="devolucion_venta.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>">Devolución de venta con LMT</a></li>
															...
															<?php if (PermitirFuncion([701, 702, 703, 714])) { ?>
																<div class="btn-group" style="margin-left: 5px;">
																	<button data-toggle="dropdown" class="btn btn-outline btn-primary dropdown-toggle"><i class="fa fa-plus-circle"></i> Agregar documento de compras <i class="fa fa-caret-down"></i></button>
																	<ul class="dropdown-menu">
																		<?php if (PermitirFuncion(701)) { ?>
																			<li><a class="dropdown-item alkin d-compra" href="solicitud_compra.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>">Solicitud de compra con LMT</a></li>
																			<li><a class="dropdown-item alkin d-compra" href="solicitud_compra.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>&LMT=false">Solicitud de compra sin LMT</a></li>
																		<?php } ?>

																		<?php if (PermitirFuncion(702)) { ?>
																			<li><a class="dropdown-item alkin d-compra" href="orden_compra.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>">Orden de compra con LMT</a></li>
																		...
																		<?php if (PermitirFuncion(703)) { ?>
																			<li><a class="dropdown-item alkin d-compra" href="entrega_compra.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>">Entrega de compra con LMT</a></li>
																			<li><a class="dropdown-item alkin d-compra" href="entrega_compra.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>&LMT=false">Entrega de compra sin LMT</a></li>
																		<?php } ?>

																		<?php if (PermitirFuncion(714)) { ?>
																			<li><a class="dropdown-item alkin d-compra" href="devolucion_compra.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>">Devolución de compra con LMT</a></li>
																			<li><a class="dropdown-item alkin d-compra" href="devolucion_compra.php?dt_LS=1&Cardcode=<?php echo base64_encode($ClienteMarketing); ?>&Contacto=<?php echo base64_encode($row['IdContactoLLamada']); ?>&Sucursal=<?php echo base64_encode($row['NombreSucursal']); ?>&Direccion=<?php echo base64_encode($row['DireccionLlamada']); ?>&TipoLlamada=<?php echo base64_encode($row['IdTipoLlamada']); ?>&ItemCode=<?php echo base64_encode($row['CDU_ListaMateriales']); ?>&LS=<?php echo base64_encode($IdLlamada); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('llamada_servicio.php'); ?>&LMT=false">Devolución de compra sin LMT</a></li>
																		<?php } ?>
																	</ul>
																</div>
															<?php } ?>
