...
// Aquii los campos son diferentes ¿?
							...
							<tr>
								<td class="text-center form-inline w-150">
									<div class="checkbox checkbox-success"><input type="checkbox" class="chkSel"
											...
											aria-label="Single checkbox One" <?php if (($row['LineStatus'] == "C") && ($type == 2)) {
								...
								<td>
									<select id="WhsCode<?php echo $i; ?>" name="WhsCode[]" class="form-control select2"
										onChange="ActualizarDatos('WhsCode',<?php echo $i; ?>,<?php echo $row['LineNum']; ?>);"
								...
								<td><input size="15" type="text" id="OnHand<?php echo $i; ?>" name="OnHand[]"
										...
										readonly></td>
								<td><input size="50" type="text" id="CDU_SucursalCliente<?php echo $i; ?>"
										name="CDU_SucursalCliente[]" class="form-control"
										value="<?php echo $row['CDU_SucursalCliente']; ?>"
										onChange="ActualizarDatos('CDU_SucursalCliente',<?php echo $i; ?>,<?php echo $row['LineNum']; ?>);"
								...
								<td><input size="30" type="text" id="CDU_OrdenServicio<?php echo $i; ?>"
										name="CDU_OrdenServicio[]" class="form-control"
										value="<?php echo $row['CDU_OrdenServicio']; ?>"
										onChange="ActualizarDatos('CDU_OrdenServicio',<?php echo $i; ?>,<?php echo $row['LineNum']; ?>);"
										maxlength="100" readonly></td>
