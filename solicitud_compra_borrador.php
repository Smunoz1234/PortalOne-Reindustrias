...
if ($edit == 1 && $sw_error == 0) {
	...
	$LimpiarOrden = EjecutarSP('sp_EliminarDatosSolicitudCompra_Borrador', $ParametrosLimpiar);
...
<!-- Aquí va el copiar a otros documentos, 23/08/2022 -->
				...
				<input type="hidden" form="CrearOrdenCompra" id="IdSolicitudCompra" name="IdSolicitudCompra" value="<?php if ($edit == 1) {
					echo base64_encode($row['ID_OrdenCompra']);
				} ?>" />
