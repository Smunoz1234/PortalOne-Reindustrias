				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<form action="cambiar_firma.php" method="post" class="form-horizontal" id="CambiarFirma"
								enctype="multipart/form-data">
								<div class="form-group">
									<label class="col-xs-12">
										<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-pencil-square"></i> Realice
											su firma</h3>
									</label>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-lg-3">
										<?php if ($row['AnxFirma'] != "") { ?>
											<img id="SigActual" style="max-width: 100%; height: auto;"
												src="<?php echo $dir_new . $row['AnxFirma']; ?>" alt="" />
										<?php } else { ?>
											<div class="alert alert-info text-center h-150 w-150 p-xl border-size-sm">
												<h4><i class="fa fa-info-circle"></i> Aún no tiene ninguna firma realizada
												</h4>
											</div>
										<?php } ?>
									</div>
								...
								<div class="form-group">
									<div class="col-lg-3">
										...
										<button class="btn btn-success m-t-n-lg" type="button" id="FirmaUsuario"
											onClick="AbrirFirma('SigUser');"><i class="fa fa-pencil-square-o"></i>
											Realizar nueva firma</button>
										<input type="hidden" id="SigUser" name="SigUser" value="" />
										<img id="ImgSigUser" style="display: none; max-width: 100%; height: auto;"
											src="" alt="" />
									</div>
								</div>
