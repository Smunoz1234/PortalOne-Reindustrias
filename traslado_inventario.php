									...
									<div class="modal-body">
										<div class="ibox-content">
											...
											<div class="form-group">
												...
												<div class="col-lg-10">
													<textarea readonly form="CrearEntregaVenta" style="color: black; font-weight: bold;" class="form-control" name="MensajeProceso" id="MensajeProceso" type="text" maxlength="250" rows="4"><?php if ($mensajeProceso != "") {
														echo $mensajeProceso;
											...
											<div class="form-group">
												...
												<div class="col-lg-10">
													<textarea <?php if ($edit == 1) {
														echo "readonly";
													} ?> form="CrearEntregaVenta" class="form-control required" name="ComentariosAutor" id="ComentariosAutor" type="text" maxlength="250" rows="4"><?php if ($edit == 1 || $sw_error == 1) {
			   ...
			   <form id="frm" action="" class="form-horizontal">
				...
				<div class="col-lg-8">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<textarea type="text" maxlength="2000" name="Comentarios" form="CrearTrasladoInventario" rows="4" id="Comentarios" class="form-control" <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
								echo "readonly";
				...
				<div class="col-lg-4">
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="SubTotal" form="CrearTrasladoInventario" id="SubTotal" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="Descuentos" form="CrearTrasladoInventario" id="Descuentos" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="Impuestos" form="CrearTrasladoInventario" id="Impuestos" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
					...
					<div class="form-group">
						...
						<div class="col-lg-5">
							<input type="text" name="TotalTraslado" form="CrearTrasladoInventario" id="TotalTraslado" class="form-control" style="text-align: right; font-weight: bold;" value="<?php if ($edit == 1) {
							...
							<?php // if (PermitirFuncion(1213)) {?>
								<div class="form-group">
									<div class="col-lg-5">
										...
										<input form="CrearTrasladoInventario" autocomplete="off" name="NombreRecibeFirma" type="text" class="form-control cierre-input" id="NombreRecibeFirma" maxlength="200" value="<?php echo $row['NombreRecibeFirma'] ?? ""; ?>" required <?php if ($NameFirma != "") {
												 echo "readonly";
											 } ?>>
									</div>
									<div class="col-lg-5">
										<label class="control-label">Cédula de quien recibe</label>
										<input form="CrearTrasladoInventario" autocomplete="off" name="CedulaRecibeFirma" type="number" class="form-control cierre-input" id="CedulaRecibeFirma" maxlength="20" value="<?php echo $row['CedulaRecibeFirma'] ?? ""; ?>" <?php if ($NameFirma != "") {
												 echo "readonly";
											 } ?>>
									</div>
								</div>
					...
					<?php if (($edit == 1) && ($row['DocDestinoDocEntry'] == "") && ($NameFirma != "")) { ?>
						<div class="col-lg-3">
							<div class="btn-group pull-right">
								...
								<ul class="dropdown-menu">
									<li><a class="alkin dropdown-item" href="salida_inventario.php?dt_TI=1&DocEntry=<?php echo base64_encode($row['DocEntry']); ?>&Cardcode=<?php echo base64_encode($row['CardCode']); ?>&Dim1=<?php echo base64_encode($row['OcrCode']); ?>&Dim2=<?php echo base64_encode($row['OcrCode2']); ?>&Dim3=<?php echo base64_encode($row['OcrCode3']); ?>&SucursalFact=<?php echo base64_encode($row['SucursalFacturacion']); ?>&Sucursal=<?php echo base64_encode($row['SucursalDestino']); ?>&Direccion=<?php echo base64_encode($row['DireccionDestino']); ?>&Almacen=<?php echo base64_encode($row['ToWhsCode']); ?>&AlmacenDestino=<?php echo base64_encode($row['ToWhsCode']); ?>&Contacto=<?php echo base64_encode($row['CodigoContacto']); ?>&Empleado=<?php echo base64_encode($row['CodEmpleado']); ?>&IdTipoEntrega=<?php echo $row['IdTipoEntrega'] ?? ""; ?>&IdAnioEntrega=<?php echo $row['IdAnioEntrega'] ?? ""; ?>&Descontable=<?php echo $row['Descontable'] ?? ""; ?>&ValorCuotaDesc=<?php echo $row['ValorCuotaDesc'] ?? ""; ?>&TI=<?php echo base64_encode($row['ID_TrasladoInv']); ?>&Evento=<?php echo base64_encode($row['IdEvento']); ?>&Proyecto=<?php echo base64_encode($row['PrjCode']); ?>&ConceptoSalida=<?php echo base64_encode($row['ConceptoSalida']); ?>&CondicionPago=<?php echo base64_encode($row['IdCondicionPago']); ?>">Salida de inventario</a></li>
								</ul>
							</div>
						</div>
					<?php } ?>
				...
				<input type="hidden" form="CrearTrasladoInventario" id="IdTrasladoInv" name="IdTrasladoInv" value="<?php if ($edit == 1) {
