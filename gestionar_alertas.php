				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<br>
							<form action="gestionar_alertas.php" method="post" class="form-horizontal"
									...
									<div class="col-sm-4">
										<select name="Cliente" required class="form-control m-b chosen-select"
											...
											<?php while ($row_Cliente = sqlsrv_fetch_array($SQL_Cliente)) { ?>
												<option value="<?php echo $row_Cliente['CodigoCliente']; ?>" <?php if ((isset($Cliente)) && (strcmp($row_Cliente['CodigoCliente'], $Cliente) == 0)) {
								...
								<form name="frmAlertas" id="frmAlertas" action="registro.php" method="post">
									<div class="row">
										...
										<div class="col-lg-6">
											<button class="btn btn-primary pull-right" type="submit"><i
													class="fa fa-check"></i> Guardar todo</button>
										</div>
									</div>
									<br>
									<?php $Cont = 1;
										...
										do { ?>
											<div id="div_<?php echo $Cont; ?>">
												<div class="row">
													...
													<div class="col-lg-4">
														<select name="Categoria[]" class="form-control m-b"
															id="Categoria<?php echo $Cont; ?>">
																	...
																	while ($row_MenuLvl2 = sqlsrv_fetch_array($SQL_MenuLvl2)) {
																		...
																		if ($Num_MenuLvl3 >= 1) {
																			...
																			while ($row_MenuLvl3 = sqlsrv_fetch_array($SQL_MenuLvl3)) {
																				if (strcmp($row_MenuLvl3['ID_Categoria'], $row_Datos['ID_Categoria']) == 0) {
																			...
																			if (strcmp($row_MenuLvl2['ID_Categoria'], $row_Datos['ID_Categoria']) == 0) {
																				$Sel = "selected=\"selected\"";
																			} else {
																				$Sel = "";
																			}
													...
													<div class="col-lg-4">
														<select name="Sucursal[]" class="form-control m-b"
															id="Sucursal<?php echo $Cont; ?>">
															<option value="" selected="selected">Seleccione...</option>
															<?php
															$Where = "Where CodigoCliente=''" . $Cliente . "''";
															$SQL_Sucursales = Seleccionar("uvw_Sap_tbl_Clientes_Sucursales", "CodigoCliente, NombreCliente, NombreSucursal", $Where);
															while ($row_Sucursal = sqlsrv_fetch_array($SQL_Sucursales)) { ?>
																<option value="<?php echo $row_Sucursal['NombreSucursal']; ?>" <?php if (strcmp($row_Sucursal['NombreSucursal'], $row_Datos['Sucursal']) == 0) {
																	  echo "selected=\"selected\"";
																  } ?>>
													...
													<div class="col-lg-12">
														<div class="table-responsive">
															<table class="table table-bordered">
																...
																<tbody>
																	<tr>
																		<td><input name="Enero[]" type="text" class="form-control"
																				id="Enero<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Enero'] > 0) {
																					echo $row_Datos['Enero'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text" name="Febrero[]"
																				id="Febrero<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Febrero'] > 0) {
																					echo $row_Datos['Febrero'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text" name="Marzo[]"
																				id="Marzo<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Marzo'] > 0) {
																					echo $row_Datos['Marzo'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text" name="Abril[]"
																				id="Abril<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Abril'] > 0) {
																					echo $row_Datos['Abril'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text" name="Mayo[]"
																				id="Mayo<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Mayo'] > 0) {
																					echo $row_Datos['Mayo'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text" name="Junio[]"
																				id="Junio<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Junio'] > 0) {
																					echo $row_Datos['Junio'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text" name="Julio[]"
																				id="Julio<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Julio'] > 0) {
																					echo $row_Datos['Julio'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text" name="Agosto[]"
																				id="Agosto<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Agosto'] > 0) {
																					echo $row_Datos['Agosto'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text"
																				name="Septiembre[]"
																				id="Septiembre<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Septiembre'] > 0) {
																					echo $row_Datos['Septiembre'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text" name="Octubre[]"
																				id="Octubre<?php echo $Cont; ?>" maxlength="2"
																				placeholder="Día"
																				value="<?php if ($row_Datos['Octubre'] > 0) {
																					echo $row_Datos['Octubre'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text"
																				name="Noviembre[]" id="Noviembre<?php echo $Cont; ?>"
																				maxlength="2" placeholder="Día"
																				value="<?php if ($row_Datos['Noviembre'] > 0) {
																					echo $row_Datos['Noviembre'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																		<td><input class="form-control" type="text"
																				name="Diciembre[]" id="Diciembre<?php echo $Cont; ?>"
																				maxlength="2" placeholder="Día"
																				value="<?php if ($row_Datos['Diciembre'] > 0) {
																					echo $row_Datos['Diciembre'];
																				} ?>"
																				onKeyPress="return justNumbersOnly(event);"></td>
																	</tr>
																</tbody>
											...
											<?php $Cont++;
										} while ($row_Datos = sqlsrv_fetch_array($SQL_Datos));
									} ?>
									...
									<div id="div_<?php echo $Cont; ?>">
										<div class="row">
											...
											<div class="col-lg-4">
												<select name="Sucursal[]" class="form-control m-b"
													...
													$SQL_Sucursales = Seleccionar("uvw_Sap_tbl_Clientes_Sucursales", "CodigoCliente, NombreCliente, NombreSucursal", $Where);
													while ($row_Sucursal = sqlsrv_fetch_array($SQL_Sucursales)) { ?>
														<option value="<?php echo $row_Sucursal['NombreSucursal']; ?>">
															<?php echo $row_Sucursal['NombreSucursal']; ?></option>
													<?php } ?>
												</select>
											</div>
													...
													<table class="table table-bordered">
														...
														<tbody>
															<tr>
																...
																<td><input class="form-control" type="text"
																		name="Noviembre[]" id="Noviembre<?php echo $Cont; ?>"
																		maxlength="2" placeholder="Día" value=""
																		onKeyPress="return justNumbersOnly(event);"></td>
																<td><input class="form-control" type="text"
																		name="Diciembre[]" id="Diciembre<?php echo $Cont; ?>"
																		maxlength="2" placeholder="Día" value=""
										...
										<button type="button" id="<?php echo $Cont; ?>" class="btn btn-success btn-xs"
											onClick="addField(this);"><i class="fa fa-plus"></i> Añadir</button>
										<br><br>
									</div>
