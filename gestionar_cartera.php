				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-info-circle"></i> Ingrese la información
								para consultar el cliente</h3>
							<br>
							<form action="consultar_cliente_cartera.php" method="post" class="form-horizontal"
								id="Consultar">
								<div class="form-group">
									...
									<div class="col-lg-2">
										<button type="submit" class="btn btn-outline btn-info"><i
					...
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<div class="form-group">
								...
								<h3 class="col-lg-3 bg-warning p-xs b-r-sm"><span class="pull-right">Estado de servicio:
										<?php echo $row_Cliente['DeEstadoServicioCliente']; ?></span></h3>
							</div>
							<div class="tabs-container">
								<ul class="nav nav-tabs">
									<li class="active"><a data-toggle="tab" href="#tab-1"><i
												class="fa fa-briefcase"></i> Registrar gestión</a></li>
									<li class=""><a data-toggle="tab" href="#tab-2" onClick="ConsultarTab('2');"><i
												class="fa fa-money"></i> Pagos realizados</a></li>
									<li class=""><a data-toggle="tab" href="#tab-3"><i class="fa fa-calendar"></i>
											Historico de gestión</a></li>
									<li><a data-toggle="tab" href="#tab-4" onClick="ConsultarTab('4');"><i
												class="fa fa-phone"></i> Llamadas de servicios</a></li>
									<li><a data-toggle="tab" href="#tab-5" onClick="ConsultarTab('5');"><i
												class="fa fa-car"></i> Tarjetas de equipo</a></li>
								</ul>
								<div class="tab-content">
									<div id="tab-1" class="tab-pane active">
										<div class="panel-body">
											<form action="gestionar_cartera.php" method="post" class="form-horizontal"
												enctype="multipart/form-data" id="RegistrarGestion">
												<div class="ibox">
													<div class="ibox-title bg-success">
														<?php $Total = SumarFacturasPendientes($Cliente); ?>
														<h5 class="collapse-link"><i class="fa fa-file-text"></i>
															Facturas pendientes</h5>
													...
													<div class="ibox-content">
														<div class="form-group">
															<div class="row m-b-md">
																<div class="col-lg-10">
																	<h2>Total pendiente: <span
																			class="font-bold text-danger"><?php echo "$" . number_format($Total, 0); ?></span>
																	</h2>
																</div>
																<div class="col-lg-2">
																	<button type="button"
																		class="btn btn-primary pull-right" id="btnZIP"
																		name="btnZIP" onClick="DescargarZIP();"
																		disabled><i class="fa fa-file-zip-o"></i>
															...
															<div class="col-lg-12">
																<div class="table-responsive">
																	<table
																		class="table table-bordered table-striped table-hover dataTables-example">
																		<thead>
																			<tr>
																				<th>#</th>
																				<th>Factura</th>
																		...
																		<tbody>
																			...
																			while ($row_FacturasPendientes = sqlsrv_fetch_array($SQL_FacturasPendientes)) { ?>
																				<tr>
																					<td><?php echo $i; ?></td>
																					<td><?php echo $row_FacturasPendientes['NoDocumento']; ?>
																					</td>
																					<td><?php if ($row_FacturasPendientes['FechaContabilizacion']->format('Y-m-d')) {
																						echo $row_FacturasPendientes['FechaContabilizacion']->format('Y-m-d');
																					} else {
																						echo $row_FacturasPendientes['FechaContabilizacion'];
																					} ?>
																					</td>
																					<td><?php if ($row_FacturasPendientes['FechaVencimiento']->format('Y-m-d')) {
																						echo $row_FacturasPendientes['FechaVencimiento']->format('Y-m-d');
																					} else {
																						echo $row_FacturasPendientes['FechaVencimiento'];
																					} ?>
																					</td>
																					<td><?php echo "$" . number_format($row_FacturasPendientes['TotalDocumento'], 2); ?>
																					</td>
																					<td><?php echo "$" . number_format($row_FacturasPendientes['ValorPagoDocumento'], 2); ?>
																					</td>
																					<td><?php echo number_format($row_FacturasPendientes['DiasVencidos'], 0); ?>
																					</td>
																					<td><?php echo "$" . number_format($row_FacturasPendientes['SaldoDocumento'], 2); ?>
																					</td>
																					<td><a href="sapdownload.php?id=<?php echo base64_encode('15'); ?>&type=<?php echo base64_encode('2'); ?>&DocKey=<?php echo base64_encode($row_FacturasPendientes['NoInterno']); ?>&ObType=<?php echo base64_encode('13'); ?>&IdFrm=<?php echo base64_encode($row_FacturasPendientes['IdSeries']); ?>"
																							target="_blank"
																					...
																					<td>
																						<div
																							...
																							<input type="checkbox"
																								class="chkSelOT"
																								id="singleCheckbox<?php echo $row_FacturasPendientes['NoDocumento']; ?>"
																								value=""
																								onChange="SeleccionarFactura('<?php echo $row_FacturasPendientes['NoInterno']; ?>','<?php echo ('13'); ?>','<?php echo ($row_FacturasPendientes['IdSeries']); ?>');"
												...
												<?php if (isset($row_TE['CDU_Fecha_SOAT']) && $Exp_SOAT) { ?>
													<div class="alert alert-info alert-dismissible"
														...
														<i class="fa fa-stethoscope"></i> El SOAT de este cliente esta
														próximo a vencerse.</p>
													</div>
												<?php } ?>
												<?php if (isset($row_TE['CDU_Fecha_Tecno']) && $Exp_Tecno) { ?>
													<div class="alert alert-success alert-dismissible"
														...
														<a href="#" class="close" data-dismiss="alert"
															aria-label="close">&times;</a>
														<i class="fa fa-wrench"></i> La Tecno. de este cliente esta próxima
														a vencerse.</p>
													</div>
												<?php } ?>
												<!-- SMM, 13/07/2022 -->
												...
												<div class="form-group">
													<label class="col-lg-12">
														<h3 class="bg-success p-xs b-r-sm"><i
																class="fa fa-briefcase"></i> Registrar gestión</h3>
													</label>
												</div>
												<div class="form-group">
													<label class="col-lg-2 control-label">Sucursal <span
															class="text-danger">*</span></label>
													<div class="col-lg-4">
														<select name="SucursalCliente" class="form-control select2"
															id="SucursalCliente" required>
															...
															<?php while ($row_SucursalCliente = sqlsrv_fetch_array($SQL_SucursalCliente)) { ?>
																<option
																	...
																	<?php if ((isset($row_TE['Ciudad'])) && (strcmp($row_TE['Ciudad'], $row_SucursalCliente['NombreSucursal']) == 0)) {
												...
												<div class="form-group">
													<label class="col-lg-2 control-label"><i
															onClick="ConsultarEquipo();"
															title="Consultar tarjeta de equipo" style="cursor: pointer"
															class="btn-xs btn-success fa fa-search"></i> Tarjeta de
														equipo</label>
													<div class="col-lg-4">
														<select name="NumeroSerie" class="form-control select2"
															id="NumeroSerie">
															<option value="" disabled selected>Seleccione...</option>
															<?php while ($row_NumeroSerie = sqlsrv_fetch_array($SQL_NumeroSerie)) { ?>
																<option
																	value="<?php echo $row_NumeroSerie['SerialInterno']; ?>"
																	data-id="<?php echo $row_NumeroSerie['IdTarjetaEquipo'] ?? ""; ?>"
																	<?php if ((isset($row_TE['IdTarjetaEquipo'])) && (strcmp($row_TE['IdTarjetaEquipo'], $row_NumeroSerie['IdTarjetaEquipo']) == 0)) {
																		echo "selected='selected'";
																	} ?>>
												...
												<div class="form-group">
													...
													<div class="col-lg-3">
														<select name="TipoGestion" class="form-control select2"
															id="TipoGestion" required>
															<option value="">Seleccione...</option>
															<?php while ($row_TipoGestion = sqlsrv_fetch_array($SQL_TipoGestion)) { ?>
																<option
																	value="<?php echo $row_TipoGestion['ID_TipoGestion']; ?>">
																	<?php echo $row_TipoGestion['TipoGestion']; ?>
																</option>
															<?php } ?>
														</select>
														<input type="hidden" name="TipoDestino" id="TipoDestino"
															value="" />
													</div>
												</div>
												<div class="form-group">
													...
													<div id="dv_btnLlamar" class="col-lg-2" style="display: none;">
														<button title="Llamar" type="button" class="btn btn-success"
															onClick="return EsTel('<?php echo base64_encode($FileCall); ?>');"><i
												...
												<div class="form-group">
													...
													<div class="col-lg-3">
														<select name="Evento" class="form-control select2" id="Evento"
															required>
															<option value="">Seleccione...</option>
														</select>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-3">
														<select name="Dirigido" class="form-control select2"
															id="Dirigido" required>
															<option value="">Seleccione...</option>
															<?php
												...
												<div class="form-group">
													...
													<div class="col-lg-4">
														<select name="ResultadoGestion" class="form-control select2"
															id="ResultadoGestion" required>
															<option value="">Seleccione...</option>
														</select>
													</div>
												</div>
												<div class="form-group">
													...
													<div id="dv_btnComents" class="col-lg-2">
														<button title="Agregar comentario sugerido" type="button"
															class="btn btn-warning" onClick="ObtenerComentario();"><i
																class="fa fa-comment"></i></button>
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-2 control-label">Fecha de compromiso de
														pago/recordatorio</label>
													<div class="col-lg-2 input-group date">
														<span class="input-group-addon"><i
																class="fa fa-calendar"></i></span><input
															name="FechaCompPago" type="text" class="form-control"
															id="FechaCompPago" value="" readonly="readonly"
															placeholder="YYYY-MM-DD">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-2 control-label">Causa de no
														pago/recordatorio</label>
													<div class="col-lg-4">
														<select name="CausaNoPago" class="form-control select2"
															id="CausaNoPago">
												...
												<div class="form-group">
													...
													<div class="col-lg-4">
														<label class="checkbox-inline i-checks"><input
																name="chkLiqIntereses" id="chkLiqIntereses"
																type="checkbox" value="1"> Registrar liquidación de
															intereses</label>
													</div>
												</div>
												<div id="dvLiqIntereses" style="display: none;">
													<div class="form-group">
														<label class="col-lg-12">
															<h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-money"></i>
																Liquidar intereses</h3>
														</label>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Fecha liquidación</label>
														<div class="col-lg-2 input-group date">
															<span class="input-group-addon"><i
																	class="fa fa-calendar"></i></span><input
													...
													<div class="form-group">
														...
														<div class="col-lg-2">
															<label class="checkbox-inline i-checks"><input
																	name="chkCobIntLiqInt" id="chkCobIntLiqInt"
																	type="checkbox" value="1" checked="checked"> Cobrar
																intereses</label>
														</div>
														<?php if (PermitirFuncion(205)) { ?>
															...
															<div class="col-lg-3">
																<label class="checkbox-inline i-checks"><input
																		name="chkVerFactNoVencLiqInt"
																		id="chkVerFactNoVencLiqInt" type="checkbox"
																		value="1"> Mostrar facturas no vencidas</label>
															</div>
														<?php } ?>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-lg-3">
															<input name="TotalSaldoLiqInt" type="text"
																class="form-control text-right" id="TotalSaldoLiqInt"
																maxlength="50" readonly="readonly" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Intereses en mora
															($)</label>
														<div class="col-lg-3">
															<input name="InteresesMoraLiqInt" type="text"
																class="form-control text-right" readonly="readonly"
																id="InteresesMoraLiqInt" maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Retiro anticipado
															($)</label>
														<div class="col-lg-3">
															<input name="RetiroAnticipadoLiqInt" type="text"
																class="form-control text-right"
																id="RetiroAnticipadoLiqInt" maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Gastos de cobranza
															($)</label>
														<div class="col-lg-3">
															<input name="GastosCobranzaLiqInt" type="text"
																class="form-control text-right" readonly="readonly"
																id="GastosCobranzaLiqInt" maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Cobro prejurídico
															($)</label>
														<div class="col-lg-3">
															<input name="CobroPrejuridicoLiqInt" type="text"
																class="form-control text-right" readonly="readonly"
																id="CobroPrejuridicoLiqInt" maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Total liquidado
															($)</label>
														<div class="col-lg-3">
															<input name="TotalLiquidadoLiqInt" type="text"
																class="form-control text-right" readonly="readonly"
																id="TotalLiquidadoLiqInt" maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Descuento ($)</label>
														<div class="col-lg-3">
															<input name="DescuentoLiqInt" type="text"
																class="form-control text-right" id="DescuentoLiqInt"
													...
													<div class="form-group">
														...
														<div class="col-lg-3">
															<input name="TotalPagarLiqInt" type="text"
																class="form-control text-right font-bold"
																readonly="readonly" id="TotalPagarLiqInt" maxlength="50"
																value="0">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-lg-4">
														<label class="checkbox-inline i-checks"><input
																name="chkRegAcuerdo" id="chkRegAcuerdo" type="checkbox"
																value="1"> Registrar acuerdo de pago</label>
													</div>
												</div>
												<div id="dvAcuerdos" style="display: none;">
													<div class="form-group">
														<label class="col-lg-12">
															<h3 class="bg-muted p-xs b-r-sm"><i
																	class="fa fa-handshake-o"></i> Acuerdos de pago</h3>
														</label>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Tipo de convenio</label>
														<div class="col-lg-3">
															<select name="TipoConvenio" class="form-control"
																id="TipoConvenio">
													...
													<div class="form-group">
														...
														<div class="col-lg-2">
															<label class="checkbox-inline i-checks"><input
																	name="chkCobInt" id="chkCobInt" type="checkbox"
																	value="1" checked="checked"> Cobrar
																intereses</label>
														</div>
														<?php if (PermitirFuncion(205)) { ?>
															<label class="col-lg-2 control-label">Facturas</label>
															<div class="col-lg-3">
																<label class="checkbox-inline i-checks"><input
																		name="chkVerFactNoVenc" id="chkVerFactNoVenc"
																		type="checkbox" value="1"> Mostrar facturas no
																	vencidas</label>
															</div>
														<?php } ?>
													</div>
													...
													<div class="form-group">
														<label class="col-lg-2 control-label">Total saldo ($)</label>
														<div class="col-lg-3">
															<input name="TotalSaldo" type="text"
																class="form-control text-right" id="TotalSaldo"
																maxlength="50" readonly="readonly" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Intereses en mora
															($)</label>
														<div class="col-lg-3">
															<input name="InteresesMora" type="text"
																class="form-control text-right" readonly="readonly"
																id="InteresesMora" maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Retiro anticipado
															($)</label>
														<div class="col-lg-3">
															<input name="RetiroAnticipado" type="text"
																class="form-control text-right" id="RetiroAnticipado"
																maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Gastos de cobranza
															($)</label>
														<div class="col-lg-3">
															<input name="GastosCobranza" type="text"
																class="form-control text-right" readonly="readonly"
																id="GastosCobranza" maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Cobro prejurídico
															($)</label>
														<div class="col-lg-3">
															<input name="CobroPrejuridico" type="text"
																class="form-control text-right" readonly="readonly"
																id="CobroPrejuridico" maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Total liquidado
															($)</label>
														<div class="col-lg-3">
															<input name="TotalLiquidado" type="text"
																class="form-control text-right" readonly="readonly"
																id="TotalLiquidado" maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Descuento ($)</label>
														<div class="col-lg-3">
															<input name="Descuento" type="text"
																class="form-control text-right" id="Descuento"
																maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">TOTAL A PAGAR ($)</label>
														<div class="col-lg-3">
															<input name="TotalPagar" type="text"
																class="form-control text-right font-bold"
																readonly="readonly" id="TotalPagar" maxlength="50"
																value="0">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-lg-3">
															<input name="AbonoInicial" type="text"
																class="form-control text-right" id="AbonoInicial"
																maxlength="50" value="0">
														</div>
													</div>
													<div class="form-group">
														<label class="col-lg-2 control-label">Saldo a diferir
															($)</label>
														<div class="col-lg-3">
															<input name="SaldoDiferir" type="text"
																class="form-control text-right" id="SaldoDiferir"
																maxlength="50" readonly="readonly" value="0">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-lg-2">
															<input class="touchspin1" type="text" value="1"
												...
												<div class="form-group">
													<div class="col-lg-4">
														<button class="btn btn-primary" type="submit" id="Guardar"><i
																class="fa fa-check"></i>&nbsp;Guardar gestión</button>
													</div>
												</div>
												<br>
							   ...
							   <iframe scrolling="no" marginheight="0" frameborder="0" class="col-lg-12" id="dv_ElastixLlamada" src="frm2.php?type=1" style="border-style:solid; border-width:0; padding-left:0; padding-right:0; padding-top:0; padding-bottom:0" height="70"></iframe>
									...
									<div id="tab-3" class="tab-pane">
										<div class="panel-body">
											<label class="col-lg-12">
												<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-calendar"></i>
													Historico de gestiones</h3>
											</label>
											<div class="col-lg-12">
												<div class="table-responsive">
													<table style="width: 100%;"
														...
														<tbody>
															...
															<?php while ($row_HistGestion = sqlsrv_fetch_array($SQL_HistGestion)) { ?>
																<tr class="gradeX">
																	<td><?php echo $i; ?></td>
																	<td><?php echo $row_HistGestion['TipoGestion']; ?><?php if ($row_HistGestion['CallFile'] != "") { ?><a
																				href="recorddownload.php?file=<?php echo base64_encode($row_HistGestion['ID_Gestion']); ?>"
																				target="_blank" class="btn btn-link btn-xs"
																				title="Descargar grabación"><i
																					class="fa fa-phone"></i></a><?php } ?></td>
																	<td><?php echo $row_HistGestion['Destino']; ?></td>
																	<td><?php echo $row_HistGestion['NombreEvento']; ?></td>
																	<td><?php echo $row_HistGestion['ResultadoGestion']; ?>
																	</td>
																	...
																	<td><?php echo $row_HistGestion['FechaRegistro']->format('Y-m-d H:i'); ?>
																	</td>
																	<td><?php echo $row_HistGestion['Usuario']; ?></td>
																	<td><?php echo $row_HistGestion['SucursalCliente']; ?>
																	</td>
											...
											<label class="col-lg-12">
												<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-handshake-o"></i>
													Historico de acuerdos de pago</h3>
											</label>
											<div class="col-lg-12">
												<div class="table-responsive">
													<table style="width: 100%;"
														...
														<tbody>
															<?php while ($row_HistAcuerdos = sqlsrv_fetch_array($SQL_HistAcuerdos)) { ?>
																<tr class="gradeX">
																	<td><?php if ($row_HistAcuerdos['FechaAcuerdo'] != "") {
																		echo $row_HistAcuerdos['FechaAcuerdo']->format('Y-m-d');
																	} else {
																		echo "--";
																	} ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['TotalSaldo'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['InteresesMora'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['GastosCobranza'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['CobroPrejuridico'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['TotalLiquidado'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['Descuento'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['TotalPagar'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['AbonoInicial'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['SaldoDiferir'], 0); ?>
																	</td>
																	<td><?php echo number_format($row_HistAcuerdos['Cuotas'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_HistAcuerdos['ValorCuota'], 0); ?>
																	</td>
																	<td><?php echo $row_HistAcuerdos['FechaRegistro']->format('Y-m-d H:i'); ?>
																	</td>
																	<td><?php echo $row_HistAcuerdos['Usuario']; ?></td>
																	<td><a href="sapdownload.php?id=<?php echo base64_encode('11'); ?>&type=<?php echo base64_encode('2'); ?>&DocKey=<?php echo base64_encode($row_HistAcuerdos['ID_Acuerdo']); ?>"
																			target="_blank"
																			class="btn btn-warning btn-xs"><i
											...
											<label class="col-lg-12">
												<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-money"></i> Historico
													de liquidación de intereses</h3>
											</label>
											<div class="col-lg-12">
												<div class="table-responsive">
													<table style="width: 100%;"
														...
														<tbody>
															<?php while ($row_LiqIntereses = sqlsrv_fetch_array($SQL_LiqIntereses)) { ?>
																<tr class="gradeX">
																	<td><?php if ($row_LiqIntereses['FechaLiquidacion'] != "") {
																		echo $row_LiqIntereses['FechaLiquidacion']->format('Y-m-d');
																	} else {
																		echo "--";
																	} ?>
																	</td>
																	<td><?php echo "$" . number_format($row_LiqIntereses['TotalSaldo'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_LiqIntereses['InteresesMora'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_LiqIntereses['GastosCobranza'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_LiqIntereses['CobroPrejuridico'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_LiqIntereses['TotalLiquidado'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_LiqIntereses['Descuento'], 0); ?>
																	</td>
																	<td><?php echo "$" . number_format($row_LiqIntereses['TotalPagar'], 0); ?>
																	</td>
																	<td><?php echo $row_LiqIntereses['FechaRegistro']->format('Y-m-d H:i'); ?>
																	</td>
																	<td><?php echo $row_LiqIntereses['Usuario']; ?></td>
																	<td><a href="sapdownload.php?id=<?php echo base64_encode('12'); ?>&type=<?php echo base64_encode('2'); ?>&DocKey=<?php echo base64_encode($row_LiqIntereses['ID_LiqInt']); ?>"
																			target="_blank"
																			class="btn btn-warning btn-xs"><i
																				class="fa fa-download"></i> Descargar</a>
																	</td>
