									...
									<div class="col-lg-3">
										<div class="input-daterange input-group" id="datepicker">
											<input name="FechaInicial" type="text" class="input-sm form-control"
												id="FechaInicial" autocomplete="off" placeholder="Fecha inicial"
												value="<?php echo $FechaInicial; ?>" />
											<span class="input-group-addon">hasta</span>
											<input name="FechaFinal" type="text" class="input-sm form-control"
												id="FechaFinal" autocomplete="off" placeholder="Fecha final"
								...
								<div class="form-group">
									...
									<div class="col-lg-3">
										<select data-placeholder="(Todos)" name="TipoLlamada[]"
											class="form-control select2" id="TipoLlamada" multiple>
											<?php $j = 0;
				...
				<div class="row m-b-md">
					...
					<div class="col-lg-3">
						<div class="ibox ">
							...
							<div class="ibox-content">
								<h1 class="no-margins">
									<?php echo number_format($row_Cont['TotalServiciosSinFactura'], 2); ?></h1>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="ibox-content form-horizontal">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-hover dataTables">
									<caption>
										<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-list"></i> Resumen por
											cliente</h3>
									</caption>
									<thead>
										<tr>
									...
									<tbody>
										...
										while ($row = sqlsrv_fetch_array($SQL)) { ?>
											<tr>
												<td><?php echo $i; ?></td>
												<td class="drill" data-cardcode='<?php echo $row['CodigoCliente']; ?>'><a
														href='javascript:void(0);'><i class='fa fa-plus-square-o'></i>
														<?php echo $row['CodigoCliente']; ?></a></td>
		...
		$(document).ready(function () {
			...
			$('.dataTables tbody').on('click', 'td.drill', function (ev) {
				...
				if (row.child.isShown()) {
					...
					$.get('dsb_facturacion_detalle.php',
						{
							id: cardcode,
