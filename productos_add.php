				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<?php if ($Step == 1) { ?>
								<form action="productos_add.php" method="post" class="form-horizontal"
									id="SeleccionarProducto">
									<div class="form-group">
										<label class="col-lg-12">
											<h3 class="bg-muted p-xs b-r-sm"><i class="fa fa-cloud-upload"></i> Seleccione
												el producto para cargar la información</h3>
										</label>
									</div>
									<div class="form-group">
										<label class="col-sm-1 control-label">Producto</label>
										<div class="col-sm-5">
											<select name="Producto" required class="form-control m-b chosen-select"
												id="Producto">
												<option value="">Seleccione...</option>
												<?php while ($row_Productos = sqlsrv_fetch_array($SQL_Productos)) { ?>
													<option value="<?php echo $row_Productos['ItemCode']; ?>">
									...
									<div class="form-group">
										<div class="col-sm-9">
											<button class="btn btn-primary" type="submit">Continuar <i
												...
												href="gestionar_productos.php" class="btn btn-outline btn-default"><i
								...
								<form action="registro.php" method="post" class="form-horizontal" id="AgregarDatos">
									...
									<div class="form-group">
										<p class="col-lg-12 text-primary">
											Producto:<br><strong><?php echo $ItemName; ?></strong></p>
									</div>
									<br>
									<?php
											...
											<div class="col-lg-12">
															...
															<div class="file">
																<a href="#">
																	...
																	<div class="file-name truncate">
																		<?php echo $archivo; ?><br /><small><?php echo $peso; ?></small>
																	</div>
																</a>
															</div>
														</div>
												...
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<select required name="Categoria<?php echo $i; ?>"
																class="form-control m-b" id="Categoria<?php echo $i; ?>"
																onChange="RevisarCat('<?php echo $i; ?>');">
																<option value="" selected="selected">Seleccione...</option>
																<?php while ($row_CatProductos = sqlsrv_fetch_array($SQL_CatProductos)) { ?>
																	<option
																		value="<?php echo $row_CatProductos['ID_CategoriaProductos']; ?>">
																		<?php echo $row_CatProductos['NombreCategoriaProductos']; ?>
																	</option>
																<?php } ?>
															</select>
														</div>
