				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<form action="maps_actividades_tecnicos.php" method="post" id="formFiltro"
								...
								<div class="form-group">
									<label class="col-lg-1 control-label">Empleado <span
									...
									<div class="col-lg-3">
										<select name="Tecnico" class="form-control m-b select2" id="Tecnico" required>
											...
											<?php while ($row_Tec = sqlsrv_fetch_array($SQL_Tec)) { ?>
												<option value="<?php echo $row_Tec['ID_Empleado']; ?>" <?php if ((isset($_POST['Tecnico'])) && (strcmp($row_Tec['ID_Empleado'], $_POST['Tecnico']) == 0)) {
													  echo "selected=\"selected\"";
												  } ?>>
													<?php echo $row_Tec['NombreEmpleado']; ?>
												</option>
											<?php } ?>
										</select>
									</div>
									<label class="col-lg-1 control-label">Fecha <span
											class="text-danger">*</span></label>
									<div class="col-lg-2 input-group date">
										<span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
											name="Fecha" type="text" class="form-control" id="Fecha"
											value="<?php if (isset($_POST['Fecha'])) {
												echo $_POST['Fecha'];
											} else {
												echo date('Y-m-d');
											} ?>"
											readonly="readonly" required placeholder="YYYY-MM-DD">
									</div>
									<div class="col-lg-2">
										<button type="submit" class="btn btn-outline btn-success"><i
												class="fa fa-map-marker"></i> Localizar</button>
									</div>
								</div>
							</form>
						</div>
