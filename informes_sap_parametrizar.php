		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="wrapper wrapper-content">
				<div class="ibox-content">
					...
					<div class="row">
						<div class="col-lg-12">
							<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-info-circle"></i> Seleccione el informe a
								parametrizar</h3>
							<br>
							<form action="informes_sap_parametrizar.php" method="post" class="form-horizontal"
								id="Consultar">
									...
									<div class="col-lg-4">
										<select name="InformeSAP" class="form-control m-b" id="InformeSAP" required>
											...
											<?php while ($row_Informe = sqlsrv_fetch_array($SQL_Informe)) { ?>
												<option value="<?php echo $row_Informe['ID_Categoria']; ?>" <?php if ((isset($ID)) && (strcmp($row_Informe['ID_Categoria'], $ID) == 0)) {
													  echo "selected=\"selected\"";
												  } ?>>
													<?php echo $row_Informe['NombreCategoria']; ?></option>
											<?php } ?>
										</select>
									</div>
									<div class="col-lg-2">
				...
				<?php if ($sw == 1) { ?>
					<div class="row">
						<div class="col-lg-12">
							<div class="ibox-content">
								<?php include ("includes/spinner.php"); ?>
								<h3 class="bg-primary p-xs b-r-sm"><i class="fa fa-check-circle-o"></i> Configure los campos
									del informe</h3><br>
								<form action="informes_sap_parametrizar.php" method="post" id="frmCampos"
									class="form-horizontal">
									<div class="form-group">
										<label class="col-lg-2 control-label text-success">Nombre del método WS</label>
										<div class="col-lg-3">
											<input name="NombreWS" type="text" required="required" class="form-control"
												id="NombreWS" maxlength="50"
												value="<?php if ($row_WS['NombreWS'] != "") {
													echo $row_WS['NombreWS'];
												} ?>"
												autocomplete="off">
										</div>
										<label class="col-lg-2 control-label text-success">Nombre del archivo</label>
										<div class="col-lg-3">
											<input name="NombreReporte" type="text" required="required" class="form-control"
												id="NombreReporte" maxlength="50"
												value="<?php if ($row_WS['NombreReporte'] != "") {
													echo $row_WS['NombreReporte'];
												} ?>"
												autocomplete="off" placeholder="Incluyendo la extensión del archivo...">
										</div>
									</div>
									<?php $Cont = 1;
									if ($Num_Campos > 0) {
										...
										do { ?>
											<div id="div_<?php echo $Cont; ?>" class="bg-muted p-sm m-t-md">
												<div class="form-group">
													...
													<div class="col-lg-3">
														<input name="NombreParam[]" type="text" required="required"
															class="form-control" id="NombreParam_<?php echo $Cont; ?>" maxlength="50"
															value="<?php echo $row_Campos['NombreParam']; ?>" autocomplete="off">
													</div>
													<label class="col-lg-2 control-label">Label del campo</label>
													<div class="col-lg-3">
														<input name="LabelCampo[]" type="text" required="required"
															class="form-control" id="LabelCampo_<?php echo $Cont; ?>" maxlength="50"
															value="<?php echo $row_Campos['LabelCampo']; ?>" <?php if ($row_Campos['TipoCampo'] == 'Usuario') {
																  echo "readonly";
															  } ?>
															autocomplete="off">
													</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-3">
														<input name="NombreCampo[]" type="text" required="required"
															class="form-control" id="NombreCampo_<?php echo $Cont; ?>" maxlength="50"
															value="<?php echo $row_Campos['NombreCampo']; ?>" <?php if ($row_Campos['TipoCampo'] == 'Usuario') {
																  echo "readonly";
															  } ?>
															autocomplete="off">
													</div>
													...
													<div class="col-lg-3">
														<select name="TipoCampo[]" class="form-control m-b"
															id="TipoCampo_<?php echo $Cont; ?>" required
															onChange="ChangeTipoCampo('<?php echo $Cont; ?>');">
															<option value="Texto" <?php if ($row_Campos['TipoCampo'] == 'Texto') {
																echo "selected=\"selected\"";
															} ?>>Texto</option>
															<option value="Comentario" <?php if ($row_Campos['TipoCampo'] == 'Comentario') {
																echo "selected=\"selected\"";
															} ?>>Comentario</option>
															<option value="Fecha" <?php if ($row_Campos['TipoCampo'] == 'Fecha') {
																echo "selected=\"selected\"";
															} ?>>Fecha</option>
															<option value="Cliente" <?php if ($row_Campos['TipoCampo'] == 'Cliente') {
																echo "selected=\"selected\"";
															} ?>>Cliente (Lista)</option>
															<option value="Sucursal" <?php if ($row_Campos['TipoCampo'] == 'Sucursal') {
																echo "selected=\"selected\"";
															} ?>>Sucursal (Dependiendo del cliente)
															</option>
															<option value="Seleccion" <?php if ($row_Campos['TipoCampo'] == 'Seleccion') {
																echo "selected=\"selected\"";
															} ?>>Selección (Checkbox)</option>
															<option value="Lista" <?php if ($row_Campos['TipoCampo'] == 'Lista') {
																echo "selected=\"selected\"";
															} ?>>Lista (Personalizada)</option>
															<option value="Usuario" <?php if ($row_Campos['TipoCampo'] == 'Usuario') {
																echo "selected=\"selected\"";
															} ?>>Usuario</option>
														</select>
													</div>
												</div>
												<div id="dv_ConfCheck_<?php echo $Cont; ?>" <?php if ($row_Campos['TipoCampo'] != 'Seleccion') { ?>style="display: none;" <?php } ?>
													class="form-group">
													<label class="col-lg-2 control-label">Nombre checkbox</label>
													<div class="col-lg-3">
														<input name="NombreCheckbox[]" type="text" required="required"
															class="form-control" id="NombreCheckbox_<?php echo $Cont; ?>"
															maxlength="50" value="<?php echo $row_Campos['NombreCheckbox']; ?>"
															autocomplete="off">
													</div>
												</div>
												<?php
												...
												<div id="dv_ConfList_<?php echo $Cont; ?>" <?php if ($row_Campos['TipoCampo'] != 'Lista') { ?>style="display: none;" <?php } ?>>
													<div class="form-group">
														...
														<div class="col-lg-3">
															<input name="VistaList[]" type="text" required="required"
																class="form-control" id="VistaList_<?php echo $Cont; ?>"
																maxlength="100" value="<?php echo $row_Campos['VistaList']; ?>"
																autocomplete="off">
														</div>
														<div class="col-lg-1">
															<button type="button"
																onClick="ConsultarCamposList('<?php echo $Cont; ?>');"
																class="btn btn-success btn-xs" title="Consultar"><i
																	class="fa fa-search"></i></button>
														</div>
														<label class="col-lg-1 control-label">Etiqueta</label>
														<div class="col-lg-2">
															<select name="EtiqList[]" class="form-control m-b"
																id="EtiqList_<?php echo $Cont; ?>" required>
																<option value="">Seleccione...</option>
																<?php if ($row_Campos['TipoCampo'] == 'Lista') {
																	while ($row_List = sqlsrv_fetch_array($SQL_List)) { ?>
																		<option value="<?php echo $row_List['COLUMN_NAME']; ?>" <?php if ((isset($row_Campos['EtiquetaList'])) && (strcmp($row_List['COLUMN_NAME'], $row_Campos['EtiquetaList']) == 0)) {
																			  echo "selected=\"selected\"";
																		  } ?>>
																			<?php echo $row_List['COLUMN_NAME']; ?></option>
																	<?php }
																} ?>
															</select>
														</div>
														...
														<div class="col-lg-2">
															<select name="ValorList[]" class="form-control m-b"
																id="ValorList_<?php echo $Cont; ?>" required>
																<option value="">Seleccione...</option>
																<?php if ($row_Campos['TipoCampo'] == 'Lista') {
																	$SQL_List = sqlsrv_query($conexion, $Cons_List);
																	while ($row_List = sqlsrv_fetch_array($SQL_List)) { ?>
																		<option value="<?php echo $row_List['COLUMN_NAME']; ?>" <?php if ((isset($row_Campos['ValorList'])) && (strcmp($row_List['COLUMN_NAME'], $row_Campos['ValorList']) == 0)) {
																			  echo "selected=\"selected\"";
																		  } ?>>
																			<?php echo $row_List['COLUMN_NAME']; ?></option>
																	<?php }
													...
													<div class="form-group">
														...
														<div class="col-lg-2">
															<select name="TodosList[]" class="form-control m-b"
																id="TodosList_<?php echo $Cont; ?>">
																<option value="0" <?php if ($row_Campos['TodosList'] == 0) {
																	echo "selected";
																} ?>>NO</option>
																<option value="1" <?php if ($row_Campos['TodosList'] == 1) {
																	echo "selected";
																} ?>>SI</option>
															</select>
														</div>
												...
												<div class="form-group">
													<div id="dv_CampoOblig_<?php echo $Cont; ?>" <?php if ($row_Campos['TipoCampo'] == 'Usuario') { ?>style="display: none;" <?php } ?>>
														...
														<div class="col-lg-2">
															<select name="CampoOblig[]" class="form-control m-b"
																id="CampoOblig_<?php echo $Cont; ?>">
																<option value="0" <?php if ($row_Campos['CampoObligatorio'] == 0) {
																	echo "selected";
																} ?>>NO</option>
																<option value="1" <?php if ($row_Campos['CampoObligatorio'] == 1) {
																	echo "selected";
																} ?>>SI</option>
															</select>
														</div>
													...
													<div id="dv_Multiple_<?php echo $Cont; ?>" <?php if (($row_Campos['TipoCampo'] != 'Sucursal') && ($row_Campos['TipoCampo'] != 'Lista')) { ?>style="display: none;"
														<?php } ?>>
														<label class="col-lg-2 control-label">Permitir varios valores</label>
														<div class="col-lg-2">
															<select name="Multiple[]" class="form-control m-b"
																id="Multiple_<?php echo $Cont; ?>">
																<option value="0" <?php if ($row_Campos['Multiple'] == 0) {
																	echo "selected";
																} ?>>NO</option>
																<option value="1" <?php if ($row_Campos['Multiple'] == 1) {
																	echo "selected";
																} ?>>SI</option>
															</select>
														</div>
												...
												<button type="button" id="<?php echo $Cont; ?>"
													class="btn btn-warning btn-xs btn_del"><i class="fa fa-minus"></i>
													Remover</button><br>
											</div>
											<?php
											$Cont++;
									...
									<div id="div_<?php echo $Cont; ?>" class="bg-muted p-sm m-t-md">
										<div class="form-group">
											<label class="col-lg-2 control-label">Nombre del parámetro</label>
											<div class="col-lg-3">
												<input name="NombreParam[]" type="text" class="form-control"
													id="NombreParam_<?php echo $Cont; ?>" maxlength="50" value=""
													autocomplete="off">
											</div>
											<label class="col-lg-2 control-label">Label del campo</label>
											<div class="col-lg-3">
												<input name="LabelCampo[]" type="text" class="form-control"
													id="LabelCampo_<?php echo $Cont; ?>" maxlength="50" value=""
													autocomplete="off">
											</div>
										</div>
										<div class="form-group">
											<label class="col-lg-2 control-label">Nombre del campo</label>
											<div class="col-lg-3">
												<input name="NombreCampo[]" type="text" class="form-control"
													id="NombreCampo_<?php echo $Cont; ?>" maxlength="50" value=""
													autocomplete="off">
											</div>
											<label class="col-lg-2 control-label">Tipo de campo</label>
											<div class="col-lg-3">
												<select name="TipoCampo[]" class="form-control m-b"
													id="TipoCampo_<?php echo $Cont; ?>"
													onChange="ChangeTipoCampo('<?php echo $Cont; ?>');">
										...
										<div id="dv_ConfCheck_<?php echo $Cont; ?>" style="display: none;"
											class="form-group">
											<label class="col-lg-2 control-label">Nombre checkbox</label>
											<div class="col-lg-3">
												<input name="NombreCheckbox[]" type="text" class="form-control"
													id="NombreCheckbox_<?php echo $Cont; ?>" maxlength="50" value=""
													autocomplete="off">
											</div>
										</div>
										<div id="dv_ConfList_<?php echo $Cont; ?>" style="display: none;" class="form-group">
											<div class="form-group">
												<label class="col-lg-2 control-label">Vista</label>
												<div class="col-lg-3">
													<input name="VistaList[]" type="text" class="form-control"
														id="VistaList_<?php echo $Cont; ?>" maxlength="100" value="">
												</div>
												<div class="col-lg-1">
													<button type="button"
														onClick="ConsultarCamposList('<?php echo $Cont; ?>');"
										...
										<button type="button" id="<?php echo $Cont; ?>" class="btn btn-success btn-xs"
											onClick="addField(this);"><i class="fa fa-plus"></i> Añadir otro</button><br>
									</div>
									<br>
									<div class="form-group">
										<div class="col-lg-2">
