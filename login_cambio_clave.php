			...
			<div class="d-none d-lg-flex col-lg-8 align-items-center ui-bg-cover ui-bg-overlay-container p-5">
				...
				<div class="w-100 text-white px-5">
					...
					<div class="text-large font-weight-light">
						Sistema de gestión y control de documentos, creación de documentos de marketing para SAP
						Business One, gestor de tareas y portal de proveedores. Todo en un mismo lugar.
					</div>
				</div>
				<!-- /.Text -->
			</div>
			...
			<div class="d-flex col-lg-4 align-items-center bg-white p-5">
				...
				<div class="d-flex col-sm-7 col-md-5 col-lg-12 px-0 px-xl-4 mx-auto">
					<div class="w-100">
						...
						<h4 class="text-center text-lighter font-weight-normal mt-5 mb-0">Inicio de sesión</h4>
						<h5 class="text-center font-weight-normal mt-5 mb-0">
							Cambiar su contraseña
						</h5>
						<!-- Form -->
						<form name="frmLogin" id="frmLogin" class="my-5" role="form" action="login_cambio_clave.php"
							method="post" enctype="application/x-www-form-urlencoded">
							<div class="form-group">
								<label class="form-label">Contraseña</label>
								<input name="Password" type="password" autofocus required="required"
									class="form-control" id="Password" maxlength="50">
							</div>
							<div class="form-group">
								<label class="form-label">Confirmar</label>
								<input name="ConfPassword" type="password" required="required" class="form-control"
									id="ConfPassword" maxlength="50">
							</div>
							<div class="d-flex justify-content-between align-items-center m-0">
								<button type="submit" class="btn btn-primary">Cambiar contraseña</button>
								<button onClick="javascript:location.href='logout.php'" type="button"
									class="btn btn-secondary">Salir</button>
							</div><br>
							<?php if ($result == 2) { ?>
								<div class="alert alert-danger">
									<i class="fa fa-times-circle-o"></i> <strong>Error.</strong> Las contraseñas no
									coinciden. <br>Por favor verifique.
								</div>
							<?php } ?>
