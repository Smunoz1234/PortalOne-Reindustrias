...
<head>
	...
	<title>Consultar entrada borrador |
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<form action="consultar_entrada_compra_borrador.php" method="get" id="formBuscar"
												...
												<tr class="gradeX">
													...
													<td>
														<?php if ($row['ID_LlamadaServicio'] != 0) { ?><a
																href="llamada_servicio.php?id=<?php echo base64_encode($row['ID_LlamadaServicio']); ?>&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('consultar_entrada_compra_borrador.php'); ?>&tl=1"
																target="_blank">
													...
													<td>
														<?php if ($row['DocBaseDocEntry'] != "") { ?><a
																href="orden_compra.php?id=<?php echo base64_encode($row['DocBaseDocEntry']); ?>&id_portal=<?php echo base64_encode($row['DocBaseIdPortal']); ?>&tl=1"
																target="_blank">
													...
													<td>
														<?php if ($row['DocDestinoDocEntry'] != "") { ?><a
																href="factura_compra.php?id=<?php echo base64_encode($row['DocDestinoDocEntry']); ?>&id_portal=<?php echo base64_encode($row['DocDestinoIdPortal']); ?>&tl=1"
																target="_blank">
													...
													<td><a href="entrada_compra_borrador.php?id=<?php echo base64_encode($row['ID_EntradaCompra']); ?>&id_portal=<?php echo base64_encode($row['IdDocPortal']); ?>&tl=1&return=<?php echo base64_encode($_SERVER['QUERY_STRING']); ?>&pag=<?php echo base64_encode('consultar_entrada_compra_borrador.php'); ?>"
															class="alkin btn btn-success btn-xs"><i
																class="fa fa-folder-open-o"></i> Abrir</a> <a
															href="sapdownload.php?id=<?php echo base64_encode('15'); ?>&type=<?php echo base64_encode('2'); ?>&DocKey=<?php echo base64_encode($row['ID_EntradaCompra']); ?>&ObType=<?php echo base64_encode('20'); ?>&IdFrm=<?php echo base64_encode($row['IdSeries']); ?>"
