...
$Cons="Select * From uvw_tbl_Archivos_Cargue";
...
<title><?php echo NOMBRE_PORTAL;?> | Cargar archivos masivos</title>
<!-- InstanceEndEditable -->
...
<script>
		function EliminarRegistro(id){
			if(id!=""){
				...
				function(){
					location.href='registro.php?P=21&type=1&id='+id;
				});
			}
		}
		function EliminarDatos(){
				...
				function(){
					location.href='registro.php?P=21&type=2';
				});			
		}
</script>
<!-- InstanceEndEditable -->
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-sm-4">
                    <div class="title-action">
                        <a href="cargar_archivo_csv.php" class="btn btn-primary"><i class="fa fa-upload"></i> Cargar archivo .csv</a>
                    </div>
                </div>
               <?php  //echo $Cons;?>
            </div>
				...
				<div class="ibox-content">
					<form action="registro.php" method="post" id="frmMover" class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-lg-8">
								<a href="cargue_masivo_archivos.php" class="btn btn-warning pull-right"><i class="fa fa-refresh"></i> Actualizar</a>
							</div>
							<div class="col-lg-2">
								<a href="#" onClick="EliminarDatos();" class="btn btn-danger pull-right"><i class="fa fa-trash-o"></i> Borrar datos</a>
							</div>
							<input type="hidden" name="P" id="P" value="20">
						</div>
					</form>
				</div>
			</div>
			...
			$Msg=ValidarEstadoArchivoCargue($row['NombreCliente'],$row['NombreCategoria'],$row['ID_Sucursal'],utf8_decode($row['Archivo']));
						?>
						 <tr class="gradeX">
							...
							<td><?php if($row['Archivo']!=""){?><a href="#" onClick="EliminarRegistro(<?php echo $row['ID_Archivo'];?>);" class="btn btn-link btn-xs"><i class="fa fa-eraser"></i> Eliminar</a><?php }else{?><p class="text-muted">Ninguno</p><?php }?></td>
						</tr>
					<?php }?>
                    </tbody>
                    </table>
