			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-8">
					...
					<ol class="breadcrumb">
						...
						<li class="active">
							<a
								href="<?php echo isset($row_Cat['URL']) ? $row_Cat['URL'] . "?id=" . $frm : "consultar_frm_recepcion_vehiculo.php" ?>">
								<?php echo isset($row_Cat['NombreCategoria']) ? $row_Cat['NombreCategoria'] : "Recepción de vehículos"; ?>
							</a>
						</li>
						<li class="active">
							<strong>
					...
					<div class="row">
						<div class="col-lg-12">
							<form action="frm_recepcion_vehiculo.php" method="post" class="form-horizontal"
														...
														<?php while ($row_SucursalCliente = sqlsrv_fetch_array($SQL_SucursalCliente)) { ?>
															<option value="<?php echo $row_SucursalCliente['NombreSucursal']; ?>"
																<?php if ((isset($row['NombreSucursal'])) && (strcmp($row_SucursalCliente['NombreSucursal'], $row['NombreSucursal']) == 0)) {
																	echo "selected";
																} elseif ($SucursalCliente == $row_SucursalCliente['NombreSucursal']) {
																	echo "selected";
																} ?>>
										...
										<div class="form-group">
											...
											<div class="col-lg-4">
												...
												<input autocomplete="off" name="no_motor" type="text" required
													class="form-control" id="no_motor" maxlength="100"
										...
										<div class="form-group">
											<div class="col-lg-4">
												<label class="control-label">KM actual <span
														class="text-danger">*</span></label>
												<input autocomplete="off" name="km_actual" required type="text"
													class="form-control" id="km_actual" maxlength="100">
											</div>
											<div class="col-lg-4">
												<label class="control-label">No. Campaña <span
														class="text-danger">*</span></label>
												<input autocomplete="off" name="no_campana" required type="text"
													class="form-control" id="no_campana" maxlength="100">
											</div>
										</div>
										<!-- Inicio, crono-info -->
										<div class="form-group">
								...
								<div class="ibox">
									<div class="ibox-title bg-success">
										<h5 class="collapse-link"><i class="fa fa-list"></i> Datos piezas de vehículo
										</h5>
										<a class="collapse-link pull-right" style="color: white;">
											<i class="fa fa-chevron-up"></i>
										</a>
									...
									<div class="ibox-content">
										...
										<?php while ($row_Pregunta = sqlsrv_fetch_array($SQL_Preguntas)) { ?>
											...
											<input type="hidden" name="<?php echo "id_pregunta_$count_rp"; ?>"
												id="<?php echo "id_pregunta_$count_rp"; ?>"
												value="<?php echo $row_Pregunta['id_recepcion_pregunta']; ?>">
											<input type="hidden" name="<?php echo "pregunta_$count_rp"; ?>"
												id="<?php echo "pregunta_$count_rp"; ?>"
												value="<?php echo $row_Pregunta['recepcion_pregunta']; ?>">

											<div class="form-group">
												<div class="col-lg-4 border-bottom ">
													<label class="control-label text-danger">
														<?php echo $row_Pregunta['recepcion_pregunta']; ?>
													</label>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-2">
													<select class="form-control"
														name="<?php echo "p_disponible_$count_rp"; ?>"
														id="<?php echo "p_disponible_$count_rp"; ?>">
														<option value="SI" <?php if ((isset($row["p_disponible_$count_rp"])) && (strcmp("si", $row["p_disponible_$count_rp"]) == 0)) {
															echo "selected";
														} ?>>
															Si
														</option>
														<option value="NO" <?php if ((isset($row["p_disponible_$count_rp"])) && (strcmp("no", $row["p_disponible_$count_rp"]) == 0)) {
															echo "selected";
														} ?>>
															No
														</option>
												...
												<div class="col-lg-2">
													<select class="form-control" name="<?php echo "p_estado_$count_rp"; ?>"
														id="<?php echo "p_estado_$count_rp"; ?>">
														<option value="BUENO" <?php if ((isset($row["p_estado_$count_rp"])) && (strcmp("BUENO", $row["p_estado_$count_rp"]) == 0)) {
															echo "selected";
														} ?>>
															Bueno
														</option>
														<option value="MALO" <?php if ((isset($row["p_estado_$count_rp"])) && (strcmp("MALO", $row["p_estado_$count_rp"]) == 0)) {
															echo "selected";
														} ?>>
															Malo
														</option>
												...
												<?php if ($row_Pregunta["profundidad_llantas"] == 'Y') { ?>
													...
													<label class="col-lg-1 control-label">Profundidad Llantas (Máximo
														24mm)</label>
													<div class="col-lg-2">
														<input autocomplete="off"
															name="<?php echo "profundidad_llantas_$count_rp"; ?>"
															id="<?php echo "profundidad_llantas_$count_rp"; ?>" type="number"
													...
													<div class="fileinput fileinput-new input-group"
														...
														<span class="input-group-addon btn btn-default btn-file">
															...
															<input name="Img1" type="file" id="Img1"
																onchange="uploadImage('Img1')" required />
														</span>
														<a href="#"
													...
													<div class="fileinput fileinput-new input-group"
														...
														<span class="input-group-addon btn btn-default btn-file">
															...
															<input name="Img2" type="file" id="Img2"
																onchange="uploadImage('Img2')" required />
														</span>
														<a href="#"
															class="input-group-addon btn btn-default fileinput-exists"
															data-dismiss="fileinput">Quitar</a>
													...
													<div class="fileinput fileinput-new input-group"
														...
														<span class="input-group-addon btn btn-default btn-file">
															...
															<input name="Img3" type="file" id="Img3"
																onchange="uploadImage('Img3')" required />
														</span>
														<a href="#"
															class="input-group-addon btn btn-default fileinput-exists"
															data-dismiss="fileinput">Quitar</a>
													...
													<div class="fileinput fileinput-new input-group"
														...
														<span class="input-group-addon btn btn-default btn-file">
															...
															<input name="Img4" type="file" id="Img4"
																onchange="uploadImage('Img4')" required />
														</span>
														<a href="#"
															class="input-group-addon btn btn-default fileinput-exists"
															data-dismiss="fileinput">Quitar</a>
													...
													<div class="fileinput fileinput-new input-group"
														...
														<span class="input-group-addon btn btn-default btn-file">
															...
															<input name="Img5" type="file" id="Img5"
																onchange="uploadImage('Img5')" required />
														</span>
														<a href="#"
															class="input-group-addon btn btn-default fileinput-exists"
															data-dismiss="fileinput">Quitar</a>
										...
										<div class="ibox-content">
											<div class="form-group">
												<label class="col-lg-1 control-label">Responsable del cliente <span
														class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input autocomplete="off" name="responsable_cliente" type="text" required maxlength="150"
														class="form-control" id="responsable_cliente" <?php if (($type_frm == 1) && ($row['Cod_Estado'] == '-1')) {
															echo "readonly";
														} ?>
														value="<?php if (($type_frm == 1) || ($sw_error == 1)) {
											...
											<div class="form-group">
												<label class="col-lg-1 control-label">Cédula de contacto <span
														class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input autocomplete="off" name="cedula_responsable_cliente"
														type="number" class="form-control" required maxlength="15"
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input autocomplete="off" name="telefono_responsable_cliente"
														type="number" class="form-control" required maxlength="50"
											...
											<div class="form-group">
												<label class="col-lg-1 control-label">Correo de contacto <span
														class="text-danger">*</span></label>
												<div class="col-lg-4">
													<input autocomplete="off" name="correo_responsable_cliente" type="email" maxlength="100"
												...
												<?php } else { //LimpiarDirTempFirma();?>
													<div class="col-lg-5">
														...
														<input type="text" id="SigCliente" name="SigCliente" value=""
															form="recepcionForm" required readonly="readonly"
